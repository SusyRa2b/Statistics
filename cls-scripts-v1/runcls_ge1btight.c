   ...
   void runcls_ge1btight( int m0 = 560, int m12 = 300 ) {

      gROOT->LoadMacro("ra2bRoostatsClass4.c+") ;



      ra2bRoostatsClass4 rfit(1,0,2) ; // --- Important!   3rd argument must be 2 (for alternative Znn model)

      rfit.initialize("an-11-257-v3-files/input-files/byhand-data-ge1b-tight.txt") ;
      rfit.setSusyScanPoint("an-11-257-v3-files/input-files/signalSyst.mSUGRAtanb40.ge1bTight.1143invpb.dat", m0, m12) ;
      ...
      char outfname[10000] ;
      sprintf( outfname, "output-files-ge1btight/clstest_ge1btight_tb40_%d_%d.root", m0, m12 ) ;
