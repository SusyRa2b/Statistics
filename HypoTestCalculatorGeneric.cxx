...
HypoTestResult* HypoTestCalculatorGeneric::GetHypoTest() const {
    ...
    cout << "\n\n HypoTestCalculatorGeneric::GetHypoTest: just getting started.\n\n" << flush ;
   ...
   cout << "\n\n HypoTestCalculatorGeneric::GetHypoTest : Test Statistic on data: " << obsTestStat << "\n\n" << flush ;
   ...
   *bothParams = *saveAll;
   ...
   cout << "\n\n HypoTestCalculatorGeneric::GetHypoTest : calling SetupSampler\n\n" << flush ;
   // Generate sampling distribution for null
   SetupSampler(*fNullModel);
   cout << "\n\n HypoTestCalculatorGeneric::GetHypoTest : calling paramPointNull\n\n" << flush ;
   ...
   cout << "\n\n HypoTestCalculatorGeneric::GetHypoTest : calling GetSamplingDistribution\n\n" << flush ;
   ...
   *bothParams = *saveAll;
   ...
   cout << "\n\n HypoTestCalculatorGeneric::GetHypoTest : calling paramPointAlt\n\n" << flush ;
