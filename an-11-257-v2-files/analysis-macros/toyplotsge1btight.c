...
#include "TLegend.h"
   ...
   void toyplotsge1btight() {
      ...
      toyns.Add("an-11-257-v2-files/output-files/toyge1btight-smonly-mctest.root") ;

      TChain bgo("tt_cls_bgonly") ;
      TChain spb("tt_cls_splusb") ;

      bgo.Add("an-11-257-v2-files/output-files/toyge1btight-smonly-mctest.root") ;
      spb.Add("an-11-257-v2-files/output-files/toyge1btight-smonly-mctest.root") ;
     ...
     //============ fit values
      ...
      TH1F* httwjfit = new TH1F("httwjfit","ttwj",40, 0., 25. ) ;
      TH1F* hqcdfit  = new TH1F("hqcdfit" ,"qcd" ,40, 0., 2. ) ;
      TH1F* hznnfit  = new TH1F("hznnfit" ,"znn" ,40, 0., 10. ) ;
      ...
      httwjfit->Draw() ;
      arrow->DrawArrow(8.5,40,8.5,0) ;
      c1->SaveAs("an-11-257-v2-files/output-files/toymc-ttwj-sig-fit-ge1btight.png") ;
      hqcdfit->Draw() ;
      arrow->DrawArrow(0.5,60,0.5,0) ;
      c1->SaveAs("an-11-257-v2-files/output-files/toymc-qcd-sig-fit-ge1btight.png") ;
      hznnfit->Draw() ;
      arrow->DrawArrow(3.0,40,3.0,0) ;
      c1->SaveAs("an-11-257-v2-files/output-files/toymc-znn-sig-fit-ge1btight.png") ;


     //============ fit uncertainty

      TH1F* httwjerr = new TH1F("httwjerr","ttwj",40, 0., 10. ) ;
      TH1F* hqcderr  = new TH1F("hqcderr" ,"qcd" ,40, 0., 1. ) ;
      TH1F* hznnerr  = new TH1F("hznnerr" ,"znn" ,40, 0., 5. ) ;
      ...
      httwjerr->Draw() ;
      c1->SaveAs("an-11-257-v2-files/output-files/toymc-ttwj-sig-err-ge1btight.png") ;
      hqcderr->Draw() ;
      c1->SaveAs("an-11-257-v2-files/output-files/toymc-qcd-sig-err-ge1btight.png") ;
      hznnerr->Draw() ;
      c1->SaveAs("an-11-257-v2-files/output-files/toymc-znn-sig-err-ge1btight.png") ;
    ...
    //
      arrow->DrawArrow(2.62,150,2.62,0.,0,">") ;
      ...
      c1->SaveAs("an-11-257-v2-files/output-files/toymc-qvalue-distributions-ge1btight.png") ;
