   ...
   void runtoyge1btight() {
      ...
      ra2bRoostatsClass3 rfit(1,0,2) ;  //+++ VERY IMPORTANT!  3rd argument must be 2 for tight sel!

      rfit.initialize("an-11-257-v2-files/input-files/mc-inputs-SMonly-tight-sel.txt") ;
      rfit.setSusyScanPoint("an-11-257-v2-files/input-files/susy-lm9-nb1-ht500-sb150_200-sig300.txt",0,0) ;
      ...
      TFile clsroot("an-11-257-v2-files/output-files/toyge1btight-smonly-mctest.root","recreate") ;
      ...
      rfit.doToyStudyNoSusyInFit(1000, "an-11-257-v2-files/input-files/mc-trueval-SMonly-tight-sel.txt" ) ;
