...
#include "TLegend.h"
   ...
   void toyplotsge1bloose() {
      ...
      toyns.Add("an-11-257-v2-files/output-files/toyge1bloose-smonly-mctest.root") ;

      TChain bgo("tt_cls_bgonly") ;
      TChain spb("tt_cls_splusb") ;

      bgo.Add("an-11-257-v2-files/output-files/toyge1bloose-smonly-mctest.root") ;
      spb.Add("an-11-257-v2-files/output-files/toyge1bloose-smonly-mctest.root") ;
     ...
     //============ fit values
      ...
      TH1F* httwjfit = new TH1F("httwjfit","ttwj",40, 50., 120. ) ;
      TH1F* hqcdfit  = new TH1F("hqcdfit" ,"qcd" ,40, 0., 15. ) ;
      TH1F* hznnfit  = new TH1F("hznnfit" ,"znn" ,40, 0., 50. ) ;
      ...
      httwjfit->Draw() ;
      arrow->DrawArrow(85.6,40,85.6,0) ;
      c1->SaveAs("an-11-257-v2-files/output-files/toymc-ttwj-sig-fit-ge1bloose.png") ;
      hqcdfit->Draw() ;
      arrow->DrawArrow(5.6,60,5.6,0) ;
      c1->SaveAs("an-11-257-v2-files/output-files/toymc-qcd-sig-fit-ge1bloose.png") ;
      hznnfit->Draw() ;
      arrow->DrawArrow(15.6,40,15.6,0) ;
      c1->SaveAs("an-11-257-v2-files/output-files/toymc-znn-sig-fit-ge1bloose.png") ;


     //============ fit uncertainty

      TH1F* httwjerr = new TH1F("httwjerr","ttwj",40, 5., 15. ) ;
      TH1F* hqcderr  = new TH1F("hqcderr" ,"qcd" ,40, 0., 5. ) ;
      ...
      httwjerr->Draw() ;
      c1->SaveAs("an-11-257-v2-files/output-files/toymc-ttwj-sig-err-ge1bloose.png") ;
      hqcderr->Draw() ;
      c1->SaveAs("an-11-257-v2-files/output-files/toymc-qcd-sig-err-ge1bloose.png") ;
      hznnerr->Draw() ;
      c1->SaveAs("an-11-257-v2-files/output-files/toymc-znn-sig-err-ge1bloose.png") ;
    ...
    //
      arrow->DrawArrow(2.44,150,2.44,0.,0,">") ;
      ...
      c1->SaveAs("an-11-257-v2-files/output-files/toymc-qvalue-distributions-ge1bloose.png") ;
