...
#include "LikelihoodIntervalPlot.cxx"
  ...
  //=====================================================================================================
   ...
   ra2bRoostatsClass4::ra2bRoostatsClass4( bool ArgUseSigTtwjVar, bool ArgUseLdpVars, int ArgznnModel ) {
...
//  bool ra2bRoostatsClass4::generateToyDatasetsFromLikelihood( const char* outputRootFile, int nToys ) {
...
//  bool ra2bRoostatsClass4::generateToyDatasetsFromNVals( const char* outputRootFile, int nToys ) {
...
//  } // generateToyDatasetsFromNVals
  ...
  //==================================================================================================
     ...
     bool ra2bRoostatsClass4::profileSusySig( float& susySigLow, float& susySigHigh, bool makePlot, const char* plotname, double scanMax ) {
...
/////    }
  ...
  //==================================================================================================
     ...
     bool ra2bRoostatsClass4::profileZnnSig( float& znnSigLow, float& znnSigHigh, bool makePlot, const char* plotname, double scanMax ) {
  ...
  //==================================================================================================
     ...
     bool ra2bRoostatsClass4::profileqcdSig( float& qcdSigLow, float& qcdSigHigh, bool makePlot, const char* plotname, double scanMax ) {
  ...
  //==================================================================================================
     bool ra2bRoostatsClass4::profileqcdSb( float& qcdSbLow, float& qcdSbHigh, bool makePlot, const char* plotname, double scanMax ) {
  ...
  //==================================================================================================
     ...
     bool ra2bRoostatsClass4::profilettwjSig( float& ttwjSigLow, float& ttwjSigHigh, bool makePlot, const char* plotname, double scanMax ) {
  ...
  //==================================================================================================
     bool ra2bRoostatsClass4::profilettwjSb( float& ttwjSbLow, float& ttwjSbHigh, bool makePlot, const char* plotname, double scanMax ) {
  ...
  //==================================================================================================
     ...
     bool ra2bRoostatsClass4::profileZnnSb( float& znnSbLow, float& znnSbHigh, bool makePlot, const char* plotname, double scanMax ) {
  ...
  //===================================================================
   ...
   ra2bRoostatsClass4::~ra2bRoostatsClass4() {
...
//    delete workspace ;
  ...
  //===================================================================
    ...
    bool ra2bRoostatsClass4::initialize( const char* infile ) {
  ...
  //===================================================================
    ...
    bool ra2bRoostatsClass4::reinitialize( ) {
 ...
 //    printf("\n\n\n") ;
  ...
  //===================================================================
    ...
    bool ra2bRoostatsClass4::susyScanNoContam( const char* inputScanFile, const char* outputFilebase ) {
 ...
 //---------------------------------
  ...
  //===================================================================
    ...
    bool ra2bRoostatsClass4::discoveryScanWithContam( const char* inputScanFile ) {
  ...
  //===================================================================
    ...
    bool ra2bRoostatsClass4::nosusysignifScanWithContam( const char* inputScanFile ) {
  ...
  //===================================================================
    ...
    bool ra2bRoostatsClass4::fitQualityPlot( bool doNorm, const char* plotname, double hmax ) {
  ...
  //===================================================================
    ...
    void ra2bRoostatsClass4::setAndFixSusySig( double setVal ) {
  ...
  //===================================================================
    ...
    void ra2bRoostatsClass4::setAndFixSusySigToPredictedValue( ) {
  ...
  //===================================================================
    ...
    void ra2bRoostatsClass4::freeSusySig( ) {
  ...
  //===================================================================
    ...
    void ra2bRoostatsClass4::parameterSnapshot() {
  ...
  //===================================================================
    ...
    void ra2bRoostatsClass4::genToyExperiment() {
  ...
  //// tt->Write() ;
       ...
       printf("\n\n\n ra2bRoostatsClass4 :  p-value for data_q = %8.3f is  %d / %d = %8.3f\n\n\n",
  ...
  //===================================================================
    ...
    double ra2bRoostatsClass4::doToyStudyNoSusyInFit( int nToys, const char* trueValsInputFile ) {
  ...
  //===================================================================
    ...
    double ra2bRoostatsClass4::getLogLikelihoodValue( ) {
