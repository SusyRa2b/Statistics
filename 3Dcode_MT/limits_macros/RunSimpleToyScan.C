...
void RunSimpleToyScan(TString fileName, int nPoints, double startVal, double stopVal, TString outFile) {
  ...
  outStream << nPoints << " points toy scan from " << startVal << " to " << stopVal << endl ;
