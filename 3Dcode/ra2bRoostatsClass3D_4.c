#include "ra2bRoostatsClass3D_4.h"
...
//
//          ra2bRoostatsClass3D_4 : Same as 3b, but adding the possibility of
//                                  having a contraint on the SL b-jet shape
//                                  with ExternalContraints. It's not working
//                                  use the 4b version.
...
#include "betaPrimeConstraint.c"
  ...
  //=====================================================================================================
   ...
   ra2bRoostatsClass3D_4::ra2bRoostatsClass3D_4() {
  ...
  //===================================================================
    ...
    bool ra2bRoostatsClass3D_4::initialize( const char* infile ,
	...
	return false ;
      ...
      float ext_ttwj_nbjet2_fr;
      float ext_ttwj_nbjet2_fr_err;
      float ext_ttwj_nbjet3_fr;
      float ext_ttwj_nbjet3_fr_err;
   ...
   // char equal;
	...
	cout << inPar << " = " << sf_mm_err[k] << endl ;	  
      ...
      // new for the b-jet shape constraint 

      fscanf( infp, "%s %g", label, &ext_ttwj_nbjet2_fr )     ; cout << "ext_ttwj_nbjet2_fr"     << " = " << ext_ttwj_nbjet2_fr     << endl ;
      fscanf( infp, "%s %g", label, &ext_ttwj_nbjet2_fr_err ) ; cout << "ext_ttwj_nbjet2_fr_err" << " = " << ext_ttwj_nbjet2_fr_err << endl ;
      fscanf( infp, "%s %g", label, &ext_ttwj_nbjet3_fr )     ; cout << "ext_ttwj_nbjet3_fr"     << " = " << ext_ttwj_nbjet3_fr     << endl ;
      fscanf( infp, "%s %g", label, &ext_ttwj_nbjet3_fr_err ) ; cout << "ext_ttwj_nbjet3_fr_err" << " = " << ext_ttwj_nbjet3_fr_err << endl ;
	...
	for (int j = 0 ; j < nBinsHT ; j++) {
	 ...
	 // rv_mu_Znnmc_ldp[i][j][k]->setConstant( kTRUE ) ;
      ...
      rv_ttwj_0lep1lep_ratio -> setVal( 1.3 ) ; // initial guess
	...
	for (int j = 0 ; j < nBinsHT ; j++) {
      ...
      // add constraint on the b-jet shape
      // make an "internal" constraint on the fraction of 2b and 3b events
      // similar to what is done in macro #804

      // compute the fitted fractions of SL components

      TString SumSLtot;
      TString SumSL2b ;
      TString SumSL3b ;
      
      RooArgSet *RasSLtot = new RooArgSet(); 
      RooArgSet *RasSL2b  = new RooArgSet(); 
      RooArgSet *RasSL3b  = new RooArgSet(); 
      
      int count = 0 ;
      int maxCount = nBinsMET*nBinsHT ;
      
      for (int i = 0 ; i < nBinsMET ; i++) {
	for (int j = 0 ; j < nBinsHT ; j++) {
	  for (int k = 0 ; k < nBinsBtag ; k++) {     
	    
	    // prepare strings to be used in RooFormulaVars
	    
	    stringstream addbin;
	    addbin << count;
	    
	    SumSLtot += "@"+addbin.str(); 
	    if ( count < maxCount ) { SumSL2b += "@"+addbin.str(); SumSL3b += "@"+addbin.str(); }
	    
	    count++ ;
	    
	    if ( count < 3*maxCount ) SumSLtot += "+" ;
	    if ( count < maxCount ) { SumSL2b += "+" ; SumSL3b += "+" ; }
	    
	    RasSLtot->add( *rv_mu_ttwj_sl[i][j][k] ) ;
	    if ( k == 1 ) RasSL2b->add( *rv_mu_ttwj_sl[i][j][k] ) ;
	    if ( k == 2 ) RasSL3b->add( *rv_mu_ttwj_sl[i][j][k] ) ;
	    
	  }
	}
      }
      
      RasSL2b->add( *RasSLtot ) ;
      RasSL3b->add( *RasSLtot ) ;
      
      TString frac2bString = "(" + SumSL2b + ") / (" + SumSLtot + ")" ;
      TString frac3bString = "(" + SumSL3b + ") / (" + SumSLtot + ")" ;
      
      RooFormulaVar *fit_ttwj_nbjet2_fr = new RooFormulaVar("fit_ttwj_nbjet2_fr",frac2bString,*RasSL2b);
      RooFormulaVar *fit_ttwj_nbjet3_fr = new RooFormulaVar("fit_ttwj_nbjet3_fr",frac3bString,*RasSL3b);
      
      // add gaussian constraints
      RooGaussian constraint2b("constraint2b","constraint2b",*fit_ttwj_nbjet2_fr,RooConst(ext_ttwj_nbjet2_fr),RooConst(ext_ttwj_nbjet2_fr_err)) ;
      RooGaussian constraint3b("constraint3b","constraint3b",*fit_ttwj_nbjet3_fr,RooConst(ext_ttwj_nbjet3_fr),RooConst(ext_ttwj_nbjet3_fr_err)) ;
      ...
      RooAbsReal *pNll ;
      if ( !addNBjetsContraint ) { pNll = sbModel.GetPdf()->createNLL(*dsObserved); }
      else { pNll = sbModel.GetPdf()->createNLL(*dsObserved,ExternalConstraints(constraint2b),ExternalConstraints(constraint3b)); }
      ...
      if ( !addNBjetsContraint ) { pNll = bModel.GetPdf()->createNLL(*dsObserved); }
      else { pNll = bModel.GetPdf()->createNLL(*dsObserved,ExternalConstraints(constraint2b),ExternalConstraints(constraint3b)); }
   ...
   //=====================================================================================================================
    ...
    bool ra2bRoostatsClass3D_4::setSusyScanPoint( const char* inputScanFile,
						  double m0, double m12, bool isT1bbbb, double t1bbbbXsec,
						  const char* inputSusy_deff_dbtageff_file
						  ) {
   ...
   //==============================================================================================================
    ...
    void ra2bRoostatsClass3D_4::mismatchErr( char* label, TString inPar ) {
   ...
   //==============================================================================================================
    ...
    RooAbsReal* ra2bRoostatsClass3D_4::makeBetaPrimeConstraint( const char* NP_name, double NP_val, double NP_err ) {
   ...
   //==============================================================================================================
    ...
    RooAbsReal* ra2bRoostatsClass3D_4::makeBetaConstraint( const char* NP_name, double NP_val, double NP_err ) {

       if ( NP_val >=1 ) {
          printf("\n\n *** ra2bRoostatsClass3D_4::makeBetaConstraint:  warning.  Input efficiency value is %g.  Resetting to 0.999.\n\n", NP_val) ;
          NP_val = 0.999 ;
       }
   ...
   //==============================================================================================================
    ...
    RooAbsReal* ra2bRoostatsClass3D_4::makeCorrelatedBetaPrimeConstraint( 
       ...
       if ( baseFailPar != 0x0 ) {
          ...
          printf("\n\n *** ra2bRoostatsClass3D_4::makeCorrelatedBetaPrimeConstraint: can't find base fail parameter.\n\n") ;
          return 0x0 ;
       }
       ...
       if ( basePassPar != 0x0 ) {
          ...
          printf("\n\n *** ra2bRoostatsClass3D_4::makeCorrelatedBetaPrimeConstraint: can't find base pass parameter.\n\n") ;
          return 0x0 ;
       }
       ...
       if ( baseFailObs != 0x0 ) {
          ...
          printf("\n\n *** ra2bRoostatsClass3D_4::makeCorrelatedBetaPrimeConstraint: can't find base fail obs.\n\n") ;
          return 0x0 ;
       }
       ...
       if ( basePassObs != 0x0 ) {
          ...
          printf("\n\n *** ra2bRoostatsClass3D_4::makeCorrelatedBetaPrimeConstraint: can't find base pass obs.\n\n") ;
          return 0x0 ;
       }
   ...
   //==============================================================================================================
    ...
    RooAbsReal* ra2bRoostatsClass3D_4::makeCorrelatedBetaConstraint(
        const char* NP_name, double NP_val, double NP_err, const char* NP_base_name, bool changeSign ) {
   ...
   //==============================================================================================================
    ...
    RooAbsReal* ra2bRoostatsClass3D_4::makeGaussianConstraint( const char* NP_name, double NP_val, double NP_err, bool allowNegative ) {
   ...
   //==============================================================================================================
    ...
    RooAbsReal* ra2bRoostatsClass3D_4::makeCorrelatedGaussianConstraint(
            const char* NP_name, double NP_val, double NP_err, const char* NP_base_name, bool changeSign ) {
