...
#include <iostream>
  ...
  //-- met4-ht4-v15
   ...
   //----------------------------
    ...
    void dmc_fillplots_btw( const char* dataset_string = "all" ) {
    ...
    //-- Data
       ...
       if ( strcmp(dataset_string, "all" ) == 0 || strcmp(dataset_string, "RunsABCDT") == 0 ) {
          printf("\n\n Loading all data.\n\n") ;
          compchain[compind] -> Add( "filesMoriond_v4/MET_2012A.root" ) ;
          compchain[compind] -> Add( "filesMoriond_v4/MET_2012B.root" ) ;
          compchain[compind] -> Add( "filesMoriond_v4/MET_2012C_pr.root" ) ;
          compchain[compind] -> Add( "filesMoriond_v4/MET_2012C_rr.root" ) ;
          compchain[compind] -> Add( "filesMoriond_v4/MET_2012D1.root" ) ;
          compchain[compind] -> Add( "filesMoriond_v4/MET_2012D2.root" ) ;
          compchain[compind] -> Add( "filesMoriond_v4/HT_2012A.root" ) ;
          compchain[compind] -> Add( "filesMoriond_v4/HTMHT_2012B.root" ) ;
          compchain[compind] -> Add( "filesMoriond_v4/HTMHT_2012C_pr.root" ) ;
          compchain[compind] -> Add( "filesMoriond_v4/HTMHT_2012C_rr.root" ) ;
          compchain[compind] -> Add( "filesMoriond_v4/HTMHT_2012D1.root" ) ;
          compchain[compind] -> Add( "filesMoriond_v4/HTMHT_2012D2.root" ) ;
          compchain[compind] -> Add( "filesMoriond_v4/JetHT_2012B.root" ) ;
          compchain[compind] -> Add( "filesMoriond_v4/JetHT_2012C_pr.root" ) ;
          compchain[compind] -> Add( "filesMoriond_v4/JetHT_2012C_rr.root" ) ;
          compchain[compind] -> Add( "filesMoriond_v4/JetHT_2012D1.root" ) ;
          compchain[compind] -> Add( "filesMoriond_v4/JetHT_2012D2.root" ) ;
  ...
  //------------
    ...
    //-- Diboson.
       ...
       compchain[compind] -> Add( "filesMoriond_v4/WW.root" ) ;
       compchain[compind] -> Add( "filesMoriond_v4/WZ.root" ) ;
       compchain[compind] -> Add( "filesMoriond_v4/ZZ.root" ) ;
    ...
    //-- Zinvisible
       ...
       compchain[compind] -> Add( "filesMoriond_v4/Zinv-100to200.root" ) ;
       compchain[compind] -> Add( "filesMoriond_v4/Zinv-200to400.root" ) ;
       compchain[compind] -> Add( "filesMoriond_v4/Zinv-400.root" ) ;
       complumi[compind] = MClumi ;
    ...
    //-- QCD
       ...
       compchain[compind] -> Add( "filesMoriond_v4/QCD-120to170.root" ) ;
       //-----------------
       compchain[compind] -> Add( "filesMoriond_v4/QCD-170to300.root" ) ;
       compchain[compind] -> Add( "filesMoriond_v4/QCD-300to470.root" ) ;
       /////////// compchain[compind] -> Add( "filesMoriond_v4/QCD-170to300-smallSample.root" ) ;
       /////////// compchain[compind] -> Add( "filesMoriond_v4/QCD-300to470-smallSample.root" ) ;
       //-----------------
       compchain[compind] -> Add( "filesMoriond_v4/QCD-470to600.root" ) ;
       compchain[compind] -> Add( "filesMoriond_v4/QCD-600to800.root" ) ;
       compchain[compind] -> Add( "filesMoriond_v4/QCD-800to1000.root" ) ;
       compchain[compind] -> Add( "filesMoriond_v4/QCD-1000to1400.root" ) ;
       compchain[compind] -> Add( "filesMoriond_v4/QCD-1400to1800.root" ) ;
       compchain[compind] -> Add( "filesMoriond_v4/QCD-1800.root" ) ;
       complumi[compind] = MClumi ;
       compcolor[compind] = 2 ;
       compscale[compind] = complumi[0] / complumi[compind] ;
    ...
    //-- single top
       ...
       compchain[compind] -> Add( "filesMoriond_v4/T-t.root" ) ;
       compchain[compind] -> Add( "filesMoriond_v4/Tbar-t.root" ) ;
       compchain[compind] -> Add( "filesMoriond_v4/T-s.root" ) ;
       compchain[compind] -> Add( "filesMoriond_v4/Tbar-s.root" ) ;
       compchain[compind] -> Add( "filesMoriond_v4/T-tW.root" ) ;
       compchain[compind] -> Add( "filesMoriond_v4/Tbar-tW.root" ) ;
       complumi[compind] = MClumi ;
    ...
    //-- W+jets
       ...
       compchain[compind] -> Add( "filesMoriond_v4/WJets-250to300.root" ) ;
       compchain[compind] -> Add( "filesMoriond_v4/WJets-300to400.root" ) ;
       compchain[compind] -> Add( "filesMoriond_v4/WJets-400.root" ) ;
       complumi[compind] = MClumi ;
    ...
    //-- ttbar
       ...
       ///////compchain[compind] -> Add( "filesMoriond_v4/TT.root" ) ;
       compchain[compind] -> Add( "filesMoriond_v4/TT_FullLept.root" ) ;
       compchain[compind] -> Add( "filesMoriond_v4/TT_SemiLept.root" ) ;
       compchain[compind] -> Add( "filesMoriond_v4/TT_FullHad.root" ) ;
       complumi[compind] = MClumi ;
    ...
    //--- cuts
       ...
       sprintf( basecuts_1lep, "MT<100&&maxChNMultDiff<40&&pfOcaloMET<2&&minDelPhiN>4&&( (nMu==1&&nEl==0) || (nMu==0&&nEl==1) )&&nJets>=3&&(pt_1st_leadJet>70&&pt_2nd_leadJet>70&&pt_3rd_leadJet>50)&&MET>125&&HT>400&&passedTrigger==1&&(!(HT<500&&MET>350))") ;

       char basecuts_1lep_nometratiocut[10000] ;
       sprintf( basecuts_1lep_nometratiocut, "MT<100&&maxChNMultDiff<40&&minDelPhiN>4&&( (nMu==1&&nEl==0) || (nMu==0&&nEl==1) )&&nJets>=3&&(pt_1st_leadJet>70&&pt_2nd_leadJet>70&&pt_3rd_leadJet>50)&&MET>125&&HT>400&&passedTrigger==1&&(!(HT<500&&MET>350))") ;

       char basecuts_1lep_nonb_nometratiocut[10000] ;
       sprintf( basecuts_1lep_nonb_nometratiocut, "MT<100&&maxChNMultDiff<40&&minDelPhiN>4&&( (nMu==1&&nEl==0) || (nMu==0&&nEl==1) )&&nJets>=3&&(pt_1st_leadJet>70&&pt_2nd_leadJet>70&&pt_3rd_leadJet>50)&&MET>125&&HT>400&&passedTrigger==1&&(!(HT<500&&MET>350))") ;

       char basecuts_1lep_nomindphin[10000] ;
       sprintf( basecuts_1lep_nomindphin, "MT<100&&maxChNMultDiff<40&&pfOcaloMET<2&&( (nMu==1&&nEl==0) || (nMu==0&&nEl==1) )&&nJets>=3&&(pt_1st_leadJet>70&&pt_2nd_leadJet>70&&pt_3rd_leadJet>50)&&MET>125&&HT>400&&passedTrigger==1&&(!(HT<500&&MET>350))") ;

       char basecuts_1lep_nonb[10000] ;
       sprintf( basecuts_1lep_nonb, "MT<100&&maxChNMultDiff<40&&pfOcaloMET<2&&minDelPhiN>4&&( (nMu==1&&nEl==0) || (nMu==0&&nEl==1) )&&nJets>=3&&(pt_1st_leadJet>70&&pt_2nd_leadJet>70&&pt_3rd_leadJet>50)&&MET>125&&HT>400&&passedTrigger==1&&(!(HT<500&&MET>350))") ;

       char basecuts_1lep_nonjet[10000] ;
       sprintf( basecuts_1lep_nonjet, "MT<100&&maxChNMultDiff<40&&pfOcaloMET<2&&minDelPhiN>4&&( (nMu==1&&nEl==0) || (nMu==0&&nEl==1) )&&(pt_1st_leadJet>70&&pt_2nd_leadJet>70&&pt_3rd_leadJet>50)&&MET>125&&HT>400&&passedTrigger==1&&(!(HT<500&&MET>350))") ;

       char basecuts_1lep_nonjet_nonb[10000] ;
       sprintf( basecuts_1lep_nonjet_nonb, "MT<100&&maxChNMultDiff<40&&minDelPhiN>4&&( (nMu==1&&nEl==0) || (nMu==0&&nEl==1) )&&(pt_1st_leadJet>70&&pt_2nd_leadJet>70&&pt_3rd_leadJet>50)&&MET>125&&HT>400&&passedTrigger==1&&(!(HT<500&&MET>350))") ;

       char basecuts_1lep_nonb_noisotrk[10000] ;
       sprintf( basecuts_1lep_nonb_noisotrk, "MT<100&&maxChNMultDiff<40&&pfOcaloMET<2&&minDelPhiN>4&&( (nMu==1&&nEl==0) || (nMu==0&&nEl==1) )&&nJets>=3&&(pt_1st_leadJet>70&&pt_2nd_leadJet>70&&pt_3rd_leadJet>50)&&MET>125&&HT>400&&passedTrigger==1&&(!(HT<500&&MET>350))") ;

       char basecuts_1lep_nonb_nomaxchmultdiff[10000] ;
       sprintf( basecuts_1lep_nonb_nomaxchmultdiff, "MT<100&&pfOcaloMET<2&&minDelPhiN>4&&( (nMu==1&&nEl==0) || (nMu==0&&nEl==1) )&&nJets>=3&&(pt_1st_leadJet>70&&pt_2nd_leadJet>70&&pt_3rd_leadJet>50)&&MET>125&&HT>400&&passedTrigger==1&&(!(HT<500&&MET>350))") ;

       char basecuts_1lep_nomt[10000] ;
       sprintf( basecuts_1lep_nomt, "maxChNMultDiff<40&&pfOcaloMET<2&&minDelPhiN>4&&( (nMu==1&&nEl==0) || (nMu==0&&nEl==1) )&&nJets>=3&&(pt_1st_leadJet>70&&pt_2nd_leadJet>70&&pt_3rd_leadJet>50)&&MET>125&&HT>400&&passedTrigger==1&&(!(HT<500&&MET>350))") ;

       char basecuts_1lep_nonb_nomt[10000] ;
       sprintf( basecuts_1lep_nonb_nomt, "maxChNMultDiff<40&&pfOcaloMET<2&&minDelPhiN>4&&( (nMu==1&&nEl==0) || (nMu==0&&nEl==1) )&&nJets>=3&&(pt_1st_leadJet>70&&pt_2nd_leadJet>70&&pt_3rd_leadJet>50)&&MET>125&&HT>400&&passedTrigger==1&&(!(HT<500&&MET>350))") ;




       char basecuts_ldp[10000] ;
       sprintf( basecuts_ldp, "maxChNMultDiff<40&&nIsoTrk==0&&pfOcaloMET<2&&minDelPhiN<=4&&(nMu==0&&nEl==0)&&nJets>=3&&(pt_1st_leadJet>70&&pt_2nd_leadJet>70&&pt_3rd_leadJet>50)&&MET>125&&HT>400&&passedTrigger==1&&(!(HT<500&&MET>350))") ;

       char basecuts_ldp_nometratiocut[10000] ;
       sprintf( basecuts_ldp_nometratiocut, "maxChNMultDiff<40&&nIsoTrk==0&&minDelPhiN<=4&&(nMu==0&&nEl==0)&&nJets>=3&&(pt_1st_leadJet>70&&pt_2nd_leadJet>70&&pt_3rd_leadJet>50)&&MET>125&&HT>400&&passedTrigger==1&&(!(HT<500&&MET>350))") ;

       char basecuts_ldp_nonb_nometratiocut[10000] ;
       sprintf( basecuts_ldp_nonb_nometratiocut, "maxChNMultDiff<40&&nIsoTrk==0&&minDelPhiN<=4&&(nMu==0&&nEl==0)&&nJets>=3&&(pt_1st_leadJet>70&&pt_2nd_leadJet>70&&pt_3rd_leadJet>50)&&MET>125&&HT>400&&passedTrigger==1&&(!(HT<500&&MET>350))") ;

       char basecuts_ldp_nonb[10000] ;
       sprintf( basecuts_ldp_nonb, "maxChNMultDiff<40&&nIsoTrk==0&&pfOcaloMET<2&&minDelPhiN<=4&&(nMu==0&&nEl==0)&&nJets>=3&&(pt_1st_leadJet>70&&pt_2nd_leadJet>70&&pt_3rd_leadJet>50)&&MET>125&&HT>400&&passedTrigger==1&&(!(HT<500&&MET>350))") ;

       char basecuts_ldp_nonjet[10000] ;
       sprintf( basecuts_ldp_nonjet, "maxChNMultDiff<40&&nIsoTrk==0&&pfOcaloMET<2&&minDelPhiN<=4&&(nMu==0&&nEl==0)&&(pt_1st_leadJet>70&&pt_2nd_leadJet>70&&pt_3rd_leadJet>50)&&MET>125&&HT>400&&passedTrigger==1&&(!(HT<500&&MET>350))") ;

       char basecuts_ldp_nonjet_nonb[10000] ;
       sprintf( basecuts_ldp_nonjet_nonb, "maxChNMultDiff<40&&nIsoTrk==0&&minDelPhiN<=4&&(nMu==0&&nEl==0)&&(pt_1st_leadJet>70&&pt_2nd_leadJet>70&&pt_3rd_leadJet>50)&&MET>125&&HT>400&&passedTrigger==1&&(!(HT<500&&MET>350))") ;

       char basecuts_ldp_nonb_noisotrk[10000] ;
       sprintf( basecuts_ldp_nonb_noisotrk, "maxChNMultDiff<40&&pfOcaloMET<2&&minDelPhiN<=4&&(nMu==0&&nEl==0)&&nJets>=3&&(pt_1st_leadJet>70&&pt_2nd_leadJet>70&&pt_3rd_leadJet>50)&&MET>125&&HT>400&&passedTrigger==1&&(!(HT<500&&MET>350))") ;

       char basecuts_ldp_nonb_nomaxchmultdiff[10000] ;
       sprintf( basecuts_ldp_nonb_nomaxchmultdiff, "nIsoTrk==0&&pfOcaloMET<2&&minDelPhiN<=4&&(nMu==0&&nEl==0)&&nJets>=3&&(pt_1st_leadJet>70&&pt_2nd_leadJet>70&&pt_3rd_leadJet>50)&&MET>125&&HT>400&&passedTrigger==1&&(!(HT<500&&MET>350))") ;




       char basecuts_0lep_nomindphin[10000] ;
       sprintf( basecuts_0lep_nomindphin, "maxChNMultDiff<40&&nIsoTrk==0&&pfOcaloMET<2&&(nMu==0&&nEl==0)&&nJets>=3&&(pt_1st_leadJet>70&&pt_2nd_leadJet>70&&pt_3rd_leadJet>50)&&MET>125&&HT>400&&passedTrigger==1&&(!(HT<500&&MET>350))") ;

       char basecuts_0lep_nomindphin_nonb[10000] ;
       sprintf( basecuts_0lep_nomindphin_nonb, "maxChNMultDiff<40&&nIsoTrk==0&&pfOcaloMET<2&&(nMu==0&&nEl==0)&&nJets>=3&&(pt_1st_leadJet>70&&pt_2nd_leadJet>70&&pt_3rd_leadJet>50)&&MET>125&&HT>400&&passedTrigger==1&&(!(HT<500&&MET>350))") ;

       char basecuts_0lep[10000] ;
       sprintf( basecuts_0lep, "maxChNMultDiff<40&&nIsoTrk==0&&pfOcaloMET<2&&minDelPhiN>4&&(nMu==0&&nEl==0)&&nJets>=3&&(pt_1st_leadJet>70&&pt_2nd_leadJet>70&&pt_3rd_leadJet>50)&&MET>125&&HT>400&&passedTrigger==1&&(!(HT<500&&MET>350))") ;

       char basecuts_0lep_nometratiocut[10000] ;
       sprintf( basecuts_0lep_nometratiocut, "maxChNMultDiff<40&&nIsoTrk==0&&minDelPhiN>4&&(nMu==0&&nEl==0)&&nJets>=3&&(pt_1st_leadJet>70&&pt_2nd_leadJet>70&&pt_3rd_leadJet>50)&&MET>125&&HT>400&&passedTrigger==1&&(!(HT<500&&MET>350))") ;

       char basecuts_0lep_nonb_nometratiocut[10000] ;
       sprintf( basecuts_0lep_nonb_nometratiocut, "maxChNMultDiff<40&&nIsoTrk==0&&minDelPhiN>4&&(nMu==0&&nEl==0)&&nJets>=3&&(pt_1st_leadJet>70&&pt_2nd_leadJet>70&&pt_3rd_leadJet>50)&&MET>125&&HT>400&&passedTrigger==1&&(!(HT<500&&MET>350))") ;

       char basecuts_0lep_nonb[10000] ;
       sprintf( basecuts_0lep_nonb, "maxChNMultDiff<40&&nIsoTrk==0&&pfOcaloMET<2&&minDelPhiN>4&&(nMu==0&&nEl==0)&&nJets>=3&&(pt_1st_leadJet>70&&pt_2nd_leadJet>70&&pt_3rd_leadJet>50)&&MET>125&&HT>400&&passedTrigger==1&&(!(HT<500&&MET>350))") ;

       char basecuts_0lep_nonb_noisotrk[10000] ;
       sprintf( basecuts_0lep_nonb_noisotrk, "maxChNMultDiff<40&&pfOcaloMET<2&&minDelPhiN>4&&(nMu==0&&nEl==0)&&nJets>=3&&(pt_1st_leadJet>70&&pt_2nd_leadJet>70&&pt_3rd_leadJet>50)&&MET>125&&HT>400&&passedTrigger==1&&(!(HT<500&&MET>350))") ;

       char basecuts_0lep_nonb_nomaxchmultdiff[10000] ;
       sprintf( basecuts_0lep_nonb_nomaxchmultdiff, "nIsoTrk==0&&pfOcaloMET<2&&minDelPhiN>4&&(nMu==0&&nEl==0)&&nJets>=3&&(pt_1st_leadJet>70&&pt_2nd_leadJet>70&&pt_3rd_leadJet>50)&&MET>125&&HT>400&&passedTrigger==1&&(!(HT<500&&MET>350))") ;

       char basecuts_0lep_nonjet[10000] ;
       sprintf( basecuts_0lep_nonjet, "maxChNMultDiff<40&&nIsoTrk==0&&pfOcaloMET<2&&minDelPhiN>4&&(nMu==0&&nEl==0)&&(pt_1st_leadJet>70&&pt_2nd_leadJet>70&&pt_3rd_leadJet>50)&&MET>125&&HT>400&&passedTrigger==1&&(!(HT<500&&MET>350))") ;

       char basecuts_0lep_nonjet_nonb[10000] ;
       sprintf( basecuts_0lep_nonjet_nonb, "maxChNMultDiff<40&&nIsoTrk==0&&pfOcaloMET<2&&minDelPhiN>4&&(nMu==0&&nEl==0)&&(pt_1st_leadJet>70&&pt_2nd_leadJet>70&&pt_3rd_leadJet>50)&&MET>125&&HT>400&&passedTrigger==1&&(!(HT<500&&MET>350))") ;
   ...
   //-- likelihood bins
     ...
     //--- Fill the histograms. -----------------------------------------------
       ...
       fillSet( "h_met_sl_all", "MET", cuts, 10 ) ;
       fillSet( "h_ht_sl_all", "HT", cuts, 10 ) ;
       fillSet( "h_met_sl_nomctrigcorr_all", "MET", cuts, false, 10 ) ;
       fillSet( "h_ht_sl_nomctrigcorr_all", "HT", cuts, false, 10 ) ;

       sprintf( cuts, "%s", basecuts_1lep_nonb ) ;
       fillSet( "h_met_sl_nb0", "MET", cuts, 0 ) ;
       fillSet( "h_ht_sl_nb0", "HT", cuts, 0 ) ;
       fillSet( "h_met_sl_nomctrigcorr_nb0", "MET", cuts, 0, false ) ;
       fillSet( "h_ht_sl_nomctrigcorr_nb0", "HT", cuts, 0, false ) ;
       fillSetLHB( "h_lhb_sl_nb0", cuts, 0 ) ;
       fillSetLHB( "h_lhb_sl_nomctrigcorr_nb0", cuts, 0, false ) ;

       sprintf( cuts, "%s", basecuts_1lep ) ;
       fillSet( "h_met_sl_nb1", "MET", cuts, 1 ) ;
       fillSet( "h_ht_sl_nb1", "HT", cuts, 1 ) ;
       fillSet( "h_met_sl_nomctrigcorr_nb1", "MET", cuts, 1, false ) ;
       fillSet( "h_ht_sl_nomctrigcorr_nb1", "HT", cuts, 1, false ) ;
       fillSetLHB( "h_lhb_sl_nb1", cuts, 1 ) ;
       fillSetLHB( "h_lhb_sl_nomctrigcorr_nb1", cuts, 1, false ) ;

       sprintf( cuts, "%s", basecuts_1lep ) ;
       fillSet( "h_met_sl_nb2", "MET", cuts, 2 ) ;
       fillSet( "h_ht_sl_nb2", "HT", cuts, 2 ) ;
       fillSet( "h_met_sl_nomctrigcorr_nb2", "MET", cuts, 2, false ) ;
       fillSet( "h_ht_sl_nomctrigcorr_nb2", "HT", cuts, 2, false ) ;
       fillSetLHB( "h_lhb_sl_nb2", cuts, 2 ) ;
       fillSetLHB( "h_lhb_sl_nomctrigcorr_nb2", cuts, 2, false ) ;

       sprintf( cuts, "%s", basecuts_1lep ) ;
       fillSet( "h_met_sl_nb3", "MET", cuts, 3 ) ;
       fillSet( "h_ht_sl_nb3", "HT", cuts, 3 ) ;
       fillSet( "h_met_sl_nomctrigcorr_nb3", "MET", cuts, 3, false ) ;
       fillSet( "h_ht_sl_nomctrigcorr_nb3", "HT", cuts, 3, false ) ;
       fillSetLHB( "h_lhb_sl_nb3", cuts, 3 ) ;
       fillSetLHB( "h_lhb_sl_nomctrigcorr_nb3", cuts, 3, false ) ;


       sprintf( cuts, "%s&&HT<800", basecuts_1lep ) ;
       fillSet( "h_met_sl_htlt800_all", "MET", cuts, 10 ) ;
       fillSet( "h_met_sl_htlt800_nb1", "MET", cuts, 1 ) ;
       fillSet( "h_met_sl_htlt800_nb2", "MET", cuts, 2 ) ;
       fillSet( "h_met_sl_htlt800_nb3", "MET", cuts, 3 ) ;

       sprintf( cuts, "%s&&HT>800", basecuts_1lep ) ;
       fillSet( "h_met_sl_htgt800_all", "MET", cuts, 10 ) ;
       fillSet( "h_met_sl_htgt800_nb1", "MET", cuts, 1 ) ;
       fillSet( "h_met_sl_htgt800_nb2", "MET", cuts, 2 ) ;
       fillSet( "h_met_sl_htgt800_nb3", "MET", cuts, 3 ) ;


       sprintf( cuts, "%s&&MET<250", basecuts_1lep ) ;
       fillSet( "h_ht_sl_metlt250_all", "HT", cuts, 10 ) ;
       fillSet( "h_ht_sl_metlt250_nb1", "HT", cuts, 1 ) ;
       fillSet( "h_ht_sl_metlt250_nb2", "HT", cuts, 2 ) ;
       fillSet( "h_ht_sl_metlt250_nb3", "HT", cuts, 3 ) ;

       sprintf( cuts, "%s&&MET>250", basecuts_1lep ) ;
       fillSet( "h_ht_sl_metgt250_all", "HT", cuts, 10 ) ;
       fillSet( "h_ht_sl_metgt250_nb1", "HT", cuts, 1 ) ;
       fillSet( "h_ht_sl_metgt250_nb2", "HT", cuts, 2 ) ;
       fillSet( "h_ht_sl_metgt250_nb3", "HT", cuts, 3 ) ;




       sprintf( cuts, "%s", basecuts_ldp ) ;
       fillSet( "h_met_ldp_all", "MET", cuts, 10 ) ;
       fillSet( "h_ht_ldp_all", "HT", cuts, 10 ) ;
       fillSet( "h_met_ldp_nomctrigcorr_all", "MET", cuts, 10, false ) ;
       fillSet( "h_ht_ldp_nomctrigcorr_all", "HT", cuts, 10, false ) ;

       sprintf( cuts, "%s", basecuts_ldp_nonb ) ;
       fillSet( "h_met_ldp_nb0", "MET", cuts, 0 ) ;
       fillSet( "h_ht_ldp_nb0", "HT", cuts, 0 ) ;
       fillSet( "h_met_ldp_nomctrigcorr_nb0", "MET", cuts, 0, false ) ;
       fillSet( "h_ht_ldp_nomctrigcorr_nb0", "HT", cuts, 0, false ) ;
       fillSetLHB( "h_lhb_ldp_nb0", cuts, 0 ) ;
       fillSetLHB( "h_lhb_ldp_nomctrigcorr_nb0", cuts, 0, false ) ;

       sprintf( cuts, "%s", basecuts_ldp ) ;
       fillSet( "h_met_ldp_nb1", "MET", cuts, 1 ) ;
       fillSet( "h_ht_ldp_nb1", "HT", cuts, 1 ) ;
       fillSet( "h_met_ldp_nomctrigcorr_nb1", "MET", cuts, 1, false ) ;
       fillSet( "h_ht_ldp_nomctrigcorr_nb1", "HT", cuts, 1, false ) ;
       fillSetLHB( "h_lhb_ldp_nb1", cuts, 1 ) ;
       fillSetLHB( "h_lhb_ldp_nomctrigcorr_nb1", cuts, 1, false ) ;

       sprintf( cuts, "%s", basecuts_ldp ) ;
       fillSet( "h_met_ldp_nb2", "MET", cuts, 2 ) ;
       fillSet( "h_ht_ldp_nb2", "HT", cuts, 2 ) ;
       fillSet( "h_met_ldp_nomctrigcorr_nb2", "MET", cuts, 2, false ) ;
       fillSet( "h_ht_ldp_nomctrigcorr_nb2", "HT", cuts, 2, false ) ;
       fillSetLHB( "h_lhb_ldp_nb2", cuts, 2 ) ;
       fillSetLHB( "h_lhb_ldp_nomctrigcorr_nb2", cuts, 2, false ) ;

       sprintf( cuts, "%s", basecuts_ldp ) ;
       fillSet( "h_met_ldp_nb3", "MET", cuts, 3 ) ;
       fillSet( "h_ht_ldp_nb3", "HT", cuts, 3 ) ;
       fillSet( "h_met_ldp_nomctrigcorr_nb3", "MET", cuts, 3, false ) ;
       fillSet( "h_ht_ldp_nomctrigcorr_nb3", "HT", cuts, 3, false ) ;
       fillSetLHB( "h_lhb_ldp_nb3", cuts, 3 ) ;
       fillSetLHB( "h_lhb_ldp_nomctrigcorr_nb3", cuts, 3, false ) ;


       sprintf( cuts, "%s&&HT<800", basecuts_ldp ) ;
       fillSet( "h_met_ldp_htlt800_all", "MET", cuts, 10 ) ;
       fillSet( "h_met_ldp_htlt800_nb1", "MET", cuts, 1 ) ;
       fillSet( "h_met_ldp_htlt800_nb2", "MET", cuts, 2 ) ;
       fillSet( "h_met_ldp_htlt800_nb3", "MET", cuts, 3 ) ;

       sprintf( cuts, "%s&&HT>800", basecuts_ldp ) ;
       fillSet( "h_met_ldp_htgt800_all", "MET", cuts, 10 ) ;
       fillSet( "h_met_ldp_htgt800_nb1", "MET", cuts, 1 ) ;
       fillSet( "h_met_ldp_htgt800_nb2", "MET", cuts, 2 ) ;
       fillSet( "h_met_ldp_htgt800_nb3", "MET", cuts, 3 ) ;


       sprintf( cuts, "%s&&MET<250", basecuts_ldp ) ;
       fillSet( "h_ht_ldp_metlt250_all", "HT", cuts, 10 ) ;
       fillSet( "h_ht_ldp_metlt250_nb1", "HT", cuts, 1 ) ;
       fillSet( "h_ht_ldp_metlt250_nb2", "HT", cuts, 2 ) ;
       fillSet( "h_ht_ldp_metlt250_nb3", "HT", cuts, 3 ) ;

       sprintf( cuts, "%s&&MET>250", basecuts_ldp ) ;
       fillSet( "h_ht_ldp_metgt250_all", "HT", cuts, 10 ) ;
       fillSet( "h_ht_ldp_metgt250_nb1", "HT", cuts, 1 ) ;
       fillSet( "h_ht_ldp_metgt250_nb2", "HT", cuts, 2 ) ;
       fillSet( "h_ht_ldp_metgt250_nb3", "HT", cuts, 3 ) ;


       sprintf( cuts, "%s&&HT>400&&HT<=500", basecuts_1lep ) ;
       fillSet( "h_met_sl_nomctrigcorr_ht1_nb1", "MET", cuts, 1, false ) ;
       fillSet( "h_met_sl_nomctrigcorr_ht1_nb1_wide1", "MET", cuts, false ) ;
       fillSet( "h_met_sl_ht1_nb1", "MET", cuts, 1 ) ;
       fillSet( "h_met_sl_ht1_nb1_wide1", "MET", cuts, 1 ) ;
       sprintf( cuts, "%s&&HT>500&&HT<=800", basecuts_1lep ) ;
       fillSet( "h_met_sl_nomctrigcorr_ht2_nb1", "MET", cuts, 1, false ) ;
       fillSet( "h_met_sl_nomctrigcorr_ht2_nb1_wide1", "MET", cuts, 1, false ) ;
       fillSet( "h_met_sl_ht2_nb1", "MET", cuts, 1 ) ;
       fillSet( "h_met_sl_ht2_nb1_wide1", "MET", cuts, 1 ) ;
       sprintf( cuts, "%s&&HT>800&&HT<=1000", basecuts_1lep ) ;
       fillSet( "h_met_sl_nomctrigcorr_ht3_nb1", "MET", cuts, 1, false ) ;
       fillSet( "h_met_sl_nomctrigcorr_ht3_nb1_wide1", "MET", cuts, 1, false ) ;
       fillSet( "h_met_sl_ht3_nb1", "MET", cuts, 1 ) ;
       fillSet( "h_met_sl_ht3_nb1_wide1", "MET", cuts, 1 ) ;
       sprintf( cuts, "%s&&HT>1000", basecuts_1lep ) ;
       fillSet( "h_met_sl_nomctrigcorr_ht4_nb1", "MET", cuts, 1, false ) ;
       fillSet( "h_met_sl_nomctrigcorr_ht4_nb1_wide1", "MET", cuts, 1, false ) ;
       fillSet( "h_met_sl_ht4_nb1", "MET", cuts, 1 ) ;
       fillSet( "h_met_sl_ht4_nb1_wide1", "MET", cuts, 1 ) ;

       sprintf( cuts, "%s&&HT>400&&HT<=500", basecuts_1lep_nonb ) ;
       fillSet( "h_met_sl_nomctrigcorr_ht1_nb0", "MET", cuts, 0, false ) ;
       fillSet( "h_met_sl_nomctrigcorr_ht1_nb0_wide1", "MET", cuts, 0, false ) ;
       fillSet( "h_met_sl_ht1_nb0", "MET", cuts, 0 ) ;
       fillSet( "h_met_sl_ht1_nb0_wide1", "MET", cuts, 0 ) ;
       sprintf( cuts, "%s&&HT>500&&HT<=800", basecuts_1lep_nonb ) ;
       fillSet( "h_met_sl_nomctrigcorr_ht2_nb0", "MET", cuts, 0, false ) ;
       fillSet( "h_met_sl_nomctrigcorr_ht2_nb0_wide1", "MET", cuts, 0, false ) ;
       fillSet( "h_met_sl_ht2_nb0", "MET", cuts, 0 ) ;
       fillSet( "h_met_sl_ht2_nb0_wide1", "MET", cuts, 0 ) ;
       sprintf( cuts, "%s&&HT>800&&HT<=1000", basecuts_1lep_nonb ) ;
       fillSet( "h_met_sl_nomctrigcorr_ht3_nb0", "MET", cuts, 0, false ) ;
       fillSet( "h_met_sl_nomctrigcorr_ht3_nb0_wide1", "MET", cuts, 0, false ) ;
       fillSet( "h_met_sl_ht3_nb0", "MET", cuts, 0 ) ;
       fillSet( "h_met_sl_ht3_nb0_wide1", "MET", cuts, 0 ) ;
       sprintf( cuts, "%s&&HT>1000", basecuts_1lep_nonb ) ;
       fillSet( "h_met_sl_nomctrigcorr_ht4_nb0", "MET", cuts, 0, false ) ;
       fillSet( "h_met_sl_nomctrigcorr_ht4_nb0_wide1", "MET", cuts, 0, false ) ;
       fillSet( "h_met_sl_ht4_nb0", "MET", cuts, 0 ) ;
       fillSet( "h_met_sl_ht4_nb0_wide1", "MET", cuts, 0 ) ;

       sprintf( cuts, "%s&&HT>400&&HT<=500", basecuts_ldp ) ;
       fillSet( "h_met_ldp_nomctrigcorr_ht1_nb1", "MET", cuts, 1, false ) ;
       fillSet( "h_met_ldp_nomctrigcorr_ht1_nb1_wide1", "MET", cuts, 1, false ) ;
       fillSet( "h_met_ldp_ht1_nb1", "MET", cuts, 1 ) ;
       fillSet( "h_met_ldp_ht1_nb1_wide1", "MET", cuts, 1 ) ;
       sprintf( cuts, "%s&&HT>500&&HT<=800", basecuts_ldp ) ;
       fillSet( "h_met_ldp_nomctrigcorr_ht2_nb1", "MET", cuts, 1, false ) ;
       fillSet( "h_met_ldp_nomctrigcorr_ht2_nb1_wide1", "MET", cuts, 1, false ) ;
       fillSet( "h_met_ldp_ht2_nb1", "MET", cuts, 1 ) ;
       fillSet( "h_met_ldp_ht2_nb1_wide1", "MET", cuts, 1 ) ;
       sprintf( cuts, "%s&&HT>800&&HT<=1000", basecuts_ldp ) ;
       fillSet( "h_met_ldp_nomctrigcorr_ht3_nb1", "MET", cuts, 1, false ) ;
       fillSet( "h_met_ldp_nomctrigcorr_ht3_nb1_wide1", "MET", cuts, 1, false ) ;
       fillSet( "h_met_ldp_ht3_nb1", "MET", cuts, 1 ) ;
       fillSet( "h_met_ldp_ht3_nb1_wide1", "MET", cuts, 1 ) ;
       sprintf( cuts, "%s&&HT>1000", basecuts_ldp ) ;
       fillSet( "h_met_ldp_nomctrigcorr_ht4_nb1", "MET", cuts, 1, false ) ;
       fillSet( "h_met_ldp_nomctrigcorr_ht4_nb1_wide1", "MET", cuts, 1, false ) ;
       fillSet( "h_met_ldp_ht4_nb1", "MET", cuts, 1 ) ;
       fillSet( "h_met_ldp_ht4_nb1_wide1", "MET", cuts, 1 ) ;

       sprintf( cuts, "%s&&HT>400&&HT<=500", basecuts_ldp_nonb ) ;
       fillSet( "h_met_ldp_nomctrigcorr_ht1_nb0", "MET", cuts, 0, false ) ;
       fillSet( "h_met_ldp_nomctrigcorr_ht1_nb0_wide1", "MET", cuts, 0, false ) ;
       fillSet( "h_met_ldp_ht1_nb0", "MET", cuts, 0 ) ;
       fillSet( "h_met_ldp_ht1_nb0_wide1", "MET", cuts, 0 ) ;
       sprintf( cuts, "%s&&HT>500&&HT<=800", basecuts_ldp_nonb ) ;
       fillSet( "h_met_ldp_nomctrigcorr_ht2_nb0", "MET", cuts, 0, false ) ;
       fillSet( "h_met_ldp_nomctrigcorr_ht2_nb0_wide1", "MET", cuts, 0, false ) ;
       fillSet( "h_met_ldp_ht2_nb0", "MET", cuts, 0 ) ;
       fillSet( "h_met_ldp_ht2_nb0_wide1", "MET", cuts, 0 ) ;
       sprintf( cuts, "%s&&HT>800&&HT<=1000", basecuts_ldp_nonb ) ;
       fillSet( "h_met_ldp_nomctrigcorr_ht3_nb0", "MET", cuts, 0, false ) ;
       fillSet( "h_met_ldp_nomctrigcorr_ht3_nb0_wide1", "MET", cuts, 0, false ) ;
       fillSet( "h_met_ldp_ht3_nb0", "MET", cuts, 0 ) ;
       fillSet( "h_met_ldp_ht3_nb0_wide1", "MET", cuts, 0 ) ;
       sprintf( cuts, "%s&&HT>1000", basecuts_ldp_nonb ) ;
       fillSet( "h_met_ldp_nomctrigcorr_ht4_nb0", "MET", cuts, 0, false ) ;
       fillSet( "h_met_ldp_nomctrigcorr_ht4_nb0_wide1", "MET", cuts, 0, false ) ;
       fillSet( "h_met_ldp_ht4_nb0", "MET", cuts, 0 ) ;
       fillSet( "h_met_ldp_ht4_nb0_wide1", "MET", cuts, 0 ) ;

       sprintf( cuts, "%s&&HT>400&&HT<=500", basecuts_0lep ) ;
       fillSet( "h_met_zl_nomctrigcorr_ht1_nb1", "MET", cuts, 1, false ) ;
       fillSet( "h_met_zl_nomctrigcorr_ht1_nb1_wide1", "MET", cuts, 1, false ) ;
       fillSet( "h_met_zl_ht1_nb1", "MET", cuts, 1 ) ;
       fillSet( "h_met_zl_ht1_nb1_wide1", "MET", cuts, 1 ) ;
       sprintf( cuts, "%s&&HT>500&&HT<=800", basecuts_0lep ) ;
       fillSet( "h_met_zl_nomctrigcorr_ht2_nb1", "MET", cuts, 1, false ) ;
       fillSet( "h_met_zl_nomctrigcorr_ht2_nb1_wide1", "MET", cuts, 1, false ) ;
       fillSet( "h_met_zl_ht2_nb1", "MET", cuts, 1 ) ;
       fillSet( "h_met_zl_ht2_nb1_wide1", "MET", cuts, 1 ) ;
       sprintf( cuts, "%s&&HT>800&&HT<=1000", basecuts_0lep ) ;
       fillSet( "h_met_zl_nomctrigcorr_ht3_nb1", "MET", cuts, 1, false ) ;
       fillSet( "h_met_zl_nomctrigcorr_ht3_nb1_wide1", "MET", cuts, 1, false ) ;
       fillSet( "h_met_zl_ht3_nb1", "MET", cuts, 1 ) ;
       fillSet( "h_met_zl_ht3_nb1_wide1", "MET", cuts, 1 ) ;
       sprintf( cuts, "%s&&HT>1000", basecuts_0lep ) ;
       fillSet( "h_met_zl_nomctrigcorr_ht4_nb1", "MET", cuts, 1, false ) ;
       fillSet( "h_met_zl_nomctrigcorr_ht4_nb1_wide1", "MET", cuts, 1, false ) ;
       fillSet( "h_met_zl_ht4_nb1", "MET", cuts, 1 ) ;
       fillSet( "h_met_zl_ht4_nb1_wide1", "MET", cuts, 1 ) ;

       sprintf( cuts, "%s&&HT>400&&HT<=500", basecuts_0lep_nonb ) ;
       fillSet( "h_met_zl_nomctrigcorr_ht1_nb0", "MET", cuts, 0, false ) ;
       fillSet( "h_met_zl_nomctrigcorr_ht1_nb0_wide1", "MET", cuts, 0, false ) ;
       fillSet( "h_met_zl_ht1_nb0", "MET", cuts, 0 ) ;
       fillSet( "h_met_zl_ht1_nb0_wide1", "MET", cuts, 0 ) ;
       sprintf( cuts, "%s&&HT>500&&HT<=800", basecuts_0lep_nonb ) ;
       fillSet( "h_met_zl_nomctrigcorr_ht2_nb0", "MET", cuts, 0, false ) ;
       fillSet( "h_met_zl_nomctrigcorr_ht2_nb0_wide1", "MET", cuts, 0, false ) ;
       fillSet( "h_met_zl_ht2_nb0", "MET", cuts, 0 ) ;
       fillSet( "h_met_zl_ht2_nb0_wide1", "MET", cuts, 0 ) ;
       sprintf( cuts, "%s&&HT>800&&HT<=1000", basecuts_0lep_nonb ) ;
       fillSet( "h_met_zl_nomctrigcorr_ht3_nb0", "MET", cuts, 0, false ) ;
       fillSet( "h_met_zl_nomctrigcorr_ht3_nb0_wide1", "MET", cuts, 0, false ) ;
       fillSet( "h_met_zl_ht3_nb0", "MET", cuts, 0 ) ;
       fillSet( "h_met_zl_ht3_nb0_wide1", "MET", cuts, 0 ) ;
       sprintf( cuts, "%s&&HT>1000", basecuts_0lep_nonb ) ;
       fillSet( "h_met_zl_nomctrigcorr_ht4_nb0", "MET", cuts, 0, false ) ;
       fillSet( "h_met_zl_nomctrigcorr_ht4_nb0_wide1", "MET", cuts, 0, false ) ;
       fillSet( "h_met_zl_ht4_nb0", "MET", cuts, 0 ) ;
       fillSet( "h_met_zl_ht4_nb0_wide1", "MET", cuts, 0 ) ;





       sprintf( cuts, "%s&&MET>125&&MET<=150", basecuts_1lep ) ;
       fillSet( "h_ht_sl_nomctrigcorr_met1_nb1", "HT", cuts, 1, false ) ;
       fillSet( "h_ht_sl_met1_nb1", "HT", cuts, 1 ) ;
       sprintf( cuts, "%s&&MET>150&&MET<=250", basecuts_1lep ) ;
       fillSet( "h_ht_sl_nomctrigcorr_met2_nb1", "HT", cuts, 1, false ) ;
       fillSet( "h_ht_sl_met2_nb1", "HT", cuts, 1 ) ;
       sprintf( cuts, "%s&&MET>250&&MET<=350", basecuts_1lep ) ;
       fillSet( "h_ht_sl_nomctrigcorr_met3_nb1", "HT", cuts, 1, false ) ;
       fillSet( "h_ht_sl_met3_nb1", "HT", cuts, 1 ) ;
       sprintf( cuts, "%s&&MET>350", basecuts_1lep ) ;
       fillSet( "h_ht_sl_nomctrigcorr_met4_nb1", "HT", cuts, 1, false ) ;
       fillSet( "h_ht_sl_met4_nb1", "HT", cuts, 1 ) ;

       sprintf( cuts, "%s&&MET>125&&MET<=150", basecuts_1lep_nonb ) ;
       fillSet( "h_ht_sl_nomctrigcorr_met1_nb0", "HT", cuts, 0, false ) ;
       fillSet( "h_ht_sl_met1_nb0", "HT", cuts, 0 ) ;
       sprintf( cuts, "%s&&MET>150&&MET<=250", basecuts_1lep_nonb ) ;
       fillSet( "h_ht_sl_nomctrigcorr_met2_nb0", "HT", cuts, 0, false ) ;
       fillSet( "h_ht_sl_met2_nb0", "HT", cuts, 0 ) ;
       sprintf( cuts, "%s&&MET>250&&MET<=350", basecuts_1lep_nonb ) ;
       fillSet( "h_ht_sl_nomctrigcorr_met3_nb0", "HT", cuts, 0, false ) ;
       fillSet( "h_ht_sl_met3_nb0", "HT", cuts, 0 ) ;
       sprintf( cuts, "%s&&MET>350", basecuts_1lep_nonb ) ;
       fillSet( "h_ht_sl_nomctrigcorr_met4_nb0", "HT", cuts, 0, false ) ;
       fillSet( "h_ht_sl_met4_nb0", "HT", cuts, 0 ) ;


       sprintf( cuts, "%s&&MET>125&&MET<=150", basecuts_ldp ) ;
       fillSet( "h_ht_ldp_nomctrigcorr_met1_nb1", "HT", cuts, 1, false ) ;
       fillSet( "h_ht_ldp_met1_nb1", "HT", cuts, 1 ) ;
       sprintf( cuts, "%s&&MET>150&&MET<=250", basecuts_ldp ) ;
       fillSet( "h_ht_ldp_nomctrigcorr_met2_nb1", "HT", cuts, 1, false ) ;
       fillSet( "h_ht_ldp_met2_nb1", "HT", cuts, 1 ) ;
       sprintf( cuts, "%s&&MET>250&&MET<=350", basecuts_ldp ) ;
       fillSet( "h_ht_ldp_nomctrigcorr_met3_nb1", "HT", cuts, 1, false ) ;
       fillSet( "h_ht_ldp_met3_nb1", "HT", cuts, 1 ) ;
       sprintf( cuts, "%s&&MET>350", basecuts_ldp ) ;
       fillSet( "h_ht_ldp_nomctrigcorr_met4_nb1", "HT", cuts, 1, false ) ;
       fillSet( "h_ht_ldp_met4_nb1", "HT", cuts, 1 ) ;

       sprintf( cuts, "%s&&MET>125&&MET<=150", basecuts_ldp_nonb ) ;
       fillSet( "h_ht_ldp_nomctrigcorr_met1_nb0", "HT", cuts, 0, false ) ;
       fillSet( "h_ht_ldp_met1_nb0", "HT", cuts, 0 ) ;
       sprintf( cuts, "%s&&MET>150&&MET<=250", basecuts_ldp_nonb ) ;
       fillSet( "h_ht_ldp_nomctrigcorr_met2_nb0", "HT", cuts, 0, false ) ;
       fillSet( "h_ht_ldp_met2_nb0", "HT", cuts, 0 ) ;
       sprintf( cuts, "%s&&MET>250&&MET<=350", basecuts_ldp_nonb ) ;
       fillSet( "h_ht_ldp_nomctrigcorr_met3_nb0", "HT", cuts, 0, false ) ;
       fillSet( "h_ht_ldp_met3_nb0", "HT", cuts, 0 ) ;
       sprintf( cuts, "%s&&MET>350", basecuts_ldp_nonb ) ;
       fillSet( "h_ht_ldp_nomctrigcorr_met4_nb0", "HT", cuts, 0, false ) ;
       fillSet( "h_ht_ldp_met4_nb0", "HT", cuts, 0 ) ;


       sprintf( cuts, "%s&&MET>125&&MET<=150", basecuts_0lep ) ;
       fillSet( "h_ht_zl_nomctrigcorr_met1_nb1", "HT", cuts, 1, false ) ;
       fillSet( "h_ht_zl_met1_nb1", "HT", cuts, 1 ) ;
       sprintf( cuts, "%s&&MET>150&&MET<=250", basecuts_0lep ) ;
       fillSet( "h_ht_zl_nomctrigcorr_met2_nb1", "HT", cuts, 1, false ) ;
       fillSet( "h_ht_zl_met2_nb1", "HT", cuts, 1 ) ;
       sprintf( cuts, "%s&&MET>250&&MET<=350", basecuts_0lep ) ;
       fillSet( "h_ht_zl_nomctrigcorr_met3_nb1", "HT", cuts, 1, false ) ;
       fillSet( "h_ht_zl_met3_nb1", "HT", cuts, 1 ) ;
       sprintf( cuts, "%s&&MET>350", basecuts_0lep ) ;
       fillSet( "h_ht_zl_nomctrigcorr_met4_nb1", "HT", cuts, 1, false ) ;
       fillSet( "h_ht_zl_met4_nb1", "HT", cuts, 1 ) ;

       sprintf( cuts, "%s&&MET>125&&MET<=150", basecuts_0lep_nonb ) ;
       fillSet( "h_ht_zl_nomctrigcorr_met1_nb0", "HT", cuts, 0, false ) ;
       fillSet( "h_ht_zl_met1_nb0", "HT", cuts, 0 ) ;
       sprintf( cuts, "%s&&MET>150&&MET<=250", basecuts_0lep_nonb ) ;
       fillSet( "h_ht_zl_nomctrigcorr_met2_nb0", "HT", cuts, 0, false ) ;
       fillSet( "h_ht_zl_met2_nb0", "HT", cuts, 0 ) ;
       sprintf( cuts, "%s&&MET>250&&MET<=350", basecuts_0lep_nonb ) ;
       fillSet( "h_ht_zl_nomctrigcorr_met3_nb0", "HT", cuts, 0, false ) ;
       fillSet( "h_ht_zl_met3_nb0", "HT", cuts, 0 ) ;
       sprintf( cuts, "%s&&MET>350", basecuts_0lep_nonb ) ;
       fillSet( "h_ht_zl_nomctrigcorr_met4_nb0", "HT", cuts, 0, false ) ;
       fillSet( "h_ht_zl_met4_nb0", "HT", cuts, 0 ) ;
       ...
       sprintf( cuts, "%s", basecuts_0lep_nonb ) ;
       fillSet( "h_met_zl_nb0", "MET", cuts, 0 ) ;
       fillSet( "h_ht_zl_nb0", "HT", cuts, 0 ) ;
       fillSet( "h_met_zl_nomctrigcorr_nb0", "MET", cuts, 0, false ) ;
       fillSet( "h_ht_zl_nomctrigcorr_nb0", "HT", cuts, 0, false ) ;
       fillSetLHB( "h_lhb_zl_nb0", cuts, 0 ) ;
       fillSetLHB( "h_lhb_zl_nomctrigcorr_nb0", cuts, 0, false ) ;

       sprintf( cuts, "%s", basecuts_0lep ) ;
       fillSet( "h_met_zl_nb1", "MET", cuts, 1 ) ;
       fillSet( "h_ht_zl_nb1", "HT", cuts, 1 ) ;
       fillSet( "h_met_zl_nomctrigcorr_nb1", "MET", cuts, 1, false ) ;
       fillSet( "h_ht_zl_nomctrigcorr_nb1", "HT", cuts, 1, false ) ;
       fillSetLHB( "h_lhb_zl_nb1", cuts, 1 ) ;
       fillSetLHB( "h_lhb_zl_nomctrigcorr_nb1", cuts, 1, false ) ;

       sprintf( cuts, "%s", basecuts_0lep ) ;
       fillSet( "h_met_zl_nb2", "MET", cuts, 2 ) ;
       fillSet( "h_ht_zl_nb2", "HT", cuts, 2 ) ;
       fillSet( "h_met_zl_nomctrigcorr_nb2", "MET", cuts, 2, false ) ;
       fillSet( "h_ht_zl_nomctrigcorr_nb2", "HT", cuts, 2, false ) ;
       fillSetLHB( "h_lhb_zl_nb2", cuts, 2 ) ;
       fillSetLHB( "h_lhb_zl_nomctrigcorr_nb2", cuts, 2, false ) ;

       sprintf( cuts, "%s", basecuts_0lep ) ;
       fillSet( "h_met_zl_nb3", "MET", cuts, 3 ) ;
       fillSet( "h_ht_zl_nb3", "HT", cuts, 3 ) ;
       fillSet( "h_met_zl_nomctrigcorr_nb3", "MET", cuts, 3, false ) ;
       fillSet( "h_ht_zl_nomctrigcorr_nb3", "HT", cuts, 3, false ) ;
       fillSetLHB( "h_lhb_zl_nb3", cuts, 3 ) ;
       fillSetLHB( "h_lhb_zl_nomctrigcorr_nb3", cuts, 3, false ) ;
       ...
       fillSet( "h_njets_sl_all", "nJets", cuts, 10 ) ;
       sprintf( cuts, "%s", basecuts_1lep_nonjet_nonb ) ;
       fillSet( "h_njets_sl_nb0", "nJets", cuts, 0 ) ;
       sprintf( cuts, "%s", basecuts_1lep_nonjet ) ;
       fillSet( "h_njets_sl_nb1", "nJets", cuts, 1 ) ;
       sprintf( cuts, "%s", basecuts_1lep_nonjet ) ;
       fillSet( "h_njets_sl_nb2", "nJets", cuts, 2 ) ;
       sprintf( cuts, "%s", basecuts_1lep_nonjet ) ;
       fillSet( "h_njets_sl_nb3", "nJets", cuts, 3 ) ;

       sprintf( cuts, "%s", basecuts_ldp_nonjet ) ;
       fillSet( "h_njets_ldp_all", "nJets", cuts, 10 ) ;
       sprintf( cuts, "%s", basecuts_ldp_nonjet_nonb ) ;
       fillSet( "h_njets_ldp_nb0", "nJets", cuts, 0 ) ;
       sprintf( cuts, "%s", basecuts_ldp_nonjet ) ;
       fillSet( "h_njets_ldp_nb1", "nJets", cuts, 1 ) ;
       sprintf( cuts, "%s", basecuts_ldp_nonjet ) ;
       fillSet( "h_njets_ldp_nb2", "nJets", cuts, 2 ) ;
       sprintf( cuts, "%s", basecuts_ldp_nonjet ) ;
       fillSet( "h_njets_ldp_nb3", "nJets", cuts, 3 ) ;

       sprintf( cuts, "%s", basecuts_0lep_nonjet ) ;
       fillSet( "h_njets_zl_all", "nJets", cuts, 10 ) ;
       sprintf( cuts, "%s", basecuts_0lep_nonjet_nonb ) ;
       fillSet( "h_njets_zl_nb0", "nJets", cuts, 0 ) ;
       sprintf( cuts, "%s", basecuts_0lep_nonjet ) ;
       fillSet( "h_njets_zl_nb1", "nJets", cuts, 1 ) ;
       sprintf( cuts, "%s", basecuts_0lep_nonjet ) ;
       fillSet( "h_njets_zl_nb2", "nJets", cuts, 2 ) ;
       sprintf( cuts, "%s", basecuts_0lep_nonjet ) ;
       fillSet( "h_njets_zl_nb3", "nJets", cuts, 3 ) ;


     //-- MT

       sprintf( cuts, "%s", basecuts_1lep_nomt ) ;
       fillSet( "h_mt_sl_all", "MT", cuts, 10 ) ;
       sprintf( cuts, "%s", basecuts_1lep_nonb_nomt ) ;
       fillSet( "h_mt_sl_nb0", "MT", cuts, 0 ) ;
       sprintf( cuts, "%s", basecuts_1lep_nonb_nomt ) ;
       fillSet( "h_mt_sl_nb1", "MT", cuts, 1 ) ;
       sprintf( cuts, "%s", basecuts_1lep_nonb_nomt ) ;
       fillSet( "h_mt_sl_nb2", "MT", cuts, 2 ) ;
       sprintf( cuts, "%s", basecuts_1lep_nonb_nomt ) ;
       fillSet( "h_mt_sl_nb3", "MT", cuts, 3 ) ;


     //-- NPV

       sprintf( cuts, "%s", basecuts_1lep_nonb ) ;
       fillSet( "h_npv_sl_nb0", "nPV", cuts, 0 ) ;
       sprintf( cuts, "%s", basecuts_ldp_nonb ) ;
       fillSet( "h_npv_ldp_nb0", "nPV", cuts, 0 ) ;
       sprintf( cuts, "%s", basecuts_0lep_nonb ) ;
       fillSet( "h_npv_zl_nb0", "nPV", cuts, 0 ) ;

       sprintf( cuts, "%s", basecuts_1lep_nonb ) ;
       fillSet( "h_npv_sl_nb1", "nPV", cuts, 1 ) ;
       sprintf( cuts, "%s", basecuts_ldp_nonb ) ;
       fillSet( "h_npv_ldp_nb1", "nPV", cuts, 1 ) ;
       sprintf( cuts, "%s", basecuts_0lep_nonb ) ;
       fillSet( "h_npv_zl_nb1", "nPV", cuts, 1 ) ;


      //-- min Delta phi

       sprintf( cuts, "%s", basecuts_0lep_nomindphin_nonb ) ;
       fillSet( "h_mindphi_0lep_nb0", "minDelPhi", cuts, 0 ) ;

       sprintf( cuts, "%s&&MET>125&&MET<150", basecuts_0lep_nomindphin_nonb ) ;
       fillSet( "h_mindphi_0lep_met1_nb0", "minDelPhi", cuts, 0 ) ;
       sprintf( cuts, "%s&&MET>150&&MET<250", basecuts_0lep_nomindphin_nonb ) ;
       fillSet( "h_mindphi_0lep_met2_nb0", "minDelPhi", cuts, 0 ) ;
       sprintf( cuts, "%s&&MET>250&&MET<350", basecuts_0lep_nomindphin_nonb ) ;
       fillSet( "h_mindphi_0lep_met3_nb0", "minDelPhi", cuts, 0 ) ;
       sprintf( cuts, "%s&&MET>350", basecuts_0lep_nomindphin_nonb ) ;
       fillSet( "h_mindphi_0lep_met4_nb0", "minDelPhi", cuts, 0 ) ;

       sprintf( cuts, "%s&&HT>400&&HT<500", basecuts_0lep_nomindphin_nonb ) ;
       fillSet( "h_mindphi_0lep_ht1_nb0", "minDelPhi", cuts, 0 ) ;
       sprintf( cuts, "%s&&HT>500&&HT<800", basecuts_0lep_nomindphin_nonb ) ;
       fillSet( "h_mindphi_0lep_ht2_nb0", "minDelPhi", cuts, 0 ) ;
       sprintf( cuts, "%s&&HT>800&&HT<1000", basecuts_0lep_nomindphin_nonb ) ;
       fillSet( "h_mindphi_0lep_ht3_nb0", "minDelPhi", cuts, 0 ) ;
       sprintf( cuts, "%s&&HT>1000", basecuts_0lep_nomindphin_nonb ) ;
       fillSet( "h_mindphi_0lep_ht4_nb0", "minDelPhi", cuts, 0 ) ;


       sprintf( cuts, "%s", basecuts_0lep_nomindphin ) ;
       fillSet( "h_mindphi_0lep_nb1", "minDelPhi", cuts, 1 ) ;

       sprintf( cuts, "%s&&MET>125&&MET<150", basecuts_0lep_nomindphin ) ;
       fillSet( "h_mindphi_0lep_met1_nb1", "minDelPhi", cuts, 1 ) ;
       sprintf( cuts, "%s&&MET>150&&MET<250", basecuts_0lep_nomindphin ) ;
       fillSet( "h_mindphi_0lep_met2_nb1", "minDelPhi", cuts, 1 ) ;
       sprintf( cuts, "%s&&MET>250&&MET<350", basecuts_0lep_nomindphin ) ;
       fillSet( "h_mindphi_0lep_met3_nb1", "minDelPhi", cuts, 1 ) ;
       sprintf( cuts, "%s&&MET>350", basecuts_0lep_nomindphin ) ;
       fillSet( "h_mindphi_0lep_met4_nb1", "minDelPhi", cuts, 1 ) ;

       sprintf( cuts, "%s&&HT>400&&HT<500", basecuts_0lep_nomindphin ) ;
       fillSet( "h_mindphi_0lep_ht1_nb1", "minDelPhi", cuts, 1 ) ;
       sprintf( cuts, "%s&&HT>500&&HT<800", basecuts_0lep_nomindphin ) ;
       fillSet( "h_mindphi_0lep_ht2_nb1", "minDelPhi", cuts, 1 ) ;
       sprintf( cuts, "%s&&HT>800&&HT<1000", basecuts_0lep_nomindphin ) ;
       fillSet( "h_mindphi_0lep_ht3_nb1", "minDelPhi", cuts, 1 ) ;
       sprintf( cuts, "%s&&HT>1000", basecuts_0lep_nomindphin ) ;
       fillSet( "h_mindphi_0lep_ht4_nb1", "minDelPhi", cuts, 1 ) ;
      ...
      //-- min Delta phi N
       ...
       sprintf( cuts, "%s", basecuts_0lep_nomindphin_nonb ) ;
       fillSet( "h_mindphin_0lep_nb0", "minDelPhiN", cuts, 0 ) ;

       sprintf( cuts, "%s&&MET>125&&MET<150", basecuts_0lep_nomindphin_nonb ) ;
       fillSet( "h_mindphin_0lep_met1_nb0", "minDelPhiN", cuts, 0 ) ;
       sprintf( cuts, "%s&&MET>150&&MET<250", basecuts_0lep_nomindphin_nonb ) ;
       fillSet( "h_mindphin_0lep_met2_nb0", "minDelPhiN", cuts, 0 ) ;
       sprintf( cuts, "%s&&MET>250&&MET<350", basecuts_0lep_nomindphin_nonb ) ;
       fillSet( "h_mindphin_0lep_met3_nb0", "minDelPhiN", cuts, 0 ) ;
       sprintf( cuts, "%s&&MET>350", basecuts_0lep_nomindphin_nonb ) ;
       fillSet( "h_mindphin_0lep_met4_nb0", "minDelPhiN", cuts, 0 ) ;

       sprintf( cuts, "%s&&HT>400&&HT<500", basecuts_0lep_nomindphin_nonb ) ;
       fillSet( "h_mindphin_0lep_ht1_nb0", "minDelPhiN", cuts, 0 ) ;
       sprintf( cuts, "%s&&HT>500&&HT<800", basecuts_0lep_nomindphin_nonb ) ;
       fillSet( "h_mindphin_0lep_ht2_nb0", "minDelPhiN", cuts, 0 ) ;
       sprintf( cuts, "%s&&HT>800&&HT<1000", basecuts_0lep_nomindphin_nonb ) ;
       fillSet( "h_mindphin_0lep_ht3_nb0", "minDelPhiN", cuts, 0 ) ;
       sprintf( cuts, "%s&&HT>1000", basecuts_0lep_nomindphin_nonb ) ;
       fillSet( "h_mindphin_0lep_ht4_nb0", "minDelPhiN", cuts, 0 ) ;


       sprintf( cuts, "%s", basecuts_0lep_nomindphin ) ;
       fillSet( "h_mindphin_0lep_nb1", "minDelPhiN", cuts, 1 ) ;

       sprintf( cuts, "%s&&MET>125&&MET<150", basecuts_0lep_nomindphin ) ;
       fillSet( "h_mindphin_0lep_met1_nb1", "minDelPhiN", cuts, 1 ) ;
       sprintf( cuts, "%s&&MET>150&&MET<250", basecuts_0lep_nomindphin ) ;
       fillSet( "h_mindphin_0lep_met2_nb1", "minDelPhiN", cuts, 1 ) ;
       sprintf( cuts, "%s&&MET>250&&MET<350", basecuts_0lep_nomindphin ) ;
       fillSet( "h_mindphin_0lep_met3_nb1", "minDelPhiN", cuts, 1 ) ;
       sprintf( cuts, "%s&&MET>350", basecuts_0lep_nomindphin ) ;
       fillSet( "h_mindphin_0lep_met4_nb1", "minDelPhiN", cuts, 1 ) ;

       sprintf( cuts, "%s&&HT>400&&HT<500", basecuts_0lep_nomindphin ) ;
       fillSet( "h_mindphin_0lep_ht1_nb1", "minDelPhiN", cuts, 1 ) ;
       sprintf( cuts, "%s&&HT>500&&HT<800", basecuts_0lep_nomindphin ) ;
       fillSet( "h_mindphin_0lep_ht2_nb1", "minDelPhiN", cuts, 1 ) ;
       sprintf( cuts, "%s&&HT>800&&HT<1000", basecuts_0lep_nomindphin ) ;
       fillSet( "h_mindphin_0lep_ht3_nb1", "minDelPhiN", cuts, 1 ) ;
       sprintf( cuts, "%s&&HT>1000", basecuts_0lep_nomindphin ) ;
       fillSet( "h_mindphin_0lep_ht4_nb1", "minDelPhiN", cuts, 1 ) ;



       sprintf( cuts, "%s", basecuts_1lep_nomindphin ) ;
       fillSet( "h_mindphin_1lep_nb1", "minDelPhiN", cuts, 1 ) ;

       sprintf( cuts, "%s&&MET>125&&MET<150", basecuts_1lep_nomindphin ) ;
       fillSet( "h_mindphin_1lep_met1_nb1", "minDelPhiN", cuts, 1 ) ;
       sprintf( cuts, "%s&&MET>150&&MET<250", basecuts_1lep_nomindphin ) ;
       fillSet( "h_mindphin_1lep_met2_nb1", "minDelPhiN", cuts, 1 ) ;
       sprintf( cuts, "%s&&MET>250&&MET<350", basecuts_1lep_nomindphin ) ;
       fillSet( "h_mindphin_1lep_met3_nb1", "minDelPhiN", cuts, 1 ) ;
       sprintf( cuts, "%s&&MET>350", basecuts_1lep_nomindphin ) ;
       fillSet( "h_mindphin_1lep_met4_nb1", "minDelPhiN", cuts, 1 ) ;

       sprintf( cuts, "%s&&HT>400&&HT<500", basecuts_1lep_nomindphin ) ;
       fillSet( "h_mindphin_1lep_ht1_nb1", "minDelPhiN", cuts, 1 ) ;
       sprintf( cuts, "%s&&HT>500&&HT<800", basecuts_1lep_nomindphin ) ;
       fillSet( "h_mindphin_1lep_ht2_nb1", "minDelPhiN", cuts, 1 ) ;
       sprintf( cuts, "%s&&HT>800&&HT<1000", basecuts_1lep_nomindphin ) ;
       fillSet( "h_mindphin_1lep_ht3_nb1", "minDelPhiN", cuts, 1 ) ;
       sprintf( cuts, "%s&&HT>1000", basecuts_1lep_nomindphin ) ;
       fillSet( "h_mindphin_1lep_ht4_nb1", "minDelPhiN", cuts, 1 ) ;


     //--- met ratio

       sprintf( cuts, "%s", basecuts_ldp_nometratiocut ) ;
       fillSet( "h_pfOcaloMET_ldp", "pfOcaloMET", cuts, 10 ) ;
       fillSet( "h_pfOcaloMET_ldp_wide", "pfOcaloMET", cuts, 10 ) ;

       sprintf( cuts, "%s", basecuts_ldp_nonb_nometratiocut ) ;
       fillSet( "h_pfOcaloMET_ldp_nb0", "pfOcaloMET", cuts, 0 ) ;
       fillSet( "h_pfOcaloMET_ldp_nb0_wide", "pfOcaloMET", cuts, 0 ) ;

       sprintf( cuts, "%s", basecuts_ldp_nonb_nometratiocut ) ;
       fillSet( "h_pfOcaloMET_ldp_nb1", "pfOcaloMET", cuts, 1 ) ;
       fillSet( "h_pfOcaloMET_ldp_nb1_wide", "pfOcaloMET", cuts, 1 ) ;

       sprintf( cuts, "%s", basecuts_ldp_nonb_nometratiocut ) ;
       fillSet( "h_pfOcaloMET_ldp_nb2", "pfOcaloMET", cuts, 2 ) ;
       fillSet( "h_pfOcaloMET_ldp_nb2_wide", "pfOcaloMET", cuts, 2 ) ;

       sprintf( cuts, "%s", basecuts_ldp_nonb_nometratiocut ) ;
       fillSet( "h_pfOcaloMET_ldp_nb3", "pfOcaloMET", cuts, 3 ) ;
       fillSet( "h_pfOcaloMET_ldp_nb3_wide", "pfOcaloMET", cuts, 3 ) ;




       sprintf( cuts, "%s", basecuts_1lep_nometratiocut ) ;
       fillSet( "h_pfOcaloMET_sl", "pfOcaloMET", cuts, 10 ) ;
       fillSet( "h_pfOcaloMET_sl_wide", "pfOcaloMET", cuts, 10 ) ;

       sprintf( cuts, "%s", basecuts_1lep_nonb_nometratiocut ) ;
       fillSet( "h_pfOcaloMET_sl_nb0", "pfOcaloMET", cuts, 0 ) ;
       fillSet( "h_pfOcaloMET_sl_nb0_wide", "pfOcaloMET", cuts, 0 ) ;

       sprintf( cuts, "%s", basecuts_1lep_nonb_nometratiocut ) ;
       fillSet( "h_pfOcaloMET_sl_nb1", "pfOcaloMET", cuts, 1 ) ;
       fillSet( "h_pfOcaloMET_sl_nb1_wide", "pfOcaloMET", cuts, 1 ) ;

       sprintf( cuts, "%s", basecuts_1lep_nonb_nometratiocut ) ;
       fillSet( "h_pfOcaloMET_sl_nb2", "pfOcaloMET", cuts, 2 ) ;
       fillSet( "h_pfOcaloMET_sl_nb2_wide", "pfOcaloMET", cuts, 2 ) ;

       sprintf( cuts, "%s", basecuts_1lep_nonb_nometratiocut ) ;
       fillSet( "h_pfOcaloMET_sl_nb3", "pfOcaloMET", cuts, 3 ) ;
       fillSet( "h_pfOcaloMET_sl_nb3_wide", "pfOcaloMET", cuts, 3 ) ;





       sprintf( cuts, "%s", basecuts_0lep_nonb_nometratiocut ) ;
       fillSet( "h_pfOcaloMET_zl_nb0", "pfOcaloMET", cuts, 0 ) ;
       fillSet( "h_pfOcaloMET_zl_nb0_wide", "pfOcaloMET", cuts, 0 ) ;

       sprintf( cuts, "%s", basecuts_0lep_nonb_nometratiocut ) ;
       fillSet( "h_pfOcaloMET_zl_nb1", "pfOcaloMET", cuts, 1 ) ;
       fillSet( "h_pfOcaloMET_zl_nb1_wide", "pfOcaloMET", cuts, 1 ) ;

       sprintf( cuts, "%s", basecuts_0lep_nonb_nometratiocut ) ;
       fillSet( "h_pfOcaloMET_zl_nb2", "pfOcaloMET", cuts, 2 ) ;
       fillSet( "h_pfOcaloMET_zl_nb2_wide", "pfOcaloMET", cuts, 2 ) ;

       sprintf( cuts, "%s", basecuts_0lep_nonb_nometratiocut ) ;
       fillSet( "h_pfOcaloMET_zl_nb3", "pfOcaloMET", cuts, 3 ) ;
       fillSet( "h_pfOcaloMET_zl_nb3_wide", "pfOcaloMET", cuts, 3 ) ;
     ...
     //--- number of isolated tracks.
       ...
       sprintf( cuts, "%s", basecuts_0lep_nonb_noisotrk ) ;
       fillSet( "h_nisotrk_zl_nb0", "nIsoTrk", cuts, 0 ) ;
       sprintf( cuts, "%s", basecuts_0lep_nonb_noisotrk ) ;
       fillSet( "h_nisotrk_zl_nb1", "nIsoTrk", cuts, 1 ) ;
       sprintf( cuts, "%s", basecuts_0lep_nonb_noisotrk ) ;
       fillSet( "h_nisotrk_zl_nb2", "nIsoTrk", cuts, 2 ) ;
       sprintf( cuts, "%s", basecuts_0lep_nonb_noisotrk ) ;
       fillSet( "h_nisotrk_zl_nb3", "nIsoTrk", cuts, 3 ) ;

       sprintf( cuts, "%s", basecuts_ldp_nonb_noisotrk ) ;
       fillSet( "h_nisotrk_ldp_nb0", "nIsoTrk", cuts, 0 ) ;
       sprintf( cuts, "%s", basecuts_ldp_nonb_noisotrk ) ;
       fillSet( "h_nisotrk_ldp_nb1", "nIsoTrk", cuts, 1 ) ;
       sprintf( cuts, "%s", basecuts_ldp_nonb_noisotrk ) ;
       fillSet( "h_nisotrk_ldp_nb2", "nIsoTrk", cuts, 2 ) ;
       sprintf( cuts, "%s", basecuts_ldp_nonb_noisotrk ) ;
       fillSet( "h_nisotrk_ldp_nb3", "nIsoTrk", cuts, 3 ) ;

       sprintf( cuts, "%s", basecuts_1lep_nonb_noisotrk ) ;
       fillSet( "h_nisotrk_sl_nb0", "nIsoTrk", cuts, 0 ) ;
       sprintf( cuts, "%s", basecuts_1lep_nonb_noisotrk ) ;
       fillSet( "h_nisotrk_sl_nb1", "nIsoTrk", cuts, 1 ) ;
       sprintf( cuts, "%s", basecuts_1lep_nonb_noisotrk ) ;
       fillSet( "h_nisotrk_sl_nb2", "nIsoTrk", cuts, 2 ) ;
       sprintf( cuts, "%s", basecuts_1lep_nonb_noisotrk ) ;
       fillSet( "h_nisotrk_sl_nb3", "nIsoTrk", cuts, 3 ) ;



     //--- max Ncharged - Nneutral for jets in |eta| from 0.9 to 1.9 with Pt>50.

       sprintf( cuts, "%s", basecuts_0lep_nonb_nomaxchmultdiff ) ;
       fillSet( "h_maxchnmultdiff_zl_nb0", "maxChNMultDiff", cuts, 0 ) ;
       sprintf( cuts, "%s", basecuts_0lep_nonb_nomaxchmultdiff ) ;
       fillSet( "h_maxchnmultdiff_zl_nb1", "maxChNMultDiff", cuts, 1 ) ;
       sprintf( cuts, "%s", basecuts_0lep_nonb_nomaxchmultdiff ) ;
       fillSet( "h_maxchnmultdiff_zl_nb2", "maxChNMultDiff", cuts, 2 ) ;
       sprintf( cuts, "%s", basecuts_0lep_nonb_nomaxchmultdiff ) ;
       fillSet( "h_maxchnmultdiff_zl_nb3", "maxChNMultDiff", cuts, 3 ) ;

       sprintf( cuts, "%s", basecuts_ldp_nonb_nomaxchmultdiff ) ;
       fillSet( "h_maxchnmultdiff_ldp_nb0", "maxChNMultDiff", cuts, 0 ) ;
       sprintf( cuts, "%s", basecuts_ldp_nonb_nomaxchmultdiff ) ;
       fillSet( "h_maxchnmultdiff_ldp_nb1", "maxChNMultDiff", cuts, 1 ) ;
       sprintf( cuts, "%s", basecuts_ldp_nonb_nomaxchmultdiff ) ;
       fillSet( "h_maxchnmultdiff_ldp_nb2", "maxChNMultDiff", cuts, 2 ) ;
       sprintf( cuts, "%s", basecuts_ldp_nonb_nomaxchmultdiff ) ;
       fillSet( "h_maxchnmultdiff_ldp_nb3", "maxChNMultDiff", cuts, 3 ) ;

       sprintf( cuts, "%s", basecuts_1lep_nonb_nomaxchmultdiff ) ;
       fillSet( "h_maxchnmultdiff_sl_nb0", "maxChNMultDiff", cuts, 0 ) ;
       sprintf( cuts, "%s", basecuts_1lep_nonb_nomaxchmultdiff ) ;
       fillSet( "h_maxchnmultdiff_sl_nb1", "maxChNMultDiff", cuts, 1 ) ;
       sprintf( cuts, "%s", basecuts_1lep_nonb_nomaxchmultdiff ) ;
       fillSet( "h_maxchnmultdiff_sl_nb2", "maxChNMultDiff", cuts, 2 ) ;
       sprintf( cuts, "%s", basecuts_1lep_nonb_nomaxchmultdiff ) ;
       fillSet( "h_maxchnmultdiff_sl_nb3", "maxChNMultDiff", cuts, 3 ) ;
       ...
       char outfile[10000] ;
       //---------------------
       sprintf( outfile, "rootfiles/dmc_plots_btw_%s.root", dataset_string ) ;
       /////// sprintf( outfile, "rootfiles/dmc_plots_btw_smallQcd_%s.root", dataset_string ) ;
       //---------------------
       saveHist( outfile, "h*" ) ;
   ...
   //----------------------------
    ...
    void fillSetLHB( const char* hname_base, const char* cuts, int nb_requirement, bool doTrigCorr ) {
          ...
          if ( ci==0 ) {
             ...
             if ( doTrigCorr ) {
                if ( nb_requirement < 0 ) {
                   ...
                   sprintf( arg2, "(1.0-prob1-prob2-probge3)*trigWeight*(%s)", cuts ) ;
                } else if ( nb_requirement == 1 ) {
                   sprintf( arg2, "prob1*trigWeight*(%s)", cuts ) ;
                } else if ( nb_requirement == 2 ) {
                   sprintf( arg2, "prob2*trigWeight*(%s)", cuts ) ;
                } else if ( nb_requirement == 3 ) {
                   sprintf( arg2, "probge3*trigWeight*(%s)", cuts ) ;
                } else if ( nb_requirement == 10 ) {
                   sprintf( arg2, "(prob1+prob2+probge3)*trigWeight*(%s)", cuts ) ;
                } else {
                   printf(" *** illegal nb_requirement : %d \n\n", nb_requirement ) ;
                   return ;
                }
             } else {
                if ( nb_requirement < 0 ) {
                   ...
                   sprintf( arg2, "(1.0-prob1-prob2-probge3)*(%s)", cuts ) ;
                } else if ( nb_requirement == 1 ) {
                   ...
                   sprintf( arg2, "(prob1+prob2+probge3)*(%s)", cuts ) ;
                } else {
                   printf(" *** illegal nb_requirement : %d \n\n", nb_requirement ) ;
                   return ;
                }
   ...
   //----------------------------
    ...
    void fillSet( const char* hname_base, const char* varname, const char* cuts, int nb_requirement, bool doTrigCorr ) {
