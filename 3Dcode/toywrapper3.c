  ...
  void toywrapper3( const char* input_datfile = "datfiles/Input-met3-ht3-v1-wclosuresyst.dat",
                ...
                const char* input_outputDir = "output-toymc3-mgl800-mlsp700-100evts-wsyst-test1a-useEZLtrue",
                int nToy = 10,
