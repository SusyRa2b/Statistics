...
#include "TSystem.h"
#include "TRandom.h"
#include "ra2bRoostatsClass3D_4b.c"
...
// static const int nBinsHT   = 4 ;
   ...
   void toymc4b( const char* input_datfile = "datfiles/Input-met4-ht4-wsyst1.dat",
                ...
                const char* input_outputDir = "output-toymc4b",
                int nToy = 10,
       ...
       ra2bRoostatsClass3D_4b ra2b ;

       qcdModelIndex = 3 ;

       char wsfilename[10000] ;
       sprintf( wsfilename, "%s/ws.root", outputDir ) ;
       ra2b.initialize( input_datfile, input_susyfile, mgl, mlsp, false, 0., input_deffdbtagfile, qcdModelIndex, wsfilename, true ) ;
