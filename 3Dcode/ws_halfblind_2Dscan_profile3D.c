...
#include <string.h>
  ...
  //==============================================================================================
   ...
   void ws_halfblind_2Dscan_profile3D( const char* wsfile = "rootfiles/ws-data-unblind.root",
                                   const char* new_poi_name_x = "n_M4_H2_3b",
                                   int npoiPoints_x = 9, // use odd values only
                                   double poiMinVal_x = 5.,
                                   double poiMaxVal_x = 13.,
                                   const char* new_poi_name_y = "n_M4_H3_3b",
    ...
    //----------------------------------------------------------------------------------------------
     ...
     //-----------------
       ...
       for ( int i=0; i<npoiPoints; i++ ) {
          printf("  %2d : poi_x, poi_y = %6.1f, %6.1f   nll = %g\n", i, poiVals_x[i], poiVals_y[i], nllVals[i] ) ;
       }
       printf("\n\n") ;
