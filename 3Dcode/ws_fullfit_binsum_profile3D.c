...
#include <string.h>
  ...
  //==============================================================================================
   ...
   void ws_fullfit_binsum_profile3D( const char* wsfile = "rootfiles/ws-data-unblind.root",
   ...
   /// rrv_poiValue->setConstant(kTRUE) ;
    ...
    //----------------------------------------------------------------------------------------------
      ...
      //--- Main canvas
       ...
       sprintf( outrootfile, "%s/scan-ff-bs-%s.root", outputdir.Data(), new_poi_name ) ;

       char outpdffile[10000] ;
       sprintf( outpdffile, "%s/scan-ff-bs-%s.pdf", outputdir.Data(), new_poi_name ) ;
