...
#include <fstream>
  ...
  //=============================================================================================================================
   ...
   void mcclosure5( const char* infile = "rootfiles/gi-plots-met4-ht4.root",
      ...
      if ( qcdModelIndex == 4 ) {
         printf("\n\n *** Use mcclosure4.c for QCD model 4.\n\n") ; return ;
      }
      if ( qcdModelIndex < 2 || qcdModelIndex > 5 ) {
         printf("\n\n *** Unsupported qcdModelIndex (%d).  Try 2, 3, or 5.\n\n", qcdModelIndex ) ; return ;
      }
   ...
   //----
    ...
    //--- insert ttwj numbers into file.
     ...
     //--- Plot all samples together
      ...
      if ( savePlots ) {
         cqcd2 -> SaveAs("outputfiles/mcclosure5-qcd-allonone.png") ;
         cqcd2 -> SaveAs("outputfiles/mcclosure5-qcd-allonone.pdf") ;
      }
     ...
     //--- Go through the samples, 1 by 1, and draw numerator, denominator, and ratio
      ...
      for ( int si=0; si<nQcdSamples; si++ ) {
         ...
         if ( savePlots ) {
            char filename[1000] ;
            sprintf( filename, "outputfiles/mcclosure5-qcd-%s.pdf", samplename[si] ) ;
            cqcd3 -> SaveAs( filename ) ;
            sprintf( filename, "outputfiles/mcclosure5-qcd-%s.png", samplename[si] ) ;
            cqcd3 -> SaveAs( filename ) ;
         }
     ...
     //--- Draw the average 0lep/LDP ratio with MC stat error and total error.
      ...
      if ( savePlots ) {
         cqcd4 -> SaveAs("outputfiles/mcclosure5-qcd-averatio.png") ;
         cqcd4 -> SaveAs("outputfiles/mcclosure5-qcd-averatio.pdf") ;
      }
     ...
     //--- Draw the QCD scale factor with MC stat error and total error.
      ...
      if ( savePlots ) {
         char filename[1000] ;
         sprintf( filename, "outputfiles/mcclosure5-qcd-scalefactor-model%d.png", qcdModelIndex ) ;
         cqcd5 -> SaveAs( filename ) ;
         sprintf( filename, "outputfiles/mcclosure5-qcd-scalefactor-model%d.pdf", qcdModelIndex ) ;
         cqcd5 -> SaveAs( filename ) ;
      }
