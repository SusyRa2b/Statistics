   ...
   void make_ws_rootfile3b( const char* input_datfile = "output-toymc3b-debug1/Input-met3-ht3-v5-wclosuresyst-wttwjcorr-wqcdcorr-toy0000.dat",
       ...
       ra2b.initialize( input_datfile, input_susyfile, mgl, mlsp, false, 0., input_deffdbtagfile, input_deffdbtagfile_lightflavor, qcdModelIndex, wsrootfilename, blindBinsList, systfilename, pdf_syst_file, wjets_xsec_shapesyst_file, singletop_xsec_shapesyst_file, isr_shapesyst_file ) ;
