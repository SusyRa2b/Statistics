...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   newtree->Branch("prob3", &prob3, "prob3/f"); 
   newtree->Branch("probge3", &probge3, "probge3/f"); 
   newtree->Branch("probge4", &probge4, "probge4/f"); 
   ...
   newtree->Branch("SUSY_recoilPt",&SUSY_recoilPt, "SUSY_recoilPt/f");
   newtree->Branch("mjj_bestTwoCSV",&mjj_bestTwoCSV, "mjj_bestTwoCSV/f");
   newtree->Branch("mjj_closestB",&mjj_closestB, "mjj_closestB/f");
   newtree->Branch("deltaR_bestTwoCSV",&deltaR_bestTwoCSV, "deltaR_bestTwoCSV/f");
   newtree->Branch("deltaR_closestB",&deltaR_closestB, "deltaR_closestB/f");
