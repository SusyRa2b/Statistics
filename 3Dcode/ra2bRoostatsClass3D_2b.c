#include "ra2bRoostatsClass3D_2b.h"

//
//  Owen: The difference between ra2bRoostatsClass3D_1 and ra2bRoostatsClass3D_2b
...
#include "betaPrimeConstraint.c"
  ...
  //=====================================================================================================
   ...
   ra2bRoostatsClass3D_2b::ra2bRoostatsClass3D_2b() {
  ...
  //===================================================================
    ...
    bool ra2bRoostatsClass3D_2b::initialize( const char* infile ,
  ...
  //////                                                 RooArgSet( *rv_mu_susymc_ldp[i][j][k], *rv_mu_susy_M1_H1_1b, *rv_mu_susymc[0][0][0] ) ) ;
   ...
   //=====================================================================================================================
    ...
    bool ra2bRoostatsClass3D_2b::setSusyScanPoint( const char* inputScanFile,
						  double m0, double m12, bool isT1bbbb, double t1bbbbXsec,
						  const char* inputSusy_deff_dbtageff_file
						  ) {
   ...
   //==============================================================================================================
    ...
    void ra2bRoostatsClass3D_2b::mismatchErr( char* label, TString inPar ) {
   ...
   //==============================================================================================================
    ...
    RooAbsReal* ra2bRoostatsClass3D_2b::makeBetaConstraint( const char* NP_name, double NP_val, double NP_err ) {

       if ( NP_val >=1 ) {
          printf("\n\n *** ra2bRoostatsClass3D_2b::makeBetaConstraint:  warning.  Input efficiency value is %g.  Resetting to 0.999.\n\n", NP_val) ;
          NP_val = 0.999 ;
       }
   ...
   //==============================================================================================================
    ...
    RooAbsReal* ra2bRoostatsClass3D_2b::makeCorrelatedBetaPrimeConstraint( 
       ...
       if ( baseFailPar != 0x0 ) {
          ...
          printf("\n\n *** ra2bRoostatsClass3D_2b::makeCorrelatedBetaPrimeConstraint: can't find base fail parameter.\n\n") ;
          return 0x0 ;
       }
       ...
       if ( basePassPar != 0x0 ) {
          ...
          printf("\n\n *** ra2bRoostatsClass3D_2b::makeCorrelatedBetaPrimeConstraint: can't find base pass parameter.\n\n") ;
          return 0x0 ;
       }
       ...
       if ( baseFailObs != 0x0 ) {
          ...
          printf("\n\n *** ra2bRoostatsClass3D_2b::makeCorrelatedBetaPrimeConstraint: can't find base fail obs.\n\n") ;
          return 0x0 ;
       }
       ...
       if ( basePassObs != 0x0 ) {
          ...
          printf("\n\n *** ra2bRoostatsClass3D_2b::makeCorrelatedBetaPrimeConstraint: can't find base pass obs.\n\n") ;
          return 0x0 ;
       }
   ...
   //==============================================================================================================
    ...
    RooAbsReal* ra2bRoostatsClass3D_2b::makeCorrelatedBetaConstraint(
        const char* NP_name, double NP_val, double NP_err, const char* NP_base_name, bool changeSign ) {
