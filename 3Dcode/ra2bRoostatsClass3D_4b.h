#ifndef ra2bRoostatsClass3D_4b_h
#define ra2bRoostatsClass3D_4b_h
...
#include "RooArgSet.h"
   ...
   class ra2bRoostatsClass3D_4b {

     public :

       ra2bRoostatsClass3D_4b() ;

       virtual ~ra2bRoostatsClass3D_4b();
