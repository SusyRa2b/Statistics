#include "ra2bRoostatsClass3D_4b.h"

//
//  Owen: The difference between ra2bRoostatsClass3D_1 and ra2bRoostatsClass3D_4b
...
//
//          ra2bRoostatsClass3D_4b : As ra2bRoostatsClass3D_3b, but the b-jet shape 
//                                   of the SL sample is constrained using 2b/1b and 
//                                   3b/1b fractions that are provided externally
//
//
...
#include "betaPrimeConstraint.c"
  ...
  //=====================================================================================================
   ...
   ra2bRoostatsClass3D_4b::ra2bRoostatsClass3D_4b() {
  ...
  //===================================================================
    ...
    bool ra2bRoostatsClass3D_4b::initialize( const char* infile ,
   ...
   // char equal;
	...
	for (int j = 0 ; j < nBinsHT ; j++) {
	  for (int k = 0 ; k < nBinsBtag ; k++) {     
	    ...
	    if ( k == 0 ) { initialval_ttwj_sl[i][j][k] = N_1lep[i][j][k] ; }
	    else { initialval_ttwj_sl[i][j][k] = N_1lep[i][j][0]*sl_fracNb_val[i][j][k] ; }
	...
	for (int i = 0 ; i < nBinsMET ; i++) {
	  for (int j = 0 ; j < nBinsHT ; j++) {
	      ...
	      //rar_sl_fracNb[i][j][k] = makeBetaConstraint( NP_name, sl_fracNb_val[i][j][k], sl_fracNb_err[i][j][k] ) ;
	...
	for (int j = 0 ; j < nBinsHT ; j++) {
	  for (int k = 0 ; k < nBinsBtag ; k++) {     
	    ...
	    //---- TTWJ SL (implement here the constraint on the b-jet shape

	     TString ttwjSlString   = "mu_ttwj_sl";
	     ttwjSlString   += sMbins[i]+sHbins[j]+sBbins[k] ;

	     if ( k == 0 || !addBjetSLconstraint ) {
   ...
   //=====================================================================================================================
    ...
    bool ra2bRoostatsClass3D_4b::setSusyScanPoint( const char* inputScanFile,
						  double m0, double m12, bool isT1bbbb, double t1bbbbXsec,
						  const char* inputSusy_deff_dbtageff_file
						  ) {
   ...
   //==============================================================================================================
    ...
    void ra2bRoostatsClass3D_4b::mismatchErr( char* label, TString inPar ) {
   ...
   //==============================================================================================================
    ...
    RooAbsReal* ra2bRoostatsClass3D_4b::makeBetaPrimeConstraint( const char* NP_name, double NP_val, double NP_err ) {
   ...
   //==============================================================================================================
    ...
    RooAbsReal* ra2bRoostatsClass3D_4b::makeBetaConstraint( const char* NP_name, double NP_val, double NP_err ) {

       if ( NP_val >=1 ) {
          printf("\n\n *** ra2bRoostatsClass3D_4b::makeBetaConstraint:  warning.  Input efficiency value is %g.  Resetting to 0.999.\n\n", NP_val) ;
          NP_val = 0.999 ;
       }
   ...
   //==============================================================================================================
    ...
    RooAbsReal* ra2bRoostatsClass3D_4b::makeCorrelatedBetaPrimeConstraint( 
       ...
       if ( baseFailPar != 0x0 ) {
          ...
          printf("\n\n *** ra2bRoostatsClass3D_4b::makeCorrelatedBetaPrimeConstraint: can't find base fail parameter.\n\n") ;
          return 0x0 ;
       }
       ...
       if ( basePassPar != 0x0 ) {
          ...
          printf("\n\n *** ra2bRoostatsClass3D_4b::makeCorrelatedBetaPrimeConstraint: can't find base pass parameter.\n\n") ;
          return 0x0 ;
       }
       ...
       if ( baseFailObs != 0x0 ) {
          ...
          printf("\n\n *** ra2bRoostatsClass3D_4b::makeCorrelatedBetaPrimeConstraint: can't find base fail obs.\n\n") ;
          return 0x0 ;
       }
       ...
       if ( basePassObs != 0x0 ) {
          ...
          printf("\n\n *** ra2bRoostatsClass3D_4b::makeCorrelatedBetaPrimeConstraint: can't find base pass obs.\n\n") ;
          return 0x0 ;
       }
   ...
   //==============================================================================================================
    ...
    RooAbsReal* ra2bRoostatsClass3D_4b::makeCorrelatedBetaConstraint(
        const char* NP_name, double NP_val, double NP_err, const char* NP_base_name, bool changeSign ) {
   ...
   //==============================================================================================================
    ...
    RooAbsReal* ra2bRoostatsClass3D_4b::makeGaussianConstraint( const char* NP_name, double NP_val, double NP_err, bool allowNegative ) {
   ...
   //==============================================================================================================
    ...
    RooAbsReal* ra2bRoostatsClass3D_4b::makeCorrelatedGaussianConstraint(
            const char* NP_name, double NP_val, double NP_err, const char* NP_base_name, bool changeSign ) {
