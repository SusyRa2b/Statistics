...
//----------------
   ...
   void draw_mctruth_plots3D_ge4b( const char* histfile = "gi-plots.root",
                              bool logy=false,
                              bool doNorm=false,
                              double normmax=2.0,
                              int metgroupzoom=1,
     ...
     TH1F* hmctruth_allsm_0lep_4b =  (TH1F*) gDirectory->FindObject("hmctruth_allsm_0lep_4b") ;
     TH1F* hmctruth_ttwj_0lep_4b =  (TH1F*) gDirectory->FindObject("hmctruth_ttwj_0lep_4b") ;
     TH1F* hmctruth_qcd_0lep_4b  =  (TH1F*) gDirectory->FindObject("hmctruth_qcd_0lep_4b") ;
     TH1F* hmctruth_znn_0lep_4b  =  (TH1F*) gDirectory->FindObject("hmctruth_znn_0lep_4b") ;
     if ( hmctruth_allsm_0lep_4b == 0 ) { printf("\n\n*** hmctruth_allsm_0lep_4b missing.\n\n") ; return ; }
     if ( hmctruth_ttwj_0lep_4b == 0 ) { printf("\n\n*** hmctruth_ttwj_0lep_4b missing.\n\n") ; return ; }
     if ( hmctruth_qcd_0lep_4b == 0 ) { printf("\n\n*** hmctruth_qcd_0lep_4b missing.\n\n") ; return ; }
     if ( hmctruth_znn_0lep_4b == 0 ) { printf("\n\n*** hmctruth_znn_0lep_4b missing.\n\n") ; return ; }
     ...
     TH1F* hmctruth_allsm_1lep_4b =  (TH1F*) gDirectory->FindObject("hmctruth_allsm_1lep_4b") ;
     TH1F* hmctruth_ttwj_1lep_4b =  (TH1F*) gDirectory->FindObject("hmctruth_ttwj_1lep_4b") ;
     TH1F* hmctruth_qcd_1lep_4b  =  (TH1F*) gDirectory->FindObject("hmctruth_qcd_1lep_4b") ;
     TH1F* hmctruth_znn_1lep_4b  =  (TH1F*) gDirectory->FindObject("hmctruth_znn_1lep_4b") ;
     ...
     TH1F* hmctruth_allsm_ldp_4b =  (TH1F*) gDirectory->FindObject("hmctruth_allsm_ldp_4b") ;
     TH1F* hmctruth_ttwj_ldp_4b =  (TH1F*) gDirectory->FindObject("hmctruth_ttwj_ldp_4b") ;
     TH1F* hmctruth_qcd_ldp_4b  =  (TH1F*) gDirectory->FindObject("hmctruth_qcd_ldp_4b") ;
     ...
     TH1F* hmctruth_susy_0lep_4b =  (TH1F*) gDirectory->FindObject("hmctruth_susy_0lep_4b") ;
     ...
     TH1F* hmctruth_susy_1lep_4b =  (TH1F*) gDirectory->FindObject("hmctruth_susy_1lep_4b") ;
     ...
     TH1F* hmctruth_susy_ldp_4b =  (TH1F*) gDirectory->FindObject("hmctruth_susy_ldp_4b") ;
     ...
     if ( hmctruth_susy_0lep_4b == 0 ) { printf("\n\n*** hmctruth_susy_0lep_4b missing.\n\n") ; return ; }
     ...
     hmctruth_susy_0lep_4b->Scale( susyScaleFactor ) ;
     ...
     hmctruth_susy_1lep_4b->Scale( susyScaleFactor ) ;
     ...
     hmctruth_susy_ldp_4b->Scale( susyScaleFactor ) ;
     ...
     int nbtagmult(4) ;
     char btagmultname[4][100] = { "1b", "2b", "3b", "4b" } ;
     ...
     hmctruth_qcd_0lep_4b   -> SetFillColor(2) ;
     hmctruth_znn_0lep_4b   -> SetFillColor(kGreen-3) ;
     hmctruth_susy_0lep_4b  -> SetFillColor(6) ;
     ...
     hmctruth_qcd_1lep_4b   -> SetFillColor(2) ;
     hmctruth_znn_1lep_4b   -> SetFillColor(kGreen-3) ;
     hmctruth_susy_1lep_4b  -> SetFillColor(6) ;
     ...
     hmctruth_ttwj_ldp_4b  -> SetFillColor(kBlue-9) ;
     hmctruth_qcd_ldp_4b   -> SetFillColor(2) ;
     hmctruth_znn_ldp_4b   -> SetFillColor(kGreen-3) ;
     hmctruth_susy_ldp_4b  -> SetFillColor(6) ;
     ...
     THStack* hmctruth_fit_0lep_4b = new THStack( "hmctruth_fit_0lep_4b", "RA2b likelihood fit results, fit" ) ;
     ...
     THStack* hmctruth_fit_1lep_4b = new THStack( "hmctruth_fit_1lep_4b", "RA2b likelihood fit results, fit" ) ;
     ...
     THStack* hmctruth_fit_ldp_4b  = new THStack( "hmctruth_fit_ldp_4b",  "RA2b likelihood fit results, fit" ) ;
     ...
     hmctruth_fit_0lep_4b->Add( hmctruth_znn_0lep_4b ) ;
     hmctruth_fit_0lep_4b->Add( hmctruth_qcd_0lep_4b ) ;
     hmctruth_fit_0lep_4b->Add( hmctruth_ttwj_0lep_4b ) ;
     hmctruth_fit_0lep_4b->Add( hmctruth_susy_0lep_4b ) ;
     ...
     hmctruth_fit_1lep_4b->Add( hmctruth_znn_1lep_4b ) ;
     hmctruth_fit_1lep_4b->Add( hmctruth_qcd_1lep_4b ) ;
     hmctruth_fit_1lep_4b->Add( hmctruth_ttwj_1lep_4b ) ;
     hmctruth_fit_1lep_4b->Add( hmctruth_susy_1lep_4b ) ;
     ...
     hmctruth_fit_ldp_4b->Add( hmctruth_znn_ldp_4b ) ;
     hmctruth_fit_ldp_4b->Add( hmctruth_qcd_ldp_4b ) ;
     hmctruth_fit_ldp_4b->Add( hmctruth_ttwj_ldp_4b ) ;
     hmctruth_fit_ldp_4b->Add( hmctruth_susy_ldp_4b ) ;
     ...
     TCanvas* cmctruth = (TCanvas*) gDirectory->FindObject("cmctruth_ge4b") ;
     if ( cmctruth==0 ) {
        printf("\n\n Creating cmctruth canvas.\n\n") ;
        cmctruth = new TCanvas("cmctruth_ge4b","RA2b fit quality", 850, 1000 ) ;
     } else {
     ...
     if ( metgroupzoom>1 && !logy ) {
        ...
        hmctruth_allsm_0lep_4b->SetMaximum( maxSF*(hmctruth_allsm_0lep_4b->GetBinContent( zoomRefBin )) ) ;
        ...
        hmctruth_allsm_1lep_4b->SetMaximum( maxSF*(hmctruth_allsm_1lep_4b->GetBinContent( zoomRefBin )) ) ;
        ...
        hmctruth_allsm_ldp_4b->SetMaximum( maxSF*(hmctruth_allsm_ldp_4b->GetBinContent( zoomRefBin+2 )) ) ;
     ...
     printf(" pad 1\n") ; cout << flush ;
     cmctruth->cd(1);
     hmctruth_allsm_0lep_1b->UseCurrentStyle() ;
     ...
     printf(" pad 2\n") ; cout << flush ;
     cmctruth->cd(2);
     hmctruth_allsm_0lep_2b->UseCurrentStyle() ;
     ...
     printf(" pad 3\n") ; cout << flush ;
     cmctruth->cd(3);
     hmctruth_allsm_0lep_3b->UseCurrentStyle() ;
     ...
     printf(" pad 4\n") ; cout << flush ;
     cmctruth->cd(4);
     hmctruth_allsm_0lep_4b->UseCurrentStyle() ;
     hmctruth_allsm_0lep_4b->Draw("histpe") ;
     hmctruth_fit_0lep_4b->Draw("histsame") ;
     hmctruth_allsm_0lep_4b->Draw("same") ;
     gPad->SetGridy(1) ;
     ...
     printf(" pad 5\n") ; cout << flush ;
     cmctruth->cd(5);
     hmctruth_allsm_1lep_1b->UseCurrentStyle() ;
     ...
     printf(" pad 6\n") ; cout << flush ;
     cmctruth->cd(6);
     hmctruth_allsm_1lep_2b->UseCurrentStyle() ;
     ...
     printf(" pad 7\n") ; cout << flush ;
     cmctruth->cd(7);
     hmctruth_allsm_1lep_3b->UseCurrentStyle() ;
     ...
     printf(" pad 8\n") ; cout << flush ;
     cmctruth->cd(8);
     hmctruth_allsm_1lep_4b->UseCurrentStyle() ;
     hmctruth_allsm_1lep_4b->Draw("histpe") ;
     hmctruth_fit_1lep_4b->Draw("histsame") ;
     hmctruth_allsm_1lep_4b->Draw("same") ;
     gPad->SetGridy(1) ;
     ...
     printf(" pad 9\n") ; cout << flush ;
     cmctruth->cd(9);
     hmctruth_allsm_ldp_1b->UseCurrentStyle() ;
     ...
     printf(" pad 10\n") ; cout << flush ;
     cmctruth->cd(10);
     hmctruth_allsm_ldp_2b->UseCurrentStyle() ;
     ...
     printf(" pad 11\n") ; cout << flush ;
     cmctruth->cd(11);
     hmctruth_allsm_ldp_3b->UseCurrentStyle() ;
     ...
     printf(" pad 12\n") ; cout << flush ;
     cmctruth->cd(12);
     hmctruth_allsm_ldp_4b->UseCurrentStyle() ;
     hmctruth_allsm_ldp_4b->Draw("histpe") ;
     hmctruth_fit_ldp_4b->Draw("histsame") ;
     hmctruth_allsm_ldp_4b->Draw("same") ;
     gPad->SetGridy(1) ;
     ...
     cmctruth->SaveAs("mctruth_ge4b.gif") ;
