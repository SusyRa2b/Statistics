#include "ra2bRoostatsClass3D_3b_LEPT.h"
...
#include "RooProdPdfLogSum.h"
  ...
  //=====================================================================================================
   ...
   ra2bRoostatsClass3D_3b_LEPT::ra2bRoostatsClass3D_3b_LEPT() {
  ...
  //===================================================================
    ...
    bool ra2bRoostatsClass3D_3b_LEPT::initialize( const char* infile ,
   ...
   //=====================================================================================================================
    ...
    bool ra2bRoostatsClass3D_3b_LEPT::setSusyScanPoint( const char* inputScanFile,
   ...
   //==============================================================================================================
    ...
    void ra2bRoostatsClass3D_3b_LEPT::mismatchErr( char* label, TString inPar ) {
   ...
   //==============================================================================================================
    ...
    RooAbsReal* ra2bRoostatsClass3D_3b_LEPT::makeBetaPrimeConstraint( const char* NP_name, double NP_val, double NP_err ) {
   ...
   RooAbsReal* ra2bRoostatsClass3D_3b_LEPT::makeBetaConstraint( const char* NP_name, double NP_val, double NP_err, RooWorkspace& workspace ) {
       ...
       if ( NP_val >=1 ) {
          printf("\n\n *** ra2bRoostatsClass3D_3b_LEPT::makeBetaConstraint:  warning.  Input efficiency value is %g.  Resetting to 0.999.\n\n", NP_val) ;
          NP_val = 0.999 ;
       }
   ...
   //==============================================================================================================
    ...
    RooAbsReal* ra2bRoostatsClass3D_3b_LEPT::makeCorrelatedBetaPrimeConstraint( 
       ...
       if ( baseFailPar != 0x0 ) {
          ...
          printf("\n\n *** ra2bRoostatsClass3D_3b_LEPT::makeCorrelatedBetaPrimeConstraint: can't find base fail parameter.\n\n") ;
          return 0x0 ;
       }
       ...
       if ( basePassPar != 0x0 ) {
          ...
          printf("\n\n *** ra2bRoostatsClass3D_3b_LEPT::makeCorrelatedBetaPrimeConstraint: can't find base pass parameter.\n\n") ;
          return 0x0 ;
       }
       ...
       if ( baseFailObs != 0x0 ) {
          ...
          printf("\n\n *** ra2bRoostatsClass3D_3b_LEPT::makeCorrelatedBetaPrimeConstraint: can't find base fail obs.\n\n") ;
          return 0x0 ;
       }
       ...
       if ( basePassObs != 0x0 ) {
          ...
          printf("\n\n *** ra2bRoostatsClass3D_3b_LEPT::makeCorrelatedBetaPrimeConstraint: can't find base pass obs.\n\n") ;
          return 0x0 ;
       }
   ...
   //==============================================================================================================
    ...
    RooAbsReal* ra2bRoostatsClass3D_3b_LEPT::makeCorrelatedBetaConstraint(
        const char* NP_name, double NP_val, double NP_err, const char* NP_base_name, bool changeSign ) {
   ...
   //==============================================================================================================
    ...
    RooAbsReal* ra2bRoostatsClass3D_3b_LEPT::makeGaussianConstraint( const char* NP_name, double NP_val, double NP_err, bool allowNegative ) {
   ...
   //==============================================================================================================
    ...
    RooAbsReal* ra2bRoostatsClass3D_3b_LEPT::makeLognormalConstraint( const char* NP_name, double NP_val, double NP_err ) {
   ...
   //==============================================================================================================
    ...
    RooAbsReal* ra2bRoostatsClass3D_3b_LEPT::makeCorrelatedGaussianConstraint(
   ...
   //==============================================================================================================
    ...
    RooAbsReal* ra2bRoostatsClass3D_3b_LEPT::makeCorrelatedLognormalConstraint(
            const char* NP_name, double NP_val, double NP_err, const char* NP_base_name, bool changeSign ) {
  ...
  void ra2bRoostatsClass3D_3b_LEPT::SetConstants(RooWorkspace pWs, RooStats::ModelConfig pMc){
    //
  ...
  void ra2bRoostatsClass3D_3b_LEPT::SetConstant(const RooArgSet * vars, Bool_t value ){
    //
 ...
 //===============================================================================================================
  ...
  bool ra2bRoostatsClass3D_3b_LEPT::setupShapeSyst( const char* infile,
                                               const char* systname,
                                               int constraintType,
