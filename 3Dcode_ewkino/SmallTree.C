...
//cout << "nentries = " << nentries << endl;
   ...
   //for (Long64_t jentry=0; jentry<50;jentry++) {
      ...
      if(si==1 && !(MT>100&&minDelPhiN>4&&( (nMu==1&&nEl==0) || (nMu==0&&nEl==1) )) ) continue;
      if(si==2 && !(MT<100&&minDelPhiN>4&&( (nMu==1&&nEl==0) || (nMu==0&&nEl==1) )) ) continue;
      if(si==3 && !(minDelPhiN<4&&nMu==0&&nEl==0 ) ) continue;
