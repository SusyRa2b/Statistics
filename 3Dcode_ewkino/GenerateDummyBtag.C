...
void GenerateDummyBtag() {
  ...
  double dummySig[3] = {-0.05,0.02,0.07} ;
  double dummySLSig = 0.01 ;
  double dummySL    = 0.01 ;
  double dummyLdp   = 0.01 ;

  char outfile[10000] ;
  sprintf( outfile, "datfiles/DummyBtagEff-%s-%d-%s-%d-nB%d.dat", aVar1.Data(), nBinsVar1, aVar2.Data(), nBinsVar2, nBinsBjets ) ;
