#ifndef ra2bRoostatsClass5_h
#define ra2bRoostatsClass5_h
...
//
   ...
   class ra2bRoostatsClass5 {

     public :

       ra2bRoostatsClass5( bool ArgUseSigTtwjVar=false, bool ArgUseLdpVars=true, int ArgznnModel=1 ) ;

       virtual ~ra2bRoostatsClass5();
