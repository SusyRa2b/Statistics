...
#include "LikelihoodIntervalPlot.cxx"
  ...
  //=====================================================================================================
   ...
   ra2bRoostatsClass3::ra2bRoostatsClass3( bool ArgUseSigTtwjVar, bool ArgUseLdpVars, int ArgznnModel ) {
...
//  } // generateToyDatasetsFromNVals
  ...
  //==================================================================================================
     ...
     bool ra2bRoostatsClass3::profileSusySig( float& susySigLow, float& susySigHigh, bool makePlot, const char* plotname, double scanMax ) {
...
//    delete workspace ;
 ...
 //    printf("\n\n\n") ;
  ...
  //===================================================================
    ...
    bool ra2bRoostatsClass3::susyScanNoContam( const char* inputScanFile, const char* outputFilebase ) {
 ...
 //---------------------------------
  ...
  //===================================================================
    ...
    bool ra2bRoostatsClass3::susyScanWithContam( const char* inputScanFile, const char* outputFilebase ) {
 ...
 //--------------------------
  ...
  //===================================================================
    ...
    bool ra2bRoostatsClass3::discoveryScanWithContam( const char* inputScanFile ) {
  ...
  //===================================================================
    ...
    bool ra2bRoostatsClass3::fitQualityPlot( bool doNorm, const char* plotname, double hmax ) {
  ...
  //===================================================================
    ...
    double ra2bRoostatsClass3::doToyStudy( int nToys, bool isBgonlyStudy, double data_q ) {
    ...
    // f->Close() ;
       ...
       printf("\n\n\n ra2bRoostatsClass3 :  p-value for data_q = %8.3f is  %d / %d = %8.3f\n\n\n",
