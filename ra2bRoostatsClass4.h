#ifndef ra2bRoostatsClass4_h
#define ra2bRoostatsClass4_h
...
//
   ...
   class ra2bRoostatsClass4 {

     public :

       ra2bRoostatsClass4( bool ArgUseSigTtwjVar=false, bool ArgUseLdpVars=true, int ArgznnModel=1 ) ;

       virtual ~ra2bRoostatsClass4();
