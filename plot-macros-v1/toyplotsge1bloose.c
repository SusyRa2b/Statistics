...
#include "TLegend.h"
   ...
   void toyplotsge1bloose() {
      ...
      TChain toyns("toytt") ;
      toyns.Add("output-files/toy-data-ge1bloose.root") ;
     ...
     //============ fit values
      ...
      TH1F* httwjfit = new TH1F("httwjfit","ttwj",40, 30., 200. ) ;
      TH1F* hqcdfit  = new TH1F("hqcdfit" ,"qcd" ,40, 0., 80. ) ;
      ...
      c1->SaveAs("output-files/toymc-ttwj-sig-fit-ge1bloose.png") ;
      hqcdfit->Draw() ;
      arrow->DrawArrow(fit_tru_qcd, 0.4*(hqcdfit->GetMaximum()), fit_tru_qcd, 0) ;
      c1->SaveAs("output-files/toymc-qcd-sig-fit-ge1bloose.png") ;
      hznnfit->Draw() ;
      arrow->DrawArrow(fit_tru_znn, 0.4*(hznnfit->GetMaximum()), fit_tru_znn, 0) ;
      c1->SaveAs("output-files/toymc-znn-sig-fit-ge1bloose.png") ;


     //============ fit uncertainty

      TH1F* httwjerr = new TH1F("httwjerr","ttwj",40, 5., 35. ) ;
      TH1F* hqcderr  = new TH1F("hqcderr" ,"qcd" ,40, 0., 50. ) ;
      ...
      httwjerr->Draw() ;
      c1->SaveAs("output-files/toymc-ttwj-sig-err-ge1bloose.png") ;
      hqcderr->Draw() ;
      c1->SaveAs("output-files/toymc-qcd-sig-err-ge1bloose.png") ;
      hznnerr->Draw() ;
      c1->SaveAs("output-files/toymc-znn-sig-err-ge1bloose.png") ;
