// @(#)root/roostats:$Id: AsymptoticCalculatorNestedSimPdf.h 46082 2012-09-20 13:55:31Z moneta $
...
#ifndef ROOSTATS_AsymptoticCalculatorNestedSimPdf
#define ROOSTATS_AsymptoticCalculatorNestedSimPdf
...
namespace RooStats {
   ...
   class AsymptoticCalculatorNestedSimPdf : public HypoTestCalculatorGeneric {

   public:
      AsymptoticCalculatorNestedSimPdf(
   ...
   protected:
      ...
      static void factorizePdf(const RooArgSet &observables, RooAbsPdf &pdf, RooArgList &obsTerms, RooArgList &constraints) ;

      static RooAbsPdf * extractNuisancePdf(RooAbsPdf &pdf, const RooArgSet &observables, const char *name);

      static RooAbsPdf * extractNuisancePdf(const RooStats::ModelConfig &model, const char *name);


   protected:
      ClassDef(AsymptoticCalculatorNestedSimPdf,1)
