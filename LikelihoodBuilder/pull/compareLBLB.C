...
TString translate(TString name)
{
  ...
  */
  ...
  //LB->OAK
    ...
    {
      cout << "translation for " << name << " not found!" << endl;
      assert(0);
    }
  return name;
}
...
void printZtoNuNuLBLB(RooWorkspace* ws1, TString name1, RooWorkspace* ws2, TString bin2, TString scale2)
{
  double znn1 = (ws1->function(name1))->getVal();
  double znn2 = (ws2->function(name1))->getVal();
  cout << name1 << " " << znn1-znn2 << " " << percentDifference(znn1,znn2) << endl;
...
void compareFit()
{
	  ...
	  for(int h = 1; h<=4; h++)
	      ...
	      for(int b = 1; b<=3; b++)
		{
		  ...
		  if(name.Contains("eff_sf_") || name.Contains("sf_qcd_") || name.Contains("sf_ttwj_") )
		    {
		      printDiff_RAR_RRV(wsOAK, translate(varName), wsLB, translate(varName));
		    }

		  if(name.Contains("mu_"))
		    {
		      printDiff_RRV_RRV(wsOAK, translate(varName), wsLB, translate(varName));
		    }
  ...
  //Others
  printDiff_RAR_RRV(wsOAK, translate("JES_sf"), wsLB, translate("JES_sf"));
  
  printDiff_RAR_RRV(wsOAK, translate("SFqcd_met2"), wsLB, translate("SFqcd_met2"));
  printDiff_RAR_RRV(wsOAK, translate("SFqcd_met3"), wsLB, translate("SFqcd_met3"));
  printDiff_RAR_RRV(wsOAK, translate("SFqcd_met4"), wsLB, translate("SFqcd_met4"));
  printDiff_RAR_RRV(wsOAK, translate("SFqcd_nb2"), wsLB, translate("SFqcd_nb2"));
  printDiff_RAR_RRV(wsOAK, translate("SFqcd_nb3"), wsLB, translate("SFqcd_nb3"));

  printDiff_RAR_RRV(wsOAK, translate("acc_Zee_M1"), wsLB, translate("acc_Zee_M1"));
  printDiff_RAR_RRV(wsOAK, translate("acc_Zee_M2"), wsLB, translate("acc_Zee_M2"));
  printDiff_RAR_RRV(wsOAK, translate("acc_Zee_M3"), wsLB, translate("acc_Zee_M3"));
  printDiff_RAR_RRV(wsOAK, translate("acc_Zee_M4"), wsLB, translate("acc_Zee_M4"));
  printDiff_RAR_RRV(wsOAK, translate("acc_Zmm_M1"), wsLB, translate("acc_Zmm_M1"));
  printDiff_RAR_RRV(wsOAK, translate("acc_Zmm_M2"), wsLB, translate("acc_Zmm_M2"));
  printDiff_RAR_RRV(wsOAK, translate("acc_Zmm_M3"), wsLB, translate("acc_Zmm_M3"));
  printDiff_RAR_RRV(wsOAK, translate("acc_Zmm_M4"), wsLB, translate("acc_Zmm_M4"));

  printDiff_RAR_RRV(wsOAK, translate("all_gu"), wsLB, translate("all_gu"));
  
  printDiff_RAR_RRV(wsOAK, translate("btageff_sf"), wsLB, translate("btageff_sf"));

  printDiff_RAR_RRV(wsOAK, translate("eff_Zee"), wsLB, translate("eff_Zee"));
  printDiff_RAR_RRV(wsOAK, translate("eff_Zmm"), wsLB, translate("eff_Zmm"));
  
  printDiff_RAR_RRV(wsOAK, translate("knn_1b_M1"), wsLB, translate("knn_1b_M1"));
  printDiff_RAR_RRV(wsOAK, translate("knn_1b_M2"), wsLB, translate("knn_1b_M2"));
  printDiff_RAR_RRV(wsOAK, translate("knn_1b_M3"), wsLB, translate("knn_1b_M3"));
  printDiff_RAR_RRV(wsOAK, translate("knn_1b_M4"), wsLB, translate("knn_1b_M4"));
  printDiff_RAR_RRV(wsOAK, translate("knn_2b"), wsLB, translate("knn_2b"));
  printDiff_RAR_RRV(wsOAK, translate("knn_3b"), wsLB, translate("knn_3b"));

  printDiff_RAR_RRV(wsOAK, translate("pur_Zee"), wsLB, translate("pur_Zee"));
  printDiff_RAR_RRV(wsOAK, translate("pur_Zmm"), wsLB, translate("pur_Zmm"));

  printDiff_RRV_RRV(wsOAK, translate("qcd_0lepLDP_ratio_H1"), wsLB, translate("qcd_0lepLDP_ratio_H1"));
  printDiff_RRV_RRV(wsOAK, translate("qcd_0lepLDP_ratio_H2"), wsLB, translate("qcd_0lepLDP_ratio_H2"));
  printDiff_RRV_RRV(wsOAK, translate("qcd_0lepLDP_ratio_H3"), wsLB, translate("qcd_0lepLDP_ratio_H3"));
  printDiff_RRV_RRV(wsOAK, translate("qcd_0lepLDP_ratio_H4"), wsLB, translate("qcd_0lepLDP_ratio_H4"));

  printDiff_RAR_RRV(wsOAK, translate("rar_vv_sf"), wsLB, translate("rar_vv_sf"));

  printDiff_RAR_RRV(wsOAK, translate("sf_ll"), wsLB, translate("sf_ll"));
  
  printDiff_RAR_RRV(wsOAK, translate("sf_mc"), wsLB, translate("sf_mc"));
  
  printDiff_RAR_RRV(wsOAK, translate("trigeff_M1_H1"), wsLB, translate("trigeff_M1_H1"));
  printDiff_RAR_RRV(wsOAK, translate("trigeff_M1_H2"), wsLB, translate("trigeff_M1_H2"));
  printDiff_RAR_RRV(wsOAK, translate("trigeff_M1_H3"), wsLB, translate("trigeff_M1_H3"));
  printDiff_RAR_RRV(wsOAK, translate("trigeff_M1_H4"), wsLB, translate("trigeff_M1_H4"));
  printDiff_RAR_RRV(wsOAK, translate("trigeff_M2_H1"), wsLB, translate("trigeff_M2_H1"));
  printDiff_RAR_RRV(wsOAK, translate("trigeff_M2_H2"), wsLB, translate("trigeff_M2_H2"));
  printDiff_RAR_RRV(wsOAK, translate("trigeff_M2_H3"), wsLB, translate("trigeff_M2_H3"));
  printDiff_RAR_RRV(wsOAK, translate("trigeff_M2_H4"), wsLB, translate("trigeff_M2_H4"));
  printDiff_RAR_RRV(wsOAK, translate("trigeff_M3_H1"), wsLB, translate("trigeff_M3_H1"));
  printDiff_RAR_RRV(wsOAK, translate("trigeff_M3_H2"), wsLB, translate("trigeff_M3_H2"));
  printDiff_RAR_RRV(wsOAK, translate("trigeff_M3_H3"), wsLB, translate("trigeff_M3_H3"));
  printDiff_RAR_RRV(wsOAK, translate("trigeff_M3_H4"), wsLB, translate("trigeff_M3_H4"));
  //printDiff_RAR_RRV(wsOAK, translate("trigeff_M4_H1"), wsLB, translate("trigeff_M4_H1"));
  printDiff_RAR_RRV(wsOAK, translate("trigeff_M4_H2"), wsLB, translate("trigeff_M4_H2"));
  printDiff_RAR_RRV(wsOAK, translate("trigeff_M4_H3"), wsLB, translate("trigeff_M4_H3"));
  printDiff_RAR_RRV(wsOAK, translate("trigeff_M4_H4"), wsLB, translate("trigeff_M4_H4"));

  printDiff_RAR_RRV(wsOAK, translate("trigeff_sl_M1_H1"), wsLB, translate("trigeff_sl_M1_H1"));
  printDiff_RAR_RRV(wsOAK, translate("trigeff_sl_M1_H2"), wsLB, translate("trigeff_sl_M1_H2"));
  printDiff_RAR_RRV(wsOAK, translate("trigeff_sl_M1_H3"), wsLB, translate("trigeff_sl_M1_H3"));
  printDiff_RAR_RRV(wsOAK, translate("trigeff_sl_M1_H4"), wsLB, translate("trigeff_sl_M1_H4"));
  printDiff_RAR_RRV(wsOAK, translate("trigeff_sl_M2_H1"), wsLB, translate("trigeff_sl_M2_H1"));
  printDiff_RAR_RRV(wsOAK, translate("trigeff_sl_M2_H2"), wsLB, translate("trigeff_sl_M2_H2"));
  printDiff_RAR_RRV(wsOAK, translate("trigeff_sl_M2_H3"), wsLB, translate("trigeff_sl_M2_H3"));
  printDiff_RAR_RRV(wsOAK, translate("trigeff_sl_M2_H4"), wsLB, translate("trigeff_sl_M2_H4"));
  printDiff_RAR_RRV(wsOAK, translate("trigeff_sl_M3_H1"), wsLB, translate("trigeff_sl_M3_H1"));
  printDiff_RAR_RRV(wsOAK, translate("trigeff_sl_M3_H2"), wsLB, translate("trigeff_sl_M3_H2"));
  printDiff_RAR_RRV(wsOAK, translate("trigeff_sl_M3_H3"), wsLB, translate("trigeff_sl_M3_H3"));
  printDiff_RAR_RRV(wsOAK, translate("trigeff_sl_M3_H4"), wsLB, translate("trigeff_sl_M3_H4"));
  //printDiff_RAR_RRV(wsOAK, translate("trigeff_sl_M4_H1"), wsLB, translate("trigeff_sl_M4_H1"));
  printDiff_RAR_RRV(wsOAK, translate("trigeff_sl_M4_H2"), wsLB, translate("trigeff_sl_M4_H2"));
  printDiff_RAR_RRV(wsOAK, translate("trigeff_sl_M4_H3"), wsLB, translate("trigeff_sl_M4_H3"));
  printDiff_RAR_RRV(wsOAK, translate("trigeff_sl_M4_H4"), wsLB, translate("trigeff_sl_M4_H4"));
  
  
  printZtoNuNuLBLB(wsOAK, "ZtoNuNu_VeryLooseBtagYield_M1_H1", wsLB, "M1_H1", "M1");
  printZtoNuNuLBLB(wsOAK, "ZtoNuNu_VeryLooseBtagYield_M1_H2", wsLB, "M1_H2", "M1");
  printZtoNuNuLBLB(wsOAK, "ZtoNuNu_VeryLooseBtagYield_M1_H3", wsLB, "M1_H3", "M1");
  printZtoNuNuLBLB(wsOAK, "ZtoNuNu_VeryLooseBtagYield_M1_H4", wsLB, "M1_H4", "M1");
  printZtoNuNuLBLB(wsOAK, "ZtoNuNu_VeryLooseBtagYield_M2_H1", wsLB, "M2_H1", "M2");
  printZtoNuNuLBLB(wsOAK, "ZtoNuNu_VeryLooseBtagYield_M2_H2", wsLB, "M2_H2", "M2");
  printZtoNuNuLBLB(wsOAK, "ZtoNuNu_VeryLooseBtagYield_M2_H3", wsLB, "M2_H3", "M2");
  printZtoNuNuLBLB(wsOAK, "ZtoNuNu_VeryLooseBtagYield_M2_H4", wsLB, "M2_H4", "M2");
  printZtoNuNuLBLB(wsOAK, "ZtoNuNu_VeryLooseBtagYield_M3_H1", wsLB, "M3_H1", "M3");
  printZtoNuNuLBLB(wsOAK, "ZtoNuNu_VeryLooseBtagYield_M3_H2", wsLB, "M3_H2", "M3");
  printZtoNuNuLBLB(wsOAK, "ZtoNuNu_VeryLooseBtagYield_M3_H3", wsLB, "M3_H3", "M3");
  printZtoNuNuLBLB(wsOAK, "ZtoNuNu_VeryLooseBtagYield_M3_H4", wsLB, "M3_H4", "M3");
  printZtoNuNuLBLB(wsOAK, "ZtoNuNu_VeryLooseBtagYield_M4_H2", wsLB, "M4_H2", "M4");
  printZtoNuNuLBLB(wsOAK, "ZtoNuNu_VeryLooseBtagYield_M4_H3", wsLB, "M4_H3", "M4");
  printZtoNuNuLBLB(wsOAK, "ZtoNuNu_VeryLooseBtagYield_M4_H4", wsLB, "M4_H4", "M4");

  printDiff_RRV_RRV(wsOAK, translate("ttwj_0lep1lep_ratio"), wsLB, translate("ttwj_0lep1lep_ratio"));

  double susyOAK = (wsOAK->var("signalCrossSection"))->getVal();
  double susyLB =  (wsLB->var("signalCrossSection"))->getVal();
...
void comparePDFs(RooWorkspace* wsLB, RooWorkspace* wsOAK, bool ABCD)
{
  ...
  */
      ...
      for(int m = 1; m<=4; m++)
	{
	  for(int h = 1; h<=4; h++)
	      ...
	      for(int b = 1; b<=3; b++)
		{
		  ...
		  printDiff_PDF_PDF(wsOAK, translatePDF(varName), wsLB, translatePDF(varName));
  ...
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_acc_Zee_M3"), wsLB, translatePDF("pdf_acc_Zee_M3"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_acc_Zee_M4"), wsLB, translatePDF("pdf_acc_Zee_M4"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_acc_Zmm_M1"), wsLB, translatePDF("pdf_acc_Zmm_M1"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_acc_Zmm_M2"), wsLB, translatePDF("pdf_acc_Zmm_M2"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_acc_Zmm_M3"), wsLB, translatePDF("pdf_acc_Zmm_M3"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_acc_Zmm_M4"), wsLB, translatePDF("pdf_acc_Zmm_M4"));

  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_all_gu"), wsLB, translatePDF("pdf_all_gu"));
  
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_btageff_sf"), wsLB, translatePDF("pdf_btageff_sf"));

  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_eff_Zee"), wsLB, translatePDF("pdf_eff_Zee"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_eff_Zmm"), wsLB, translatePDF("pdf_eff_Zmm"));
  
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_knn_1b_M1"), wsLB, translatePDF("pdf_knn_1b_M1"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_knn_1b_M2"), wsLB, translatePDF("pdf_knn_1b_M2"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_knn_1b_M3"), wsLB, translatePDF("pdf_knn_1b_M3"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_knn_1b_M4"), wsLB, translatePDF("pdf_knn_1b_M4"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_knn_2b"), wsLB, translatePDF("pdf_knn_2b"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_knn_3b"), wsLB, translatePDF("pdf_knn_3b"));

  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_pur_Zee"), wsLB, translatePDF("pdf_pur_Zee"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_pur_Zmm"), wsLB, translatePDF("pdf_pur_Zmm"));

  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_rar_vv_sf"), wsLB, translatePDF("pdf_rar_vv_sf"));

  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_sf_ll"), wsLB, translatePDF("pdf_sf_ll"));
  
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_sf_mc"), wsLB, translatePDF("pdf_sf_mc"));
  
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_trigeff_M1_H1"), wsLB, translatePDF("pdf_trigeff_M1_H1"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_trigeff_M1_H2"), wsLB, translatePDF("pdf_trigeff_M1_H2"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_trigeff_M1_H3"), wsLB, translatePDF("pdf_trigeff_M1_H3"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_trigeff_M1_H4"), wsLB, translatePDF("pdf_trigeff_M1_H4"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_trigeff_M2_H1"), wsLB, translatePDF("pdf_trigeff_M2_H1"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_trigeff_M2_H2"), wsLB, translatePDF("pdf_trigeff_M2_H2"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_trigeff_M2_H3"), wsLB, translatePDF("pdf_trigeff_M2_H3"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_trigeff_M2_H4"), wsLB, translatePDF("pdf_trigeff_M2_H4"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_trigeff_M3_H1"), wsLB, translatePDF("pdf_trigeff_M3_H1"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_trigeff_M3_H2"), wsLB, translatePDF("pdf_trigeff_M3_H2"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_trigeff_M3_H3"), wsLB, translatePDF("pdf_trigeff_M3_H3"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_trigeff_M3_H4"), wsLB, translatePDF("pdf_trigeff_M3_H4"));
  //printDiff_PDF_PDF(wsOAK, translatePDF("pdf_trigeff_M4_H1"), wsLB, translatePDF("pdf_trigeff_M4_H1"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_trigeff_M4_H2"), wsLB, translatePDF("pdf_trigeff_M4_H2"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_trigeff_M4_H3"), wsLB, translatePDF("pdf_trigeff_M4_H3"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_trigeff_M4_H4"), wsLB, translatePDF("pdf_trigeff_M4_H4"));

  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_trigeff_sl_M1_H1"), wsLB, translatePDF("pdf_trigeff_sl_M1_H1"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_trigeff_sl_M1_H2"), wsLB, translatePDF("pdf_trigeff_sl_M1_H2"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_trigeff_sl_M1_H3"), wsLB, translatePDF("pdf_trigeff_sl_M1_H3"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_trigeff_sl_M1_H4"), wsLB, translatePDF("pdf_trigeff_sl_M1_H4"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_trigeff_sl_M2_H1"), wsLB, translatePDF("pdf_trigeff_sl_M2_H1"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_trigeff_sl_M2_H2"), wsLB, translatePDF("pdf_trigeff_sl_M2_H2"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_trigeff_sl_M2_H3"), wsLB, translatePDF("pdf_trigeff_sl_M2_H3"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_trigeff_sl_M2_H4"), wsLB, translatePDF("pdf_trigeff_sl_M2_H4"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_trigeff_sl_M3_H1"), wsLB, translatePDF("pdf_trigeff_sl_M3_H1"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_trigeff_sl_M3_H2"), wsLB, translatePDF("pdf_trigeff_sl_M3_H2"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_trigeff_sl_M3_H3"), wsLB, translatePDF("pdf_trigeff_sl_M3_H3"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_trigeff_sl_M3_H4"), wsLB, translatePDF("pdf_trigeff_sl_M3_H4"));
  //printDiff_PDF_PDF(wsOAK, translatePDF("pdf_trigeff_sl_M4_H1"), wsLB, translatePDF("pdf_trigeff_sl_M4_H1"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_trigeff_sl_M4_H2"), wsLB, translatePDF("pdf_trigeff_sl_M4_H2"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_trigeff_sl_M4_H3"), wsLB, translatePDF("pdf_trigeff_sl_M4_H3"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_trigeff_sl_M4_H4"), wsLB, translatePDF("pdf_trigeff_sl_M4_H4"));
  


  //for anders
  //cout << "anders" << endl;
  //printDiff_RRV_RRV(wsOAK, translatePDF("mean_trigeff_sl_M2_H3"), wsLB, "mean_oneLeptonTriggerEfficiency_M2_H3");
  //printDiff_RRV_RRV(wsOAK, translatePDF("sigma_trigeff_sl_M2_H3"), wsLB, "sigma_oneLeptonTriggerEfficiency_M2_H3");

  
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_N_Zee_M1_H1"), wsLB, translatePDF("pdf_N_Zee_M1_H1"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_N_Zee_M1_H2"), wsLB, translatePDF("pdf_N_Zee_M1_H2"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_N_Zee_M1_H3"), wsLB, translatePDF("pdf_N_Zee_M1_H3"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_N_Zee_M1_H4"), wsLB, translatePDF("pdf_N_Zee_M1_H4"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_N_Zee_M2_H1"), wsLB, translatePDF("pdf_N_Zee_M2_H1"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_N_Zee_M2_H2"), wsLB, translatePDF("pdf_N_Zee_M2_H2"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_N_Zee_M2_H3"), wsLB, translatePDF("pdf_N_Zee_M2_H3"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_N_Zee_M2_H4"), wsLB, translatePDF("pdf_N_Zee_M2_H4"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_N_Zee_M3_H1"), wsLB, translatePDF("pdf_N_Zee_M3_H1"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_N_Zee_M3_H2"), wsLB, translatePDF("pdf_N_Zee_M3_H2"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_N_Zee_M3_H3"), wsLB, translatePDF("pdf_N_Zee_M3_H3"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_N_Zee_M3_H4"), wsLB, translatePDF("pdf_N_Zee_M3_H4"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_N_Zee_M4_H2"), wsLB, translatePDF("pdf_N_Zee_M4_H2"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_N_Zee_M4_H3"), wsLB, translatePDF("pdf_N_Zee_M4_H3"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_N_Zee_M4_H4"), wsLB, translatePDF("pdf_N_Zee_M4_H4"));

  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_N_Zmm_M1_H1"), wsLB, translatePDF("pdf_N_Zmm_M1_H1"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_N_Zmm_M1_H2"), wsLB, translatePDF("pdf_N_Zmm_M1_H2"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_N_Zmm_M1_H3"), wsLB, translatePDF("pdf_N_Zmm_M1_H3"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_N_Zmm_M1_H4"), wsLB, translatePDF("pdf_N_Zmm_M1_H4"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_N_Zmm_M2_H1"), wsLB, translatePDF("pdf_N_Zmm_M2_H1"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_N_Zmm_M2_H2"), wsLB, translatePDF("pdf_N_Zmm_M2_H2"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_N_Zmm_M2_H3"), wsLB, translatePDF("pdf_N_Zmm_M2_H3"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_N_Zmm_M2_H4"), wsLB, translatePDF("pdf_N_Zmm_M2_H4"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_N_Zmm_M3_H1"), wsLB, translatePDF("pdf_N_Zmm_M3_H1"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_N_Zmm_M3_H2"), wsLB, translatePDF("pdf_N_Zmm_M3_H2"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_N_Zmm_M3_H3"), wsLB, translatePDF("pdf_N_Zmm_M3_H3"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_N_Zmm_M3_H4"), wsLB, translatePDF("pdf_N_Zmm_M3_H4"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_N_Zmm_M4_H2"), wsLB, translatePDF("pdf_N_Zmm_M4_H2"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_N_Zmm_M4_H3"), wsLB, translatePDF("pdf_N_Zmm_M4_H3"));
  printDiff_PDF_PDF(wsOAK, translatePDF("pdf_N_Zmm_M4_H4"), wsLB, translatePDF("pdf_N_Zmm_M4_H4"));
...
void setSame()
{
  ...
  for(vector<TString>::iterator it = names.begin(); it != names.end(); ++it)
      ...
      for(int m = 1; m<=4; m++)
	{
	  for(int h = 1; h<=4; h++)
	      ...
	      for(int b = 1; b<=3; b++)
		{
		  ...
		  if(name.Contains("eff_sf_") || name.Contains("sf_qcd_") || name.Contains("sf_ttwj_") )
		    {
		      setVal_RAR_RRV(0.9, wsOAK, translate(varName), wsLB, translate(varName));
		    }
      ...
      setVal_RRV_RRV(15064, wsOAK, translate("mu_qcd_ldp_M1_H1_1b"), wsLB, translate("mu_qcd_ldp_M1_H1_1b"));
      setVal_RRV_RRV(4643, wsOAK, translate("mu_qcd_ldp_M1_H1_2b"), wsLB, translate("mu_qcd_ldp_M1_H1_2b"));
      setVal_RRV_RRV(18, wsOAK, translate("mu_qcd_ldp_M1_H1_3b"), wsLB, translate("mu_qcd_ldp_M1_H1_3b"));
      setVal_RRV_RRV(23386, wsOAK, translate("mu_qcd_ldp_M1_H2_1b"), wsLB, translate("mu_qcd_ldp_M1_H2_1b"));
      setVal_RRV_RRV(5495, wsOAK, translate("mu_qcd_ldp_M1_H2_2b"), wsLB, translate("mu_qcd_ldp_M1_H2_2b"));
      setVal_RRV_RRV(72, wsOAK, translate("mu_qcd_ldp_M1_H2_3b"), wsLB, translate("mu_qcd_ldp_M1_H2_3b"));
      setVal_RRV_RRV(4847, wsOAK, translate("mu_qcd_ldp_M1_H3_1b"), wsLB, translate("mu_qcd_ldp_M1_H3_1b"));
      setVal_RRV_RRV(1174, wsOAK, translate("mu_qcd_ldp_M1_H3_2b"), wsLB, translate("mu_qcd_ldp_M1_H3_2b"));
      setVal_RRV_RRV(47, wsOAK, translate("mu_qcd_ldp_M1_H3_3b"), wsLB, translate("mu_qcd_ldp_M1_H3_3b"));
      setVal_RRV_RRV(4366, wsOAK, translate("mu_qcd_ldp_M1_H4_1b"), wsLB, translate("mu_qcd_ldp_M1_H4_1b"));
      setVal_RRV_RRV(629, wsOAK, translate("mu_qcd_ldp_M1_H4_2b"), wsLB, translate("mu_qcd_ldp_M1_H4_2b"));
      setVal_RRV_RRV(64, wsOAK, translate("mu_qcd_ldp_M1_H4_3b"), wsLB, translate("mu_qcd_ldp_M1_H4_3b"));
      setVal_RRV_RRV(5974, wsOAK, translate("mu_qcd_ldp_M2_H1_1b"), wsLB, translate("mu_qcd_ldp_M2_H1_1b"));
      setVal_RRV_RRV(1640, wsOAK, translate("mu_qcd_ldp_M2_H1_2b"), wsLB, translate("mu_qcd_ldp_M2_H1_2b"));
      setVal_RRV_RRV(164, wsOAK, translate("mu_qcd_ldp_M2_H1_3b"), wsLB, translate("mu_qcd_ldp_M2_H1_3b"));
      setVal_RRV_RRV(15187, wsOAK, translate("mu_qcd_ldp_M2_H2_1b"), wsLB, translate("mu_qcd_ldp_M2_H2_1b"));
      setVal_RRV_RRV(4385, wsOAK, translate("mu_qcd_ldp_M2_H2_2b"), wsLB, translate("mu_qcd_ldp_M2_H2_2b"));
      setVal_RRV_RRV(247, wsOAK, translate("mu_qcd_ldp_M2_H2_3b"), wsLB, translate("mu_qcd_ldp_M2_H2_3b"));
      setVal_RRV_RRV(4135, wsOAK, translate("mu_qcd_ldp_M2_H3_1b"), wsLB, translate("mu_qcd_ldp_M2_H3_1b"));
      setVal_RRV_RRV(1014, wsOAK, translate("mu_qcd_ldp_M2_H3_2b"), wsLB, translate("mu_qcd_ldp_M2_H3_2b"));
      setVal_RRV_RRV(56, wsOAK, translate("mu_qcd_ldp_M2_H3_3b"), wsLB, translate("mu_qcd_ldp_M2_H3_3b"));
      setVal_RRV_RRV(3726, wsOAK, translate("mu_qcd_ldp_M2_H4_1b"), wsLB, translate("mu_qcd_ldp_M2_H4_1b"));
      setVal_RRV_RRV(670, wsOAK, translate("mu_qcd_ldp_M2_H4_2b"), wsLB, translate("mu_qcd_ldp_M2_H4_2b"));
      setVal_RRV_RRV(47, wsOAK, translate("mu_qcd_ldp_M2_H4_3b"), wsLB, translate("mu_qcd_ldp_M2_H4_3b"));
      setVal_RRV_RRV(149, wsOAK, translate("mu_qcd_ldp_M3_H1_1b"), wsLB, translate("mu_qcd_ldp_M3_H1_1b"));
      setVal_RRV_RRV(0.6, wsOAK, translate("mu_qcd_ldp_M3_H1_2b"), wsLB, translate("mu_qcd_ldp_M3_H1_2b"));
      setVal_RRV_RRV(0.3, wsOAK, translate("mu_qcd_ldp_M3_H1_3b"), wsLB, translate("mu_qcd_ldp_M3_H1_3b"));
      setVal_RRV_RRV(457, wsOAK, translate("mu_qcd_ldp_M3_H2_1b"), wsLB, translate("mu_qcd_ldp_M3_H2_1b"));
      setVal_RRV_RRV(124, wsOAK, translate("mu_qcd_ldp_M3_H2_2b"), wsLB, translate("mu_qcd_ldp_M3_H2_2b"));
      setVal_RRV_RRV(0.5, wsOAK, translate("mu_qcd_ldp_M3_H2_3b"), wsLB, translate("mu_qcd_ldp_M3_H2_3b"));
      setVal_RRV_RRV(347, wsOAK, translate("mu_qcd_ldp_M3_H3_1b"), wsLB, translate("mu_qcd_ldp_M3_H3_1b"));
      setVal_RRV_RRV(54, wsOAK, translate("mu_qcd_ldp_M3_H3_2b"), wsLB, translate("mu_qcd_ldp_M3_H3_2b"));
      setVal_RRV_RRV(18, wsOAK, translate("mu_qcd_ldp_M3_H3_3b"), wsLB, translate("mu_qcd_ldp_M3_H3_3b"));
      setVal_RRV_RRV(527, wsOAK, translate("mu_qcd_ldp_M3_H4_1b"), wsLB, translate("mu_qcd_ldp_M3_H4_1b"));
      setVal_RRV_RRV(102, wsOAK, translate("mu_qcd_ldp_M3_H4_2b"), wsLB, translate("mu_qcd_ldp_M3_H4_2b"));
      setVal_RRV_RRV(12, wsOAK, translate("mu_qcd_ldp_M3_H4_3b"), wsLB, translate("mu_qcd_ldp_M3_H4_3b"));
      setVal_RRV_RRV(17, wsOAK, translate("mu_qcd_ldp_M4_H2_1b"), wsLB, translate("mu_qcd_ldp_M4_H2_1b"));
      setVal_RRV_RRV(7, wsOAK, translate("mu_qcd_ldp_M4_H2_2b"), wsLB, translate("mu_qcd_ldp_M4_H2_2b"));
      setVal_RRV_RRV(2, wsOAK, translate("mu_qcd_ldp_M4_H2_3b"), wsLB, translate("mu_qcd_ldp_M4_H2_3b"));
      setVal_RRV_RRV(37, wsOAK, translate("mu_qcd_ldp_M4_H3_1b"), wsLB, translate("mu_qcd_ldp_M4_H3_1b"));
      setVal_RRV_RRV(4, wsOAK, translate("mu_qcd_ldp_M4_H3_2b"), wsLB, translate("mu_qcd_ldp_M4_H3_2b"));
      setVal_RRV_RRV(0.00002, wsOAK, translate("mu_qcd_ldp_M4_H3_3b"), wsLB, translate("mu_qcd_ldp_M4_H3_3b"));
      setVal_RRV_RRV(103, wsOAK, translate("mu_qcd_ldp_M4_H4_1b"), wsLB, translate("mu_qcd_ldp_M4_H4_1b"));
      ...
      if(ABCD) 
	{
      ...
      setVal_RAR_RRV(1.38, wsOAK, translate("SFqcd_met3"), wsLB, translate("SFqcd_met3"));
      setVal_RAR_RRV(1.89, wsOAK, translate("SFqcd_met4"), wsLB, translate("SFqcd_met4"));
      setVal_RAR_RRV(0.7, wsOAK, translate("SFqcd_nb2"), wsLB, translate("SFqcd_nb2"));
      setVal_RAR_RRV(0.7, wsOAK, translate("SFqcd_nb3"), wsLB, translate("SFqcd_nb3"));
      
      setVal_RAR_RRV(0.67, wsOAK, translate("acc_Zee_M1"), wsLB, translate("acc_Zee_M1"));
      setVal_RAR_RRV(0.69, wsOAK, translate("acc_Zee_M2"), wsLB, translate("acc_Zee_M2"));
      setVal_RAR_RRV(0.74, wsOAK, translate("acc_Zee_M3"), wsLB, translate("acc_Zee_M3"));
      setVal_RAR_RRV(0.79, wsOAK, translate("acc_Zee_M4"), wsLB, translate("acc_Zee_M4"));
      setVal_RAR_RRV(0.67, wsOAK, translate("acc_Zmm_M1"), wsLB, translate("acc_Zmm_M1"));
      setVal_RAR_RRV(0.73, wsOAK, translate("acc_Zmm_M2"), wsLB, translate("acc_Zmm_M2"));
      setVal_RAR_RRV(0.80, wsOAK, translate("acc_Zmm_M3"), wsLB, translate("acc_Zmm_M3"));
      setVal_RAR_RRV(0.85, wsOAK, translate("acc_Zmm_M4"), wsLB, translate("acc_Zmm_M4"));
      
      setVal_RAR_RRV(0.9, wsOAK, translate("all_gu"), wsLB, translate("all_gu"));
      
      setVal_RAR_RRV(-0.09, wsOAK, translate("btageff_sf"), wsLB, translate("btageff_sf"));
      
      setVal_RAR_RRV(0.85, wsOAK, translate("eff_Zee"), wsLB, translate("eff_Zee"));
      setVal_RAR_RRV(0.88, wsOAK, translate("eff_Zmm"), wsLB, translate("eff_Zmm"));
      
      
      
      setVal_RAR_RRV(0.9, wsOAK, translate("pur_Zee"), wsLB, translate("pur_Zee"));
      setVal_RAR_RRV(0.77, wsOAK, translate("pur_Zmm"), wsLB, translate("pur_Zmm"));
      
      setVal_RRV_RRV(0.27, wsOAK, translate("qcd_0lepLDP_ratio_H1"), wsLB, translate("qcd_0lepLDP_ratio_H1"));
      setVal_RRV_RRV(0.17, wsOAK, translate("qcd_0lepLDP_ratio_H2"), wsLB, translate("qcd_0lepLDP_ratio_H2"));
      setVal_RRV_RRV(0.11, wsOAK, translate("qcd_0lepLDP_ratio_H3"), wsLB, translate("qcd_0lepLDP_ratio_H3"));
      setVal_RRV_RRV(0.05, wsOAK, translate("qcd_0lepLDP_ratio_H4"), wsLB, translate("qcd_0lepLDP_ratio_H4"));
      
      setVal_RAR_RRV(0.9, wsOAK, translate("rar_vv_sf"), wsLB, translate("rar_vv_sf"));
      
      setVal_RAR_RRV(-0.23, wsOAK, translate("sf_ll"), wsLB, translate("sf_ll"));
      
      setVal_RAR_RRV(0.98, wsOAK, translate("sf_mc"), wsLB, translate("sf_mc"));
      
      setVal_RAR_RRV(0.61, wsOAK, translate("trigeff_M1_H1"), wsLB, translate("trigeff_M1_H1"));
      setVal_RAR_RRV(0.72, wsOAK, translate("trigeff_M1_H2"), wsLB, translate("trigeff_M1_H2"));
      setVal_RAR_RRV(0.99, wsOAK, translate("trigeff_M1_H3"), wsLB, translate("trigeff_M1_H3"));
      setVal_RAR_RRV(0.99, wsOAK, translate("trigeff_M1_H4"), wsLB, translate("trigeff_M1_H4"));
      setVal_RAR_RRV(0.76, wsOAK, translate("trigeff_M2_H1"), wsLB, translate("trigeff_M2_H1"));
      setVal_RAR_RRV(0.83, wsOAK, translate("trigeff_M2_H2"), wsLB, translate("trigeff_M2_H2"));
      setVal_RAR_RRV(0.99, wsOAK, translate("trigeff_M2_H3"), wsLB, translate("trigeff_M2_H3"));
      setVal_RAR_RRV(0.99, wsOAK, translate("trigeff_M2_H4"), wsLB, translate("trigeff_M2_H4"));
      setVal_RAR_RRV(0.99, wsOAK, translate("trigeff_M3_H1"), wsLB, translate("trigeff_M3_H1"));
      setVal_RAR_RRV(0.99, wsOAK, translate("trigeff_M3_H2"), wsLB, translate("trigeff_M3_H2"));
      setVal_RAR_RRV(0.99, wsOAK, translate("trigeff_M3_H3"), wsLB, translate("trigeff_M3_H3"));
      setVal_RAR_RRV(0.99, wsOAK, translate("trigeff_M3_H4"), wsLB, translate("trigeff_M3_H4"));
      //setVal_RAR_RRV(1, wsOAK, translate("trigeff_M4_H1"), wsLB, translate("trigeff_M4_H1"));
      setVal_RAR_RRV(0.99, wsOAK, translate("trigeff_M4_H2"), wsLB, translate("trigeff_M4_H2"));
      setVal_RAR_RRV(0.99, wsOAK, translate("trigeff_M4_H3"), wsLB, translate("trigeff_M4_H3"));
      setVal_RAR_RRV(0.99, wsOAK, translate("trigeff_M4_H4"), wsLB, translate("trigeff_M4_H4"));
      
      setVal_RAR_RRV(0.9, wsOAK, translate("trigeff_sl_M1_H1"), wsLB, translate("trigeff_sl_M1_H1"));
      setVal_RAR_RRV(0.987, wsOAK, translate("trigeff_sl_M1_H2"), wsLB, translate("trigeff_sl_M1_H2"));
      setVal_RAR_RRV(0.99, wsOAK, translate("trigeff_sl_M1_H3"), wsLB, translate("trigeff_sl_M1_H3"));
      setVal_RAR_RRV(0.99, wsOAK, translate("trigeff_sl_M1_H4"), wsLB, translate("trigeff_sl_M1_H4"));
      setVal_RAR_RRV(0.95, wsOAK, translate("trigeff_sl_M2_H1"), wsLB, translate("trigeff_sl_M2_H1"));
      setVal_RAR_RRV(0.99, wsOAK, translate("trigeff_sl_M2_H2"), wsLB, translate("trigeff_sl_M2_H2"));
      setVal_RAR_RRV(0.99, wsOAK, translate("trigeff_sl_M2_H3"), wsLB, translate("trigeff_sl_M2_H3"));
      setVal_RAR_RRV(0.99, wsOAK, translate("trigeff_sl_M2_H4"), wsLB, translate("trigeff_sl_M2_H4"));
      setVal_RAR_RRV(0.99, wsOAK, translate("trigeff_sl_M3_H1"), wsLB, translate("trigeff_sl_M3_H1"));
      setVal_RAR_RRV(0.99, wsOAK, translate("trigeff_sl_M3_H2"), wsLB, translate("trigeff_sl_M3_H2"));
      setVal_RAR_RRV(0.99, wsOAK, translate("trigeff_sl_M3_H3"), wsLB, translate("trigeff_sl_M3_H3"));
      setVal_RAR_RRV(0.99, wsOAK, translate("trigeff_sl_M3_H4"), wsLB, translate("trigeff_sl_M3_H4"));
      //setVal_RAR_RRV(1, wsOAK, translate("trigeff_sl_M4_H1"), wsLB, translate("trigeff_sl_M4_H1"));
      setVal_RAR_RRV(0.99, wsOAK, translate("trigeff_sl_M4_H2"), wsLB, translate("trigeff_sl_M4_H2"));
      setVal_RAR_RRV(0.99, wsOAK, translate("trigeff_sl_M4_H3"), wsLB, translate("trigeff_sl_M4_H3"));
      setVal_RAR_RRV(0.99, wsOAK, translate("trigeff_sl_M4_H4"), wsLB, translate("trigeff_sl_M4_H4"));
      
      setVal_RAR_RRV(0.4, wsOAK, translate("knn_1b_M1"), wsLB, translate("knn_1b_M1"));
      setVal_RAR_RRV(0.4, wsOAK, translate("knn_1b_M2"), wsLB, translate("knn_1b_M2"));
      setVal_RAR_RRV(0.4, wsOAK, translate("knn_1b_M3"), wsLB, translate("knn_1b_M3"));
      setVal_RAR_RRV(0.4, wsOAK, translate("knn_1b_M4"), wsLB, translate("knn_1b_M4"));
      setVal_RAR_RRV(0.1, wsOAK, translate("knn_2b"), wsLB, translate("knn_2b"));
      setVal_RAR_RRV(0.01, wsOAK, translate("knn_3b"), wsLB, translate("knn_3b"));
      //NOTE -- LB Knn will be reset by setZtoNuNu function
      
      bool skipSetting = true;
      if(!skipSetting)
	{ 
      
      setZtoNuNu(wsOAK, translate("mu_znn_M1_H1_1b"), 128, wsLB, "M1_H1", 128/0.4, "M1_1b", 0.4);
      setZtoNuNu(wsOAK, translate("mu_znn_M1_H2_1b"), 89, wsLB, "M1_H2", 89/0.4, "M1_1b", 0.4);
      setZtoNuNu(wsOAK, translate("mu_znn_M1_H3_1b"), 7, wsLB, "M1_H3", 7/0.4, "M1_1b", 0.4);
      setZtoNuNu(wsOAK, translate("mu_znn_M1_H4_1b"), 4, wsLB, "M1_H4", 4/0.4, "M1_1b", 0.4);
      setZtoNuNu(wsOAK, translate("mu_znn_M2_H1_1b"), 268, wsLB, "M2_H1", 268/0.4, "M2_1b", 0.4);
      setZtoNuNu(wsOAK, translate("mu_znn_M2_H2_1b"), 287, wsLB, "M2_H2", 287/0.4, "M2_1b", 0.4);
      setZtoNuNu(wsOAK, translate("mu_znn_M2_H3_1b"), 36, wsLB, "M2_H3", 36/0.4, "M2_1b", 0.4);
      setZtoNuNu(wsOAK, translate("mu_znn_M2_H4_1b"), 15, wsLB, "M2_H4", 15/0.4, "M2_1b", 0.4);
      setZtoNuNu(wsOAK, translate("mu_znn_M3_H1_1b"), 121, wsLB, "M3_H1", 121/0.4, "M3_1b", 0.4);
      setZtoNuNu(wsOAK, translate("mu_znn_M3_H2_1b"), 105, wsLB, "M3_H2", 105/0.4, "M3_1b", 0.4);
      setZtoNuNu(wsOAK, translate("mu_znn_M3_H3_1b"), 11, wsLB, "M3_H3", 11/0.4, "M3_1b", 0.4);
      setZtoNuNu(wsOAK, translate("mu_znn_M3_H4_1b"), 9, wsLB, "M3_H4", 9/0.4, "M3_1b", 0.4);
      setZtoNuNu(wsOAK, translate("mu_znn_M4_H2_1b"), 49, wsLB, "M4_H2", 49/0.4, "M4_1b", 0.4);
      setZtoNuNu(wsOAK, translate("mu_znn_M4_H3_1b"), 8, wsLB, "M4_H3", 8/0.4, "M4_1b", 0.4);
      setZtoNuNu(wsOAK, translate("mu_znn_M4_H4_1b"), 9, wsLB, "M4_H4", 9/0.4, "M4_1b", 0.4);
      ...
      setVal_RRV_RRV(1.21, wsOAK, translate("ttwj_0lep1lep_ratio"), wsLB, translate("ttwj_0lep1lep_ratio"));
