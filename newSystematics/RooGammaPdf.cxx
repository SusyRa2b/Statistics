...
RooGammaPdf::RooGammaPdf(const char *name, const char *title,
  ...
  gamma("gamma","Shape",this,_gamma),
  beta("beta","Scale",this,_beta),
  mu("mu","Para",this,_mu)
{
}
...
Double_t RooGammaPdf::analyticalIntegral(Int_t code, const char* rangeName) const 
{
 ...
 //integral of the GammPdf distribution via ROOT::Math
...
//_____________________________________________________________________________
Int_t RooGammaPdf::getGenerator(const RooArgSet& directVars, RooArgSet &generateVars, Bool_t /*staticInitOK*/) const
{
...
//_____________________________________________________________________________
void RooGammaPdf::generateEvent(Int_t code)
{
  assert(code==1) ;
