...
void runLimit_withPlots(char* cut , char* model , int m0, int m12, bool isMeasured)
{
  ...
  gSystem->CompileMacro("ra2bRoostatsClass7_noNSig.c","kO") ;
  ...
  if(isMeasured) profileLikelihoodLimit(outputfile.Data(),"ws","SbModel", "BModel","ra2b_observed_rds",name.Data(),true,
					m0,m12,500,10000,10,true,true,true);
