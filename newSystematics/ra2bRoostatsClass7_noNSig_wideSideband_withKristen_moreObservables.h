#ifndef ra2bRoostatsClass7_noNSig_h
#define ra2bRoostatsClass7_noNSig_h
...
//
   ...
   class ra2bRoostatsClass7 {

     public :

       ra2bRoostatsClass7( bool ArgUseSigTtwjVar=true, bool ArgUseLdpVars=true ) ;

       virtual ~ra2bRoostatsClass7();

       bool initialize( const char* infile = "an-11-257-v2-files/input-files/byhand-data-ge2b-loose.txt",
                        const char* inputScanFile = "an-11-257-v3-files/input-files/signalSyst.T1bbbb.ge1bTight.dat", double m0 = 875., double m12 = 525., bool isT1bbbb = false, double t1bbbbXsec=0. , const char* outfile = "ws.root" , bool effInitFixed = true, bool constantNonPoisson = false, bool constantSigEff = false) ;
     ...
     private :
      ...
      //======= Observables ==============================================================
       ...
       RooRealVar* rv_Nsb_sl_e      ;
       RooRealVar* rv_Nsb_sl_mu      ;
      ...
      //-- ttwj
       ...
       RooRealVar*    rv_mu_ttwj_sb_sl_e  ;
       RooRealVar*    rv_mu_ttwj_sb_sl_mu  ;
      ...
      //-- susy
       ...
       RooFormulaVar* rv_mu_susy_sig_sl_e  ;
       RooFormulaVar* rv_mu_susy_sig_sl_mu  ;
       RooFormulaVar* rv_mu_susy_sb_sl_e   ;
       RooFormulaVar* rv_mu_susy_sb_sl_mu   ;
   ...
   //  RooRealVar*    rv_mu_qcd_lsb_0b_ldp ;
      ...
      //-- Gaussian constraints and constants.
       ...
       RooFormulaVar* rv_eff_sf_sig_sl_e ;
       RooFormulaVar* rv_eff_sf_sig_sl_mu ;
       RooFormulaVar* rv_eff_sf_sb_sl_e ;
       RooFormulaVar* rv_eff_sf_sb_sl_mu ;
       RooFormulaVar* rv_eff_sf_sig_ldp ;
       RooFormulaVar* rv_eff_sf_sb_ldp ;

       RooRealVar* rv_width_eff_sf_sig ;
       RooRealVar* rv_width_eff_sf_sb ;
       RooRealVar* rv_width_eff_sf_sig_sl_e ;
       RooRealVar* rv_width_eff_sf_sig_sl_mu ;
       RooRealVar* rv_width_eff_sf_sb_sl_e ;
       RooRealVar* rv_width_eff_sf_sb_sl_mu ;
       ...
       RooRealVar* rv_mean_eff_sf_sig_sl_e ;
       RooRealVar* rv_mean_eff_sf_sig_sl_mu ;
       RooRealVar* rv_mean_eff_sf_sb_sl_e ;
       RooRealVar* rv_mean_eff_sf_sb_sl_mu ;
    ...
    //++++ MC inputs +++++++++++++++++++++++
       ...
       RooRealVar*    rv_mu_susymc_sig_sl_e   ;
       RooRealVar*    rv_mu_susymc_sig_sl_mu   ;
       RooRealVar*    rv_mu_susymc_sb_sl_e    ;
       RooRealVar*    rv_mu_susymc_sb_sl_mu    ;
     ...
     //-- SB, LDP
       ...
       RooFormulaVar* rv_n_sb_sl_e      ;
       RooFormulaVar* rv_n_sb_sl_mu      ;
       ...
       RooPoisson*  pdf_Nsig        ;
       RooAbsPdf*   pdf_Nsig_noNSig ;
       RooPoisson*  pdf_Nsb         ;
       RooPoisson*  pdf_Nsig_ldp    ;
       RooPoisson*  pdf_Nsb_ldp     ;
       RooPoisson*  pdf_Nsig_sl     ;
       RooPoisson*  pdf_Nsb_sl_e      ;
       RooPoisson*  pdf_Nsb_sl_mu      ;
