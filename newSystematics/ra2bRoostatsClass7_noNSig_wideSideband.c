...
#include "ra2bRoostatsClass7_noNSig_wideSideband.h"
 ...
 ///  rv_Nlsb_0b_ldp = new RooRealVar( "Nlsb_0b_ldp" , "Nlsb_0b_ldp" , 0.0, 1000000. ) ;
  ...
  /// rv_Nlsb_0b_ldp -> setVal( Nhtonlytrig_lsb_0b_ldp ) ;
    ...
    //____ Counts in SB, SL  ______________________
      ...
      rv_mu_ttwj_sb_sl_e  = new RooRealVar( "mu_ttwj_sb_sl_e"    , "mu_ttwj_sb_sl_e"    , 0.0, 3000. ) ;
      rv_mu_ttwj_sb_sl_mu  = new RooRealVar( "mu_ttwj_sb_sl_mu"    , "mu_ttwj_sb_sl_mu"    , 0.0, 3000. ) ;
