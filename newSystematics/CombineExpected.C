...
CombineExpected(char* likelihood,char* limit){
  ...
  TString branchDescriptor("mGluino:mLSP:asymptoticLimit:toyLimit:toyLimit_err:expectedToyLimit:expectedToyLimit_errHigh:expectedToyLimit_errLow:CLsplusb_toyLimit:CLsplusb_toyLimit_err:CLsplusb_expectedToyLimit:CLsplusb_expectedToyLimit_errHigh:CLsplusb_expectedToyLimit_errLow");
  ...
  TH2D *h2d_1BL_expected = new TH2D("h2d_1BL_expected","1BL, expected UL",22,100,1200,23,50,1200);
  TH2D *h2d_1BT_expected = new TH2D("h2d_1BT_expected","1BT, expected UL",22,100,1200,23,50,1200);
  TH2D *h2d_2BL_expected = new TH2D("h2d_2BL_expected","2BL, expected UL",22,100,1200,23,50,1200);
  TH2D *h2d_2BT_expected = new TH2D("h2d_2BT_expected","2BT, expected UL",22,100,1200,23,50,1200);
  TH2D  *h2d_3B_expected = new TH2D( "h2d_3B_expected", "3B, expected UL",22,100,1200,23,50,1200);
  ...
  TH2D *h2d_1BL_observed = new TH2D("h2d_1BL_observed","1BL, observed UL",22,100,1200,23,50,1200);
  TH2D *h2d_1BT_observed = new TH2D("h2d_1BT_observed","1BT, observed UL",22,100,1200,23,50,1200);
  TH2D *h2d_2BL_observed = new TH2D("h2d_2BL_observed","2BL, observed UL",22,100,1200,23,50,1200);
  TH2D *h2d_2BT_observed = new TH2D("h2d_2BT_observed","2BT, observed UL",22,100,1200,23,50,1200);
  TH2D  *h2d_3B_observed = new TH2D( "h2d_3B_observed", "3B, observed UL",22,100,1200,23,50,1200);
  ...
  TH2D *eps_1BL ;//= new TH2D("eps_1BL","efficiency - 1BL",22,100,1200,23,50,1200);
  TH2D *eps_1BT ;//= new TH2D("eps_1BT","efficiency - 1BT",22,100,1200,23,50,1200);
  TH2D *eps_2BL ;//= new TH2D("eps_2BL","efficiency - 2BL",22,100,1200,23,50,1200);
  TH2D *eps_2BT ;//= new TH2D("eps_2BT","efficiency - 2BT",22,100,1200,23,50,1200);
  TH2D *eps_3B  ;//= new TH2D("eps_3B" ,"efficiency - 3B", 22,100,1200,23,50,1200);

  TH2D *h2d_1BL_xsUL_expected = new TH2D("h2d_1BL_xsUL_expected","1BL, expected xs UL (pb)",22,100,1200,23,50,1200);
  TH2D *h2d_1BT_xsUL_expected = new TH2D("h2d_1BT_xsUL_expected","1BT, expected xs UL (pb)",22,100,1200,23,50,1200);
  TH2D *h2d_2BL_xsUL_expected = new TH2D("h2d_2BL_xsUL_expected","2BL, expected xs UL (pb)",22,100,1200,23,50,1200);
  TH2D *h2d_2BT_xsUL_expected = new TH2D("h2d_2BT_xsUL_expected","2BT, expected xs UL (pb)",22,100,1200,23,50,1200);
  TH2D  *h2d_3B_xsUL_expected = new TH2D( "h2d_3B_xsUL_expected", "3B, expected xs UL (pb)",22,100,1200,23,50,1200);

  TH2D *h2d_1BL_xsUL_observed = new TH2D("h2d_1BL_xsUL_observed","1BL, observed xs UL (pb)",22,100,1200,23,50,1200);
  TH2D *h2d_1BT_xsUL_observed = new TH2D("h2d_1BT_xsUL_observed","1BT, observed xs UL (pb)",22,100,1200,23,50,1200);
  TH2D *h2d_2BL_xsUL_observed = new TH2D("h2d_2BL_xsUL_observed","2BL, observed xs UL (pb)",22,100,1200,23,50,1200);
  TH2D *h2d_2BT_xsUL_observed = new TH2D("h2d_2BT_xsUL_observed","2BT, observed xs UL (pb)",22,100,1200,23,50,1200);
  TH2D  *h2d_3B_xsUL_observed = new TH2D( "h2d_3B_xsUL_observed", "3B, observed xs UL (pb)",22,100,1200,23,50,1200);

  TH2D *h2d_bestSel  = new TH2D("h2d_bestSel" ,"Best selection - expected from DD bkg",22,100,1200,23,50,1200);
  TH2D *h2d_bestUL   = new TH2D("h2d_bestUL"  ,"Best expected xs UL (pb)",22,100,1200,23,50,1200);
  TH2D *h2d_bestUL_observed   = new TH2D("h2d_bestUL_observed" ,"observed xs UL (pb) using best expected selection",22,100,1200,23,50,1200);
  TH2D *h2d_bestSel_observed  = new TH2D("h2d_bestSel_observed" ,"Best selection - observed",22,100,1200,23,50,1200);
  TH2D *h2d_bestUL_observed_noexpected   = new TH2D("h2d_bestUL_observed_noexpected" ,"observed xs UL (pb) using best observed selection",22,100,1200,23,50,1200);
