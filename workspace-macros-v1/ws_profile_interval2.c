...
//----------
  ...
  using namespace RooStats;
   ...
   void ws_profile_interval2( const char* wsfile = "ws-test1.root",
                              const char* parName = "mu_susy_sig",
                              double alpha = 0.10,
  ...
  ///  fout.Close() ;
       ...
       if ( rp != 0x0 ) {
          ...
          if ( efficiency > 0. ) {
             ...
             rp->Dump() ;
             cout << flush ;
             RooCurve* rc = (RooCurve*) rp->findObject("nll_likelihood_ra2b_observed_rds_with_constr_Profile[mu_susy_sig]_Norm[mu_susy_sig]") ;
             ...
             ///rccanv->SaveAs("rccanv.png") ;
                ...
                printf("\n\n *** Can't find RooCurve with name : nll_likelihood_ra2b_observed_rds_with_constr_Profile[mu_susy_sig]_Norm[mu_susy_sig]\n\n") ; cout << flush ;
             }
