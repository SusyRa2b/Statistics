...
#include <string.h>
  ...
  //==============================================================================================
   ...
   void ws_constrained_profile2n( const char* wsfile = "output-files/ws-newfit-lm9-1BL.root",
                                   const char* new_poi_name = "mu_ttwj_sb_1b",
                                   int npoiPoints = 10,
                                   double poiMinVal = 250,
                                   double poiMaxVal = 320,
