...
void make_mc_smonly_lm9_ws_ge1bloose() {
  ...
  gSystem->Exec("mv output-files/ws-mc-smonly-lm9-ge1bloose.root output-files/ws-mc-smonly-lm9-ge1bloose.root-old") ;
  gSystem->Exec("mv ws.root output-files/ws-mc-smonly-lm9-ge1bloose.root") ;
