   ...
   void scanplot_tb10_withcontam_loose_sel() {
      ...
      rfit.susyScanWithContam("input-files/susyScanInput4-tanb10-SSVHPT-nj3-nb1-ht350-sb150_200-sig200.txt", "-scanplot-withcontam.png" ) ;
