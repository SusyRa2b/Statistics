   ...
   void scanplot_unblind_tb10_withcontam_tight_sel() {
      ...
      rfit.susyScanWithContam("input-files/susyScanInput4-tanb10-SSVHPT-nj3-nb1-ht500-sb150_200-sig300.txt","-scanplot-withcontam-unblind.png" ) ;
