   ...
   void scanplot_unblind_tb50_nocontam_loose_sel() {
      ...
      rfit.susyScanNoContam("input-files/susyScanInput4-tanb50-SSVHPT-nj3-nb1-ht350-sb150_200-sig200.txt","-scanplot-nocontam-unblind.png" ) ;
