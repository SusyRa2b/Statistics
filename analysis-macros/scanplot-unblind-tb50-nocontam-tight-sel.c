   ...
   void scanplot_unblind_tb50_nocontam_tight_sel() {
      ...
      rfit.susyScanNoContam("input-files/susyScanInput4-tanb50-SSVHPT-nj3-nb1-ht500-sb150_200-sig300.txt","-scanplot-nocontam-unblind.png" ) ;
