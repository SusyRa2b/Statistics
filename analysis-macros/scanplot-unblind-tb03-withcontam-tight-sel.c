   ...
   void scanplot_unblind_tb03_withcontam_tight_sel() {
      ...
      rfit.susyScanWithContam("input-files/susyScanInput4-tanb03-SSVHPT-nj3-nb1-ht500-sb150_200-sig300.txt","-scanplot-withcontam-unblind.png" ) ;
