   ...
   void scanplot_unblind_tb03_withcontam_loose_sel() {
      ...
      rfit.susyScanWithContam("input-files/susyScanInput4-tanb03-SSVHPT-nj3-nb1-ht350-sb150_200-sig200.txt","-scanplot-withcontam-unblind.png" ) ;
