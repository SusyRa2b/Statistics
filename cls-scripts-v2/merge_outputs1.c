...
#include <stdio.h>
   ...
   void merge_outputs1( const char* selection = "ge1btight" ) {
      ...
      sprintf( infile, "output-%s-t1bbbb-iter9.txt", selection ) ;
      ...
      while ( !feof( infp ) ) {
         ...
         if ( thisInd<0 ) {
            ...
            clsxsec9[thisInd] = txsec ;
            clsval9[thisInd] = tcls ;
         }
      ...
      sprintf( infile, "output-%s-t1bbbb-iter10.txt", selection ) ;
      ...
      while ( !feof( infp ) ) {
         ...
         if ( thisInd<0 ) {
            ...
            clsxsec10[thisInd] = txsec ;
            clsval10[thisInd] = tcls ;
         }
      ...
      printf("\n\n") ;
      printf(        "mg:mlsp:Eff:PLNsigUL:PLXsecUL:clsXsec1:clsXsec2:clsXsec3:clsXsec4:clsXsec5:clsXsec6:clsXsec7:clsXsec8:clsXsec9:clsXsec10:clsVal1:clsVal2:clsVal3:clsVal4:clsVal5:clsVal6:clsVal7:clsVal8:clsVal9:clsVal10\n") ;
      fprintf(outfp, "mg:mlsp:Eff:PLNsigUL:PLXsecUL:clsXsec1:clsXsec2:clsXsec3:clsXsec4:clsXsec5:clsXsec6:clsXsec7:clsXsec8:clsXsec9:clsXsec10:clsVal1:clsVal2:clsVal3:clsVal4:clsVal5:clsVal6:clsVal7:clsVal8:clsVal9:clsVal10\n") ;
      for ( int i=0; i<nPoints; i++ ) {
       //if ( clsval1[i] > 9. ) continue ;
         printf(        "  %7d %7d  %8.4f  %8.3f %8.3f   %8.3f %8.3f %8.3f %8.3f %8.3f %8.3f %8.3f %8.3f %8.3f %8.3f %8.3f %8.3f %8.3f %8.3f %8.3f %8.3f %8.3f %8.3f %8.3f %8.3f\n",
             mg[i], mlsp[i], eff[i], plnsigul[i], plxsecul[i], clsxsec1[i], clsxsec2[i], clsxsec3[i], clsxsec4[i], clsxsec5[i], clsxsec6[i], clsxsec7[i], clsxsec8[i], clsxsec9[i], clsxsec10[i], clsval1[i], clsval2[i], clsval3[i], clsval4[i], clsval5[i], clsval6[i], clsval7[i], clsval8[i], clsval9[i], clsval10[i]  ) ;
         fprintf(outfp, "  %7d %7d  %8.4f  %8.3f %8.3f   %8.3f %8.3f %8.3f %8.3f %8.3f %8.3f %8.3f %8.3f %8.3f %8.3f %8.3f %8.3f %8.3f %8.3f %8.3f %8.3f %8.3f %8.3f %8.3f %8.3f\n",
             mg[i], mlsp[i], eff[i], plnsigul[i], plxsecul[i], clsxsec1[i], clsxsec2[i], clsxsec3[i], clsxsec4[i], clsxsec5[i], clsxsec6[i], clsxsec7[i], clsxsec8[i], clsxsec9[i], clsxsec10[i], clsval1[i], clsval2[i], clsval3[i], clsval4[i], clsval5[i], clsval6[i], clsval7[i], clsval8[i], clsval9[i], clsval10[i]  ) ;
      } // i.
      printf("\n\n") ;
