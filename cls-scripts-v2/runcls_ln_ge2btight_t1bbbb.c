   ...
   void runcls_ln_ge2btight_t1bbbb( int m0 = 560, int m12 = 300, double t1bbbbXsec = 1.0 ) {
      ...
      rfit.setSusyScanPoint("an-11-257-v3-files/input-files/signalSyst.T1bbbb.ge2bTight.dat", m0, m12, true, t1bbbbXsec ) ;
 ...
 ///  char outfname[10000] ;
 ///  sprintf( outfname, "output-files-ge2btight-t1bbbb/clstest_ge2btight_tb40_%d_%d.root", m0, m12 ) ;
