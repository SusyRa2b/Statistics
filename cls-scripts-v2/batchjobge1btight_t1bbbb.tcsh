...
##----------------------------------------
  ...
  mkdir -p log-files-ge1btight-t1bbbb-iter$4
# mkdir -p output-files-ge1btight-t1bbbb-iter$4
...
#---------
  root -b -q cls-scripts-v2/runcls_ln_ge1btight_t1bbbb.c\($1,$2,$3\) >& /tmp/owen/cls-ge1btight-t1bbbb-$1-$2-iter$4.log
  ...
  echo Log file is cls-ge1btight-t1bbbb-$1-$2-iter$4.log   Checking it...
  ls -l /tmp/owen/cls-ge1btight-t1bbbb-$1-$2-iter$4.log

  echo doing the greps
  grep "test stat"    /tmp/owen/cls-ge1btight-t1bbbb-$1-$2-iter$4.log >  log-files-ge1btight-t1bbbb-iter$4/short-cls-ge1btight-t1bbbb-$1-$2-iter$4.log
  grep "p-value of"   /tmp/owen/cls-ge1btight-t1bbbb-$1-$2-iter$4.log >> log-files-ge1btight-t1bbbb-iter$4/short-cls-ge1btight-t1bbbb-$1-$2-iter$4.log
  grep "final result" /tmp/owen/cls-ge1btight-t1bbbb-$1-$2-iter$4.log >> log-files-ge1btight-t1bbbb-iter$4/short-cls-ge1btight-t1bbbb-$1-$2-iter$4.log

  gzip -9v log-files-ge1btight-t1bbbb-iter$4/short-cls-ge1btight-t1bbbb-$1-$2-iter$4.log
#---------
# root -b -q cls-scripts-v2/runcls_ln_ge1btight_t1bbbb.c\($1,$2,$3\) >& log-files-ge1btight-t1bbbb-iter$4/cls-ge1btight-t1bbbb-$1-$2-$4.log

# grep "test stat"    log-files-ge1btight-t1bbbb-iter$4/cls-ge1btight-t1bbbb-$1-$2-$4.log >  log-files-ge1btight-t1bbbb-iter$4/short-cls-ge1btight-t1bbbb-$1-$2-$4.log
# grep "p-value of"   log-files-ge1btight-t1bbbb-iter$4/cls-ge1btight-t1bbbb-$1-$2-$4.log >> log-files-ge1btight-t1bbbb-iter$4/short-cls-ge1btight-t1bbbb-$1-$2-$4.log
# grep "final result" log-files-ge1btight-t1bbbb-iter$4/cls-ge1btight-t1bbbb-$1-$2-$4.log >> log-files-ge1btight-t1bbbb-iter$4/short-cls-ge1btight-t1bbbb-$1-$2-$4.log

# gzip -9v log-files-ge1btight-t1bbbb-iter$4/cls-ge1btight-t1bbbb-$1-$2-$4.log
#---------
