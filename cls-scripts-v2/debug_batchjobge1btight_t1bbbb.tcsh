...
#
#        1  2    3    4     5      6
# Args: mg mlsp Xsec iter logdir outdir
#
...
#---------
  ...
  root -b -q cls-scripts-v2/debug_runcls_ln_ge1btight_t1bbbb.c\($1,$2,$3,$4,\"$outdir\"\) >& $logdir/cls-ge1btight-t1bbbb-$1-$2-$4.log

  grep "test stat"    $logdir/cls-ge1btight-t1bbbb-$1-$2-$4.log >  $logdir/short-cls-ge1btight-t1bbbb-$1-$2-$4.log
  grep "p-value of"   $logdir/cls-ge1btight-t1bbbb-$1-$2-$4.log >> $logdir/short-cls-ge1btight-t1bbbb-$1-$2-$4.log
  grep "final result" $logdir/cls-ge1btight-t1bbbb-$1-$2-$4.log >> $logdir/short-cls-ge1btight-t1bbbb-$1-$2-$4.log

  gzip -9v $logdir/cls-ge1btight-t1bbbb-$1-$2-$4.log
#---------
