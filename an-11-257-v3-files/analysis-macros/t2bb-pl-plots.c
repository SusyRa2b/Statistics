...
#include "histio.c"
  ...
  using namespace std ;
    ...
    void t2bb_pl_plots() {
        ...
        loadHist("an-11-257-v3-files/output-files/an-scanplot-unblind-t2bb-withcontam-ge1b-loose.root","ge1bloose" ) ;
        loadHist("an-11-257-v3-files/output-files/an-scanplot-unblind-t2bb-withcontam-ge1b-tight.root","ge1btight" ) ;
        loadHist("an-11-257-v3-files/output-files/an-scanplot-unblind-t2bb-withcontam-ge2b-loose.root","ge2bloose" ) ;
        loadHist("an-11-257-v3-files/output-files/an-scanplot-unblind-t2bb-withcontam-ge2b-tight.root","ge2btight" ) ;
    ...
    //--------
        ...
        text->DrawTextNDC( 0.15, 0.92, "t2bb: ge1bloose, PL cross section upper limit") ;


        cxsec->SaveAs("an-11-257-v3-files/output-files/an-t2bb-pl-xsecul-ge1bloose.png") ;
    ...
    //--------
        ...
        text->SetTextAngle(0.) ;
        text->SetTextSize(0.045) ;
        text->DrawTextNDC( 0.15, 0.92, "t2bb: ge1btight, PL cross section upper limit") ;


        cxsec->SaveAs("an-11-257-v3-files/output-files/an-t2bb-pl-xsecul-ge1btight.png") ;
    ...
    //--------
        ...
        text->SetTextAngle(0.) ;
        text->SetTextSize(0.045) ;
        text->DrawTextNDC( 0.15, 0.92, "t2bb: ge2bloose, PL cross section upper limit") ;


        cxsec->SaveAs("an-11-257-v3-files/output-files/an-t2bb-pl-xsecul-ge2bloose.png") ;
    ...
    //--------
        ...
        text->SetTextAngle(0.) ;
        text->SetTextSize(0.045) ;
        text->DrawTextNDC( 0.15, 0.92, "t2bb: ge2btight, PL cross section upper limit") ;


        cxsec->SaveAs("an-11-257-v3-files/output-files/an-t2bb-pl-xsecul-ge2btight.png") ;
    ...
    //--------
        ...
        text->SetTextAngle(0.) ;
        text->SetTextSize(0.045) ;
        text->DrawTextNDC( 0.15, 0.92, "t2bb: ge1bloose, Efficiency") ;

        ceff->SaveAs("an-11-257-v3-files/output-files/an-t2bb-eff-ge1bloose.png") ;
    ...
    //--------
        ...
        text->SetTextAngle(0.) ;
        text->SetTextSize(0.045) ;
        text->DrawTextNDC( 0.15, 0.92, "t2bb: ge1btight, Efficiency") ;

        ceff->SaveAs("an-11-257-v3-files/output-files/an-t2bb-eff-ge1btight.png") ;
    ...
    //--------
        ...
        text->SetTextAngle(0.) ;
        text->SetTextSize(0.045) ;
        text->DrawTextNDC( 0.15, 0.92, "t2bb: ge2bloose, Efficiency") ;

        ceff->SaveAs("an-11-257-v3-files/output-files/an-t2bb-eff-ge2bloose.png") ;
    ...
    //--------
        ...
        text->SetTextAngle(0.) ;
        text->SetTextSize(0.045) ;
        text->DrawTextNDC( 0.15, 0.92, "t2bb: ge2btight, Efficiency") ;

        ceff->SaveAs("an-11-257-v3-files/output-files/an-t2bb-eff-ge2btight.png") ;
