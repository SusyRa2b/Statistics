   ...
   void an_scanplot_unblind_t2bb_withcontam_ge2b_tight() {
      ...
      rfit.susyScanWithContam("an-11-257-v3-files/input-files/signalSyst.T2bb.ge2btight.dat",
                              "an-11-257-v3-files/output-files/an-scanplot-unblind-t2bb-withcontam-ge2b-tight", 1 ) ;
