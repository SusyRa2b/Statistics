...
void make_lm9_ws_2BT_sbvars() {
  ...
  gSystem->Exec("mv output-files/ws-lm9-2BT-sbvars.root output-files/ws-lm9-2BT-sbvars.root-old") ;
  gSystem->Exec("mv ws.root output-files/ws-lm9-2BT-sbvars.root") ;
