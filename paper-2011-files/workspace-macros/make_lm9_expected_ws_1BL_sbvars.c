...
void make_lm9_expected_ws_1BL_sbvars() {
  ...
  gSystem->Exec("mv output-files/expected-ws-lm9-1BL-sbvars.root output-files/expected-ws-lm9-1BL-sbvars.root-old") ;
  gSystem->Exec("mv ws.root output-files/expected-ws-lm9-1BL-sbvars.root") ;
