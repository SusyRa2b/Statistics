...
#include "LikelihoodIntervalPlot.cxx"
  ...
  //=====================================================================================================
   ...
   ra2bRoostatsClass5::ra2bRoostatsClass5( bool ArgUseSigTtwjVar, bool ArgUseLdpVars, int ArgznnModel ) {
  ...
  //===================================================================
   ...
   ra2bRoostatsClass5::~ra2bRoostatsClass5() {
...
//    delete workspace ;
  ...
  //===================================================================
    ...
    bool ra2bRoostatsClass5::initialize( const char* infile ) {
