#ifndef ra2bRoostatsClass6_h
#define ra2bRoostatsClass6_h
...
//
   ...
   class ra2bRoostatsClass6 {

     public :

       ra2bRoostatsClass6( bool ArgUseSigTtwjVar=false, bool ArgUseLdpVars=true, int ArgznnModel=1 ) ;

       virtual ~ra2bRoostatsClass6();
